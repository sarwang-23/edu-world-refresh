...
const replaces = [
  ...
  { f: 'src/routes/students_.entrepreneurship.tsx', p: /Summer 2026 cohort/g, r: 'Upcoming cohort' },
  ...
  { f: 'src/routes/programmes.teacher-training.tsx', p: /Ongoing Programmes\u20132026/g, r: 'Ongoing Programmes' },
