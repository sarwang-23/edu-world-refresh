...
files.forEach((f) => {
  ...
  content = content.replace(
    / - (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)(?:[a-z]*)? 202[0-9]/g,
    "",
  );
  content = content.replace(
    /\s(January|February|March|April|May|June|July|August|September|October|November|December) 202[0-9]/g,
    "",
  );
  ...
  content = content.replace(
    /\d{1,2}(st|nd|rd|th)? (January|February|March|April|May|June|July|August|September|October|November|December) 202[0-9]/g,
    "Upcoming",
  );
  content = content.replace(
    /\d{1,2}\u2013\d{1,2} (January|February|March|April|May|June|July|August|September|October|November|December) 202[0-9]/g,
    "Upcoming",
  );
  content = content.replace(
    /\d{1,2}-\d{1,2} (January|February|March|April|May|June|July|August|September|October|November|December) 202[0-9]/g,
