...
if (gilpPost) {
  ...
  console.log(
    'Raw HTML contains "Cohort Representation:":',
    gilpPost.rawHtml.includes("Cohort Representation:"),
  );
  console.log(
    'Raw HTML contains "Course Modules and Faculty:":',
    gilpPost.rawHtml.includes("Course Modules and Faculty:"),
  );
  console.log(
    'Raw HTML contains "Critical Takeaways":',
    gilpPost.rawHtml.includes("Critical Takeaways"),
  );
} else {
