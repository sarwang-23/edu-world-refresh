  ...
  head: () => ({
    meta: [
      { title: "Global India Leadership Programme at Cambridge — Global Edu Lab" },
      {
        name: "description",
        content:
          "A transformative leadership programme at Cambridge Judge Business School for Indian board members, CEOs and senior leaders.",
      },
    ],
  }),
  component: Page,
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10 z-10">
        ...
        <div className="flex flex-wrap justify-center gap-6 lg:gap-8">
          {faculty.map((f, i) => (
            <div
              key={i}
              className="group w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(25%-1.5rem)] bg-white rounded-[2rem] overflow-hidden shadow-[0_8px_24px_rgba(10,48,29,0.04)] border border-forest/5 hover:shadow-[0_32px_64px_rgba(10,48,29,0.12)] hover:border-gold/30 hover:-translate-y-2 transition-all duration-700 flex flex-col relative"
            >
              ...
              <div className="p-6 sm:p-7 flex flex-col flex-1 relative z-10 bg-white">
                <div className="mb-4">
                  <h3 className="text-[19px] font-bold text-forest-deep tracking-tight mb-1 group-hover:text-gold-deep transition-colors duration-500">
                    {f.name}
                  </h3>
                  <p className="text-[12.5px] font-bold text-gold/90 tracking-wide uppercase">
                    {f.role}
                  </p>
                </div>
