    ...
    <section className="bg-forest-deep py-20 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            <p className="text-[13px] font-bold uppercase tracking-[0.3em] text-gold mb-3">Signature Experience · 17 September</p>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(10,48,29,0.04)] border border-forest/5 relative overflow-hidden group hover:shadow-[0_20px_40px_rgba(10,48,29,0.08)] hover:-translate-y-1 transition-all duration-500">
            ...
            <ul className="space-y-4">
              <li className="flex items-center justify-between p-4 rounded-xl bg-[#FAF8F5] border border-forest/5 transition-colors group-hover:border-gold/20">
                ...
                <span className="text-[14px] font-bold text-gold-deep bg-gold/10 px-3 py-1 rounded-full">30 May 2026</span>
              </li>
              <li className="flex items-center justify-between p-4 rounded-xl bg-[#FAF8F5] border border-forest/5 transition-colors group-hover:border-gold/20">
                <span className="text-[14.5px] font-bold text-forest-deep">Round 2</span>
                <span className="text-[14px] font-bold text-gold-deep bg-gold/10 px-3 py-1 rounded-full">30 July 2026</span>
              </li>
            </ul>
          </div>
            ...
            <div className="space-y-5">
              <div className="group flex items-center gap-5 bg-[#FAF8F5] rounded-2xl p-5 border border-forest/5 hover:border-gold/20 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                <div className="h-12 w-12 rounded-xl bg-forest-deep flex items-center justify-center shrink-0 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
