  ...
  head: () => ({
    meta: [
      { title: "Global India Leadership Programme at Cambridge | Sept 2026 — Global Edu Lab" },
      {
        name: "description",
        content:
          "A 5-day residential executive leadership programme at Cambridge Judge Business School for Indian board members, CEOs and senior leaders. September 2026.",
      },
    ],
  }),
  component: Page,
        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-16 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-[16px] md:text-[17px] text-forest/75 leading-relaxed max-w-[480px] mb-8 font-medium">
              ...
              experience equips you with cutting-edge insights in AI, strategy, and leadership to
              navigate complexity.
            </p>
            ...
            <div className="flex items-center gap-4 border-t border-forest/10 pt-6">
              <span className="text-[13px] font-bold uppercase tracking-[0.2em] text-forest/50">
                Certified By
              </span>
              <img
        ...
        <div className="grid md:grid-cols-[1fr_1.1fr] gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-[540px]">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-[12px] font-bold uppercase tracking-[0.3em] text-gold">
                About the Programme
              </span>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-6 pt-6 border-t border-forest/10">
              {[
                ...
                { val: "Sept 2026", label: "Next Cohort" },
              ].map((s, i) => (
                <div key={i} className="flex flex-col">
                  <span className="text-[22px] font-bold text-forest-deep">{s.val}</span>
                  <span className="text-[12px] uppercase tracking-wider text-forest/60 font-medium mt-0.5">
                    {s.label}
                  </span>
                </div>
              ))}
            ...
            <div className="relative bg-white rounded-2xl shadow-[0_8px_40px_rgba(10,48,29,0.08)] overflow-hidden ring-1 ring-forest/5">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-[14px] font-bold text-white uppercase tracking-wider leading-tight">
                          BIDISHA BANERJEE
                        </p>
                      ...
                      <div className="ml-auto bg-white/10 backdrop-blur-md border border-white/20 rounded-xl px-4 py-2">
                        <p className="text-[13px] italic text-white font-medium">
                          "I'm loving it here"
                        </p>
                      </div>
                    </div>
              ...
              <div className="px-6 py-4 flex items-center justify-between border-t border-forest/6 bg-white">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-[13px] font-bold text-forest/70 uppercase tracking-wider">
                    Alumni Testimonial
                  </span>
                </div>
                <img
    ...
    <section className="bg-[#F5F0E0] py-20">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="mb-12">
          ...
          <p className="mt-3 text-[15px] text-forest/65 max-w-2xl leading-relaxed">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            <p className="text-[13px] font-bold uppercase tracking-[0.3em] text-gold mb-3">
              Signature Experience · 17 September
            </p>
            ...
            <p className="text-[15px] text-cream/75 leading-relaxed mb-8">
              On 17 September, gather at the Home of Cricket for an exclusive leadership session,
              private tour and networking lunch. The programme includes a leadership session
              inspired by the principles of high-performance sport, a private networking lunch with
              senior business leaders and academics, and an exclusive behind-the-scenes tour of the
              Home of Cricket.
            </p>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl min-h-[340px]">
            ...
            <div className="absolute bottom-5 left-5">
              ...
              <p className="text-white text-[14px] font-semibold">London, UK · 17 September 2026</p>
            </div>
          </div>
        </div>
      </div>
...
function LordsMarquee() {
  const items = [
    {
      icon: <Calendar className="h-11 w-11 mx-auto text-gold mb-3 stroke-[1.5]" />,
    ...
    <section className="bg-white py-12 border-b border-forest/10 overflow-hidden relative">
      ...
      <div className="animate-marquee flex items-center">
        {repeatedItems.map((item, i) => (
          ...
          >
            {item.icon}
            <p className="text-[13px] font-bold text-forest-deep uppercase tracking-[0.1em] text-center">
              {item.text}
            </p>
          </div>
        ))}
  ...
  const phases = [
    {
      ...
      items: [
        ...
        "Pre reading material and pre-programme assessment shared 10–20 August 2026",
    ...
    },
    {
      ...
      items: [
        "March 2027 — GEL will measure the impact on your organisation's growth",
        ...
        <div className="animate-[marquee_40s_linear_infinite] flex items-start">
          {repeatedFaculty.map((f, i) => (
            <div key={i} className="group text-center shrink-0 w-[280px] px-6">
              ...
              <p className="text-[12.5px] text-white/50 mt-1.5 font-medium">
                Cambridge Judge Business School
              </p>
            </div>
          ))}
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="text-center mb-16">
          ...
          <p className="text-[15px] font-medium text-forest/70 italic max-w-2xl mx-auto">
            Applications are reviewed on a rolling, space-available basis. Early applications are
            strongly encouraged.
          </p>
        </div>
    ...
    <section className="bg-[#EDE0C4] py-24 border-t border-[#C8B89A]/40">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="mb-16">
          ...
          <p className="mt-5 text-[14px] italic text-forest/50">
            *Programme fee across all packages will increase by 10% for Round 2 applications.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-14">
          {packages.map((pkg, i) => (
            ...
            >
              ...
              />
              <div className="p-8 relative">
                <span className="absolute top-6 right-6 text-gold/40 text-3xl select-none font-serif">
                  ✦
                </span>
    ...
    <section className="bg-[#FAF8F5] py-24 border-y border-forest/5 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        <div className="text-center mb-14">
          <span className="inline-block text-[11px] font-bold uppercase tracking-[0.22em] text-gold-deep bg-gold/10 px-4 py-1.5 rounded-full mb-4">
            Packages 2 &amp; 3
          </span>
          ...
          {hotels.map((hotel, i) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="text-[15px] font-bold text-forest-deep leading-snug mb-1">
                  {hotel.name}
                </h3>
    ...
    <section className="bg-white py-24 border-t border-forest/5">
      <div className="mx-auto w-[96%] xl:max-w-[1400px]">
        <div className="text-center mb-16">
          ...
          <p className="text-[1.3rem] md:text-[1.5rem] text-forest/80 font-light">
...
function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "The programme takes place at Cambridge Judge Business School over 5 residential days (14–18 September 2026), with a special off-site session at Lord's Cricket Ground in London on 17 September.",
    },
    {
    ...
    },
    {
      ...
      a: "Applications are reviewed on a rolling, space-available basis. Early applications are strongly encouraged. Programme fees will increase by 10% for Round 2 applications, subject to availability.",
    },
    {
            ...
            >
              ...
              >
                ...
                {open === i ? (
                  ...
                  <ChevronDown className="h-5 w-5 text-forest/35 shrink-0" />
                )}
              </button>
              {open === i && (
    ...
    <section className="bg-forest-deep py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="grid md:grid-cols-2 gap-16 items-start lg:pt-8">
          {/* LEFT — Text content */}
          <div>
            <span className="inline-block text-[11px] font-bold uppercase tracking-[0.22em] text-[#C9913D] bg-[#C9913D]/15 px-4 py-1.5 rounded-full mb-6 border border-[#C9913D]/20">
              Upon Completion
            </span>
            ...
            <div className="relative flex justify-center">
              ...
              <div className="relative bg-white rounded-2xl shadow-[0_40px_100px_rgba(0,0,0,0.5)] p-6 w-full border border-[#C9913D]/30">
                ...
                <div className="ml-4 space-y-2 mb-8">
                  ...
                  <p className="text-[17px] font-bold text-forest-deep border-b border-forest/10 pb-2 pr-8">
                    [Participant Name]
                  </p>
                  <p className="text-[10px] text-forest/50">attended</p>
                  <p className="text-[13px] font-bold text-forest-deep leading-snug">
                    Global India Leadership Programme
                  </p>
                  <p className="text-[10px] text-forest/50">14th September – 18th September 2026</p>
                </div>
                <div className="ml-4 mt-8 flex items-end justify-between">
                  ...
                  <img
                    src="https://static.wixstatic.com/media/bf78a9_63184a68c2974142a13024cf634f6d33~mv2.png"
                    alt="Cambridge"
                    className="h-5 w-auto object-contain opacity-40 mr-2"
                  />
                </div>
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <p className="text-[3rem] font-black text-forest/5 tracking-[0.4em] rotate-[-30deg] select-none">
                    SAMPLE
                  </p>
                </div>
              </div>
    ...
    <section className="bg-[#F7F5F1] py-24 border-t border-forest/5 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10 z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-[15px] text-forest/60 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {faculty.map((f, i) => (
            <div
              key={i}
              className="group bg-white rounded-2xl overflow-hidden shadow-[0_8px_20px_rgba(10,48,29,0.03)] border border-forest/5 hover:border-gold/30 hover:shadow-[0_20px_40px_rgba(196,148,50,0.08)] hover:-translate-y-1 transition-all duration-500 flex flex-col"
            >
              ...
              <div className="p-6 flex flex-col flex-1 bg-white relative z-10">
                <h3 className="text-[17px] font-bold text-forest-deep leading-snug mb-1">
                  {f.name}
                </h3>
                <p className="text-[13px] font-serif italic text-gold mb-4 leading-snug">
                  {f.role}
                </p>
    ...
    <section className="bg-[#FAF8F5] py-24 border-t border-forest/5 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-6 md:px-10">
        <div className="text-center mb-14">
          ...
          <h2 className="text-[2rem] md:text-[2.5rem] font-bold text-forest-deep mb-3">
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-10">
          {policies.map((p, i) => (
            <div
              key={i}
              className={`rounded-2xl border p-6 ${p.color} hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-md`}
            >
              <div className="flex items-center justify-between mb-4">
                <span className={`text-[2rem] font-bold ${p.iconColor}`}>{p.icon}</span>
                <span className={`text-[13px] font-bold px-3 py-1 rounded-full ${p.badge}`}>
                  {p.refund}
                </span>
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <div className="bg-white rounded-2xl p-7 shadow-[0_8px_30px_rgba(10,48,29,0.05)] border border-forest/5 relative overflow-hidden">
            ...
            <p className="text-[14px] text-forest/65 leading-relaxed">
              ...
              <a
                ...
                className="text-[#1a73e8] underline hover:text-[#1558b0] transition-colors"
              >
                info@globaledulab.com
              </a>
              . Refunds (where applicable) will be processed within <strong>14 working days</strong>{" "}
          ...
          <div className="bg-white rounded-2xl p-7 shadow-[0_8px_30px_rgba(10,48,29,0.05)] border border-forest/5 relative overflow-hidden">
            ...
            <p className="text-[14px] text-forest/65 leading-relaxed">
              <strong>Refunds are processed only in GBP (British Pounds).</strong> If you paid in
              another currency, the final amount you receive may vary depending on the prevailing
              exchange rate and any charges applied by your payment provider or bank at the time of
              refund.
            </p>
          </div>
        </div>
    ...
    <section className="bg-white py-24 border-t border-forest/5">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="grid md:grid-cols-2 gap-14 items-center">
          {/* Left: contact info */}
          <div>
            <span className="inline-block text-[11px] font-bold uppercase tracking-[0.22em] text-gold-deep bg-gold/10 px-4 py-1.5 rounded-full mb-5">
              Get in Touch
            </span>
            ...
            <div className="space-y-5">
              <div className="group flex items-center gap-5 bg-[#FAF8F5] rounded-2xl p-5 border border-forest/5 hover:border-gold/20 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                <div className="h-12 w-12 rounded-xl bg-forest-deep flex items-center justify-center shrink-0 shadow-md">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-forest/40 mb-0.5">
                    Email
                  </p>
                  <a
                    href="mailto:info@globaledulab.com"
                    className="text-[16px] font-bold text-forest-deep hover:text-gold-deep transition-colors"
                  >
                    info@globaledulab.com
                  </a>
                </div>
              ...
              <div className="group flex items-center gap-5 bg-[#FAF8F5] rounded-2xl p-5 border border-forest/5 hover:border-gold/20 hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                ...
                <div>
                  ...
                  <p className="text-[16px] font-bold text-forest-deep">
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-[0_30px_80px_rgba(10,48,29,0.12)]">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-[12px] font-bold uppercase tracking-widest text-gold mb-1">
                  Cambridge Judge Business School
                </p>
        ...
        <div className="grid md:grid-cols-[1fr_1.1fr] gap-14 items-start">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-[14px] text-forest/60">14–18 September 2026</span>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0_8px_30px_rgba(10,48,29,0.05)] border border-forest/5 mb-6">
              ...
              <p className="text-[13px] font-bold text-forest-deep">
                Please note:{" "}
                <span className="font-normal text-forest/65">
                  Submitting an application on this page does not guarantee a confirmed place.
                  Applications are reviewed by our programme team using a selective admission model.
                </span>
              </p>
            </div>
            <div className="space-y-2">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="border border-forest/15 rounded-xl px-3 py-3 text-[14px] text-forest-deep bg-[#FAF8F5] focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold/10 transition-all duration-200 w-24"
                  >
                  ...
                  <input
                    ...
                    className="flex-1 border border-forest/15 rounded-xl px-4 py-3 text-[14px] text-forest-deep bg-[#FAF8F5] focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold/10 transition-all duration-200"
                  />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-forest/15 rounded-xl px-4 py-3 text-[14px] text-forest/60 bg-[#FAF8F5] focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold/10 transition-all duration-200"
                >
              ...
              {status === "success" && (
                <p className="text-center text-[13px] font-semibold text-forest-deep mt-1">
                  ✓ Application received — check your email for confirmation.
                </p>
              )}
              {status === "error" && (
                <p className="text-center text-[13px] font-semibold text-red-500 mt-1">
                  Something went wrong. Please try again.
                </p>
              )}
              <p className="text-center text-[11.5px] text-forest/40 mt-1">
    ...
    <section className="bg-forest-deep py-20 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-2xl px-6">
        ...
        <p className="text-[15px] text-cream/70 leading-relaxed mb-8 max-w-md mx-auto">
          Applications now open for the September 2026 cohort. Limited seats — secure your place
          early.
        </p>
        ...
        <div className="mt-10">
          <img
            src="https://static.wixstatic.com/media/bf78a9_63184a68c2974142a13024cf634f6d33~mv2.png"
            alt="Cambridge Judge Business School"
            className="h-9 w-auto object-contain mx-auto opacity-35"
          />
        </div>
      </div>
    </section>
