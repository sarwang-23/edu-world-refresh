        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Cambridge Judge Business School</span>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 border border-forest/8">
              ...
              <div>
                <p className="text-[11px] font-bold text-forest-deep uppercase tracking-wider">Cambridge Judge</p>
                <p className="text-[10px] text-forest/55 mt-0.5">Business School</p>
              </div>
            </div>
            <div className="absolute -top-5 -right-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 border border-forest/8">
              ...
              <div>
                <p className="text-[11px] font-bold text-forest-deep uppercase tracking-wider">5-Day Residential</p>
                <p className="text-[10px] text-forest/55 mt-0.5">Immersive Programme</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Curriculum Pillars</span>
            <div className="h-px w-8 bg-gold" />
          </div>
            ...
            <div key={i} className="group bg-[#F7F5F0] rounded-3xl p-8 border border-forest/8 hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              <div className="flex items-start gap-5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-forest/65 leading-relaxed mt-1">{p.desc}</p>
                </div>
              </div>
              <ul className="space-y-2 pl-1">
                {p.items.map((item, k) => (
                  <li key={k} className="flex items-center gap-2.5 text-[13px] text-forest/75">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              <div className="h-px w-8 bg-gold" />
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Signature Experience</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="rounded-2xl border border-white/10 bg-white/5 p-5">
                  <p className="text-[12px] font-bold text-gold mb-1">{item.t}</p>
                  <p className="text-[12px] text-white/65 leading-snug">{item.d}</p>
                </div>
              ))}
            </div>
          </div>
          <div className="relative h-full min-h-[380px]">
            <div className="h-full w-full overflow-hidden rounded-3xl shadow-2xl border border-white/10 min-h-[380px]">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold mb-1">Lord's Cricket Ground</p>
                <p className="text-white text-[13px] font-semibold">London, UK · 17 September 2026</p>
              </div>
            </div>
          </div>
        </div>
          ...
          {phases.map((ph, i) => (
            <div key={i} className="rounded-3xl bg-white border border-forest/10 overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-[12px] text-gold font-semibold mb-6">{ph.date}</p>
                <ul className="space-y-3">
                  {ph.items.map((item, k) => (
                    <li key={k} className="flex items-start gap-2.5 text-[13px] text-forest/75 leading-relaxed">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          <div className="flex flex-col gap-6">
            <div className="rounded-2xl p-8 bg-forest-deep text-white border border-forest-deep relative overflow-hidden shadow-xl">
              ...
              <p className="text-[11px] font-bold uppercase tracking-[0.2em] mb-2 text-gold">Course Fee</p>
            ...
            <div className="bg-[#F7F5F0] rounded-2xl p-8 border border-forest/10 flex-1">
              ...
              <ul className="space-y-3">
                {inclusions.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-[13px] text-forest/75 leading-relaxed">
              ...
              <ul className="space-y-2.5">
                {exclusions.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-[13px] text-forest/55 leading-relaxed">
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <div className="mt-10 flex gap-4 justify-center flex-wrap">
          ...
          <Link to="/contact" className="inline-flex items-center gap-2 rounded-full border border-white/20 px-7 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-white hover:border-white/50 transition-all duration-300">
            Request Brochure
          </Link>
        </div>
      </div>
