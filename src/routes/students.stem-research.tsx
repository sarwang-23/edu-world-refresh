  ...
  return (
    <section className="relative bg-[#F4EFE6] overflow-hidden pt-20 pb-36 md:pt-28 md:pb-44">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <Link
          to="/students"
          className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-blue-600 mb-10 hover:text-blue-500 transition-colors"
        >
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            {/* badge */}
            <span className="inline-flex items-center gap-2 bg-blue-500/10 text-blue-600 text-[9px] font-bold uppercase tracking-[0.22em] px-4 py-2 rounded-full border border-blue-400/25 mb-7">
            ...
            <div className="flex gap-4 flex-wrap">
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-8 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-white hover:bg-blue-500 transition-all duration-300 shadow-xl shadow-blue-500/25"
              >
                Apply Now <ArrowUpRight className="h-4 w-4" />
              </Link>
              <Link
                to="/students"
                className="inline-flex items-center gap-2 rounded-full border border-forest/20 bg-white px-7 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-forest hover:border-blue-400/40 transition-all duration-300"
              >
                View All Tracks
              </Link>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-blue-600">What You'll Do</span>
            <div className="h-px w-8 bg-blue-500" />
          </div>
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep mb-3">Four pillars of learning.</h2>
          <p className="text-[14px] text-forest/55 max-w-lg mx-auto leading-[1.75]">Everything is designed to build genuine research capability and scientific curiosity.</p>
        </div>
    ...
    <section className="py-24 bg-[#F4EFE6]">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-blue-500" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-blue-600">Programme Modules</span>
            <div className="h-px w-8 bg-blue-500" />
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((m, i) => (
            <div key={i} className="rounded-[1.5rem] bg-white border border-forest/8 p-7 hover:border-blue-400/30 hover:shadow-[0_12px_36px_rgba(37,99,235,0.09)] transition-all duration-300 shadow-sm group">
              <span className="text-[11px] font-black text-blue-500/50 tracking-[0.2em] group-hover:text-blue-500 transition-colors duration-300">{m.num}</span>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-blue-400">What You'll Leave With</span>
            </div>
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-4 mb-5">
                ...
                <p className="text-[13px] text-white/70 leading-[1.65] mt-1">{o.text}</p>
              </div>
            ))}
          </div>
  ...
  return (
    <section className="bg-[#F4EFE6] py-24 text-center">
      <div className="mx-auto max-w-2xl px-6">
        <div className="flex items-center justify-center gap-3 mb-5">
          <div className="h-px w-8 bg-blue-500" />
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-blue-600">Join the Track</span>
          <div className="h-px w-8 bg-blue-500" />
        </div>
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-10 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-white hover:bg-blue-500 transition-all duration-300 shadow-xl shadow-blue-500/25"
        >
