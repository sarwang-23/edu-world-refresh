...
export const Route = createFileRoute("/programmes/graduate")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Experience Cambridge. Expand your thinking. Shape what comes next.",
      },
    ],
  }),
          ...
          <div className="relative">
            <div className="rounded-[2.5rem] overflow-hidden aspect-[4/3] shadow-[0_32px_80px_-12px_rgba(26,53,35,0.25)] relative ring-1 ring-forest/10">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                <div>
                  <p className="text-[14px] font-bold uppercase tracking-[0.3em] text-gold mb-1">
                ...
                <div className="flex -space-x-2">
                  ...
                  <div className="w-8 h-8 rounded-full bg-forest-deep border-2 border-white/40 flex items-center justify-center text-white text-[15px] font-bold">
                    +30
                  </div>
                </div>
              </div>
            ...
            <div className="absolute -top-6 -right-6 flex items-center gap-3 rounded-2xl bg-forest-deep p-4 shadow-2xl shadow-forest-deep/25 border border-white/10">
              ...
              <div>
                ...
                <p className="text-[14px] text-cream/55 mt-0.5">
                  Entrepreneurship, Research & Architecture
                </p>
              </div>
            </div>
        ...
        <div className="flex gap-0 animate-marquee" style={{ animationDirection: "reverse" }}>
          {repeated.map((s, i) => (
            ...
            >
              ...
              <p className="text-[14px] font-bold uppercase tracking-[0.18em] text-gold mt-2 mb-1">
                {s.label}
              </p>
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="mb-16">
          ...
          <div className="inline-flex items-center gap-4 overflow-hidden rounded-2xl bg-[#F4EFE6] border border-gold/20 px-6 py-4 shadow-sm group">
            ...
            <div>
              <span className="text-[14px] font-bold text-forest-deep leading-[1.6]">
                It's not just a summer.{" "}
              </span>
              <span className="text-[14px] font-bold text-gold leading-[1.6]">
    ...
    <section id="tracks" className="py-32 bg-[#F4EFE6] relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-[15px] text-forest/65 max-w-lg mx-auto leading-[1.75]">
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-white border border-forest/8 shadow-[0_4px_32px_rgba(26,53,35,0.08)] hover:shadow-[0_32px_80px_rgba(26,53,35,0.2)] hover:-translate-y-3 transition-all duration-500 flex flex-col">
            ...
            <div className="p-9 pb-6">
              <div className="flex items-center justify-between mb-8">
                ...
                <span className="text-[14px] font-semibold text-forest/35 uppercase tracking-widest">
                  Entrepreneurship
                </span>
              </div>
              ...
              <p className="text-[14px] font-semibold text-forest/65 mb-4 tracking-wide">
                Build ideas. Solve problems.
              </p>
              <p className="text-[14px] text-forest/55 leading-[1.65] mb-6">
            ...
            <div className="relative h-48 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7 right-7">
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-gold px-7 py-3 text-[14px] font-bold uppercase tracking-[0.2em] text-forest-deep shadow-xl shadow-gold/30 hover:bg-amber-400 transition-all duration-300 group/btn"
                >
                  Explore Track
            ...
            <div className="relative h-48 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7 right-7">
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-blue-500 px-7 py-3 text-[14px] font-bold uppercase tracking-[0.2em] text-white shadow-xl shadow-blue-500/30 hover:bg-blue-400 transition-all duration-300 group/btn"
                >
                  Explore Track
                  <ArrowUpRight className="h-4 w-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                </Link>
            ...
            <div className="relative h-48 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7 right-7">
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#B47C35] px-7 py-3 text-[14px] font-bold uppercase tracking-[0.2em] text-white shadow-xl shadow-orange-500/30 hover:bg-[#966526] transition-all duration-300 group/btn"
                >
                  Explore Track
                  <ArrowUpRight className="h-4 w-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                </Link>
  ...
  return (
    <section className="bg-forest-deep py-32 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-5 text-[15px] text-cream/65 leading-[1.75] max-w-xl mx-auto">
