          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 pb-20 lg:grid-cols-12 lg:gap-12 pt-10">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mt-6 max-w-xl text-[17px] leading-[1.65] text-muted-foreground">
                AI-powered simulations that place learners inside real business scenarios. Make
                decisions. See the impact. Build the skills that matter in today's world.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-5">
                {[
                  ...
                  { icon: <Zap className="h-4 w-4" />, label: "AI-Powered Scenarios & Feedback" },
                  {
                    ...
                    label: "Analytics for Deeper Insights",
                  },
                ].map(({ icon, label }) => (
                  <div
                    key={label}
                    className="flex items-center gap-2 text-forest/60 text-[14px] font-medium"
                  >
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-[1.05rem] text-forest/65 max-w-xl mx-auto">
                Curriculum-aligned simulations that develop critical business skills through
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="rounded-2xl border border-forest/10 bg-white p-8 shadow-sm">
                ...
                <p className="text-forest/65 mb-6 text-[15px]">
                  Short, focused experiences (20–30 min) that introduce, apply or reinforce key
                  concepts in-class.
                </p>
                <ul className="space-y-3 mb-8">
                  {[
                    "Pre-class or in-class activities",
                    "Flipped classroom support",
                    "Formative assessment",
                    "Quick, engaging and easy to integrate",
                  ].map((item) => (
                ...
                <div className="overflow-hidden rounded-xl">
                  <img
                    src={formatImg1}
                    alt="Micro-Simulations in action"
              ...
              <div className="rounded-2xl border border-forest/10 bg-white p-8 shadow-sm">
                ...
                <h3 className="text-[1.4rem] font-bold text-forest mb-3">
                  Interactive Case Simulations
                </h3>
                <p className="text-forest/65 mb-6 text-[15px]">
                  Multi-round, facilitated experiences where learners make a series of decisions in
                  an evolving scenario.
                </p>
                <ul className="space-y-3 mb-8">
                  {[
                    "Team or individual play",
                    "Facilitated discussions & debrief",
                ...
                <div className="overflow-hidden rounded-xl">
                  <img
                    src={formatImg2}
                    alt="Interactive Case Simulations"
                    className="w-full h-48 object-cover"
                    loading="lazy"
                  />
                </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center mb-14">
              ...
              <p className="text-forest/60 text-[1.05rem] max-w-xl mx-auto">
                See how our games create dynamic, immersive learning experiences in classrooms and
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-white/70 text-[15px] leading-relaxed mb-8">
                  Whether you want to integrate an existing game, run a facilitated workshop, or
                  create a custom simulation, we'll help you deliver impactful learning experiences
                  that your students will remember.
                </p>
        ...
        {selectedGameIndex !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-3xl bg-white shadow-2xl transition-all flex flex-col md:flex-row">
              ...
              <div
                className="relative h-72 md:h-auto md:w-5/12 flex-shrink-0 bg-cover bg-center"
                style={{ backgroundImage: `url(${portfolioImages[selectedGameIndex]})` }}
              >
              ...
              <div className="p-8 md:p-10 md:w-7/12 flex flex-col bg-[#F7F5F0]">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-forest/5 shadow-sm">
                    ...
                    <p className="text-[13px] font-semibold text-forest">
                      {gamePortfolio[selectedGameIndex].duration}
                    </p>
                  </div>
                </div>
                  ...
                  <ul className="space-y-3">
                    {gamePortfolio[selectedGameIndex].objectives.map((obj, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        ...
                        <span className="text-[14.5px] leading-relaxed text-forest/80 font-medium">
                          {obj}
                        </span>
                      </li>
                    ))}
