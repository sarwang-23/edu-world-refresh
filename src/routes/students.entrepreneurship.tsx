...
export const Route = createFileRoute('/students/entrepreneurship')({
  head: () => ({
    meta: [
  ...
  return (
    <section className="relative bg-[#F4EFE6] overflow-hidden pt-20 pb-36 md:pt-28 md:pb-44">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <Link
          to="/students"
          className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.18em] text-gold mb-10 hover:text-gold/70 transition-colors"
        >
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <Link
                to="/students"
                className="inline-flex items-center gap-2 rounded-full border border-forest/20 bg-white px-7 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-forest hover:border-gold/40 transition-all duration-300"
              >
                View All Tracks
              </Link>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">What You'll Do</span>
            <div className="h-px w-8 bg-gold" />
          </div>
    ...
    <section className="py-24 bg-[#F4EFE6]">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Programme Modules</span>
            <div className="h-px w-8 bg-gold" />
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((m, i) => (
            <div key={i} className="rounded-[1.5rem] bg-white border border-forest/8 p-7 hover:border-gold/30 hover:shadow-[0_12px_36px_rgba(26,53,35,0.09)] transition-all duration-300 shadow-sm group">
              <span className="text-[11px] font-black text-gold/50 tracking-[0.2em] group-hover:text-gold transition-colors duration-300">{m.num}</span>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              <div className="h-px w-8 bg-gold" />
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">What You'll Leave With</span>
            </div>
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-4 mb-5">
                ...
                <p className="text-[13px] text-cream/75 leading-[1.65] mt-1">{o.text}</p>
              </div>
            ))}
          </div>
  ...
  return (
    <section className="bg-[#F4EFE6] py-24 text-center">
      <div className="mx-auto max-w-2xl px-6">
        <div className="flex items-center justify-center gap-3 mb-5">
          <div className="h-px w-8 bg-gold" />
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Join the Track</span>
          <div className="h-px w-8 bg-gold" />
        </div>
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-full bg-gold px-10 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-forest-deep hover:bg-amber-400 transition-all duration-300 shadow-xl shadow-gold/25"
        >
