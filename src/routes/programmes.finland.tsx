  ...
  head: () => ({
    meta: [
      { title: "Finland Education Study Visit — Global Edu Lab" },
      {
        name: "description",
        content:
          "An immersive 5-day study visit to Finland — learn from the world's top-performing education system through school visits, policy sessions, and expert faculty interactions.",
      },
      { property: "og:title", content: "Finland Education Study Visit" },
      {
        property: "og:description",
        content:
          "Experience the Finnish education miracle first-hand. School visits, policy dialogues, and leadership workshops in Helsinki and Espoo.",
      },
    ],
  }),
  component: Page,
  ...
  const testimonials = [
    {
      ...
      school: "Headmistress, Greenfields International School, Bengaluru",
      quote:
        "Walking through a Finnish school and seeing the joy, the autonomy, and the trust between teachers and students was profoundly moving. GEL made this possible and the programme was impeccably organised.",
      initials: "SK",
    },
    {
      name: "Vikram Anand",
      school: "Director, Anand School Group, Chennai",
      quote:
        "The Finland visit was a career-defining experience. The research sessions at the University of Helsinki and the school observations gave me a blueprint for school reform I've been building ever since.",
      initials: "VA",
    },
  ];
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-2xl p-8 bg-forest-deep text-white border border-forest-deep relative overflow-hidden shadow-xl">
              ...
              <p className="text-[24px] font-bold text-white mb-3">
                Early bird starts at 1,800 EUR
              </p>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications open for the September 2026 cohort. Limited seats — secure yours today.
        </p>
