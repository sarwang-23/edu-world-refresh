  ...
  head: () => ({
    meta: [
      { title: "London School Leadership Programme — Global Edu Lab" },
      {
        name: "description",
        content:
          "A premium 5-day leadership programme in London — from the House of Lords to leading independent school visits, policy dialogues and Westminster networking.",
      },
      { property: "og:title", content: "London School Leadership Programme" },
      {
        property: "og:description",
        content:
          "Experience the best of British education leadership. House of Lords visits, independent school tours, and policy dialogues in London.",
      },
    ],
  }),
  component: Page,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-[15px] text-forest/65 leading-relaxed max-w-lg">
              The London School Leadership Programme (LLP) is a premium 5-day executive experience
              in the heart of Britain's capital. Visit the Houses of Parliament, meet policy makers,
              explore leading independent and state schools, and return with a global leadership
              perspective anchored in British institutional excellence.
            </p>
  ...
  const pillars = [
    {
      ...
      items: [
        "Visit the Houses of Parliament & meet MPs",
        "Policy dialogues on the British education system",
        "Understand Ofsted, curriculum frameworks and school governance",
      ],
    },
    {
      ...
      items: [
        "Visits to top-ranked independent and state schools",
        "Discussions with British headteachers & governors",
        "Observe British pedagogical models in real classrooms",
      ],
    },
    {
      ...
      items: [
        "London networking dinners with senior educators",
        "Interactions with global school leaders & policy experts",
        "Lifelong GEL London Leadership Alumni membership",
      ],
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Experience leadership, the London way!
          </h2>
        </div>
  ...
  const profiles = [
    {
      ...
      desc: "Those who want to benchmark their institution against the British independent school model and understand global education governance.",
      icon: <Building2 className="h-6 w-6" />,
      color: "bg-forest",
    },
    {
      title: "Next-gen Education Leaders",
      desc: "Aspiring leaders who want exposure to Westminster policy dialogues, British boarding schools and international school governance.",
      icon: <GraduationCap className="h-6 w-6" />,
      color: "bg-gold",
    },
    {
      title: "Education Policy Advisors",
      desc: "Those who want to understand how British education policy drives school performance and what lessons can be applied in the Indian context.",
...
function Schedule() {
  const days = [
    {
      day: "Day 1",
      location: "Arrival in London",
      items: [
        "Welcome reception & programme orientation",
        "Evening networking dinner with the cohort",
      ],
    },
    {
      day: "Day 2",
      location: "Westminster & Policy",
      items: [
        "Visit to Houses of Parliament",
        "Briefing session with education policy experts",
        "Westminster policy dialogue on school standards",
      ],
    },
    {
      day: "Day 3",
      location: "School Immersions",
      items: [
        "Visits to 2 leading London independent schools",
        "Headteacher Q&A and classroom observations",
        "Networking dinner with senior British educators",
      ],
    },
    {
      day: "Day 4",
      location: "Leadership & London",
      items: [
        "Leadership workshop: Adapting British governance",
        "City of London tour & cultural programme",
        "Formal award dinner & certificate ceremony",
      ],
    },
    {
      day: "Day 5",
      location: "Departure",
      items: ["Final reflection & action planning session", "Check out & departures"],
    },
  ];
  return (
    <section id="schedule" className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-14">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Programme Schedule{" "}
            <span className="text-forest/40 font-medium text-2xl">(Indicative)</span>
          </h2>
        </div>
        <div className="grid md:grid-cols-3 gap-4">
          {days.map((d, i) => (
            ...
            >
              <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-forest/40">
                {d.day}
              </span>
              ...
              <ul className="space-y-2">
                {d.items.map((it, k) => (
                  <li
                    key={k}
                    className="flex items-start gap-2 text-[14px] text-forest/70 leading-relaxed"
                  >
        ...
        <p className="mt-8 text-[14px] italic text-forest/40">
  ...
  const testimonials = [
    {
      ...
      school: "Principal, Delhi Public School, Hyderabad",
      quote:
        "Walking through the Houses of Parliament and discussing education policy with British parliamentarians was an experience I'll carry for life. GEL delivered an impeccably curated week that elevated my entire perspective on school leadership.",
      initials: "MS",
    },
    {
      name: "Arjun Mehta",
      school: "School Director, Mehta Foundation Schools, Mumbai",
      quote:
        "The London programme gave me access to institutions and conversations that I simply couldn't have arranged on my own. The independent school visits and Westminster policy dialogue were extraordinary. Highly recommended for any serious school leader.",
      initials: "AM",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {details.map((d, i) => (
            ...
            >
              <p className="text-[14px] font-bold uppercase tracking-[0.2em] mb-2 text-forest/40">
                {d.label}
              </p>
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-2xl p-8 bg-forest-deep text-white border border-forest-deep relative overflow-hidden shadow-xl">
              ...
              <p className="text-[24px] font-bold text-white mb-3">
                Early bird starts at 1,900 GBP
              </p>
              <span className="inline-block text-[14px] font-semibold text-white/70">
              ...
              <div className="mb-10">
                ...
                <ul className="space-y-3.5">
                  {inclusions.map((item, i) => (
                    <li
                      key={i}
                      className="flex items-start gap-3 text-[14px] text-forest/75 leading-relaxed"
                    >
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-gold shrink-0" />
                      {item}
                    </li>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white leading-tight">
          Bring London's leadership excellence to your school.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications open for the January 2026 cohort. Limited seats — secure yours today.
        </p>
