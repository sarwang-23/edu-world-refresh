  ...
  head: () => ({
    meta: [
      { title: "Global Impact of Cambridge Startups · House of Lords — Global Edu Lab" },
      {
        name: "description",
        content:
          "An exclusive invite-only evening at the House of Lords celebrating the global impact of Cambridge-born startups. October 2026.",
      },
      { property: "og:title", content: "Global Impact of Cambridge Startups · House of Lords" },
      {
        property: "og:description",
        content:
          "Invite-only evening celebrating Cambridge startups at the House of Lords, Westminster.",
      },
    ],
  }),
  component: Page,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-[15px] text-forest/65 leading-relaxed max-w-lg">
              An exclusive, invite-only evening at the Palace of Westminster honouring the founders,
              investors and researchers behind Cambridge&rsquo;s most impactful global ventures —
              bringing together the UK-India business corridor under one historic roof.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Where Cambridge meets Westminster.
          </h2>
          <p className="mt-4 text-[15px] text-forest/65 max-w-2xl mx-auto leading-relaxed">
            An evening that brings together two of the most important institutions in the UK — the
            University of Cambridge and the UK Parliament — to celebrate global innovation and the
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {items.map((it, i) => (
            <div
              key={i}
              className="group bg-[#F7F5F0] rounded-3xl p-8 border border-forest/8 hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-gold shadow-sm group-hover:bg-gold/10 transition-colors duration-300">
                {it.icon}
              </div>
...
function WhatToExpect() {
  const agenda = [
    {
      time: "6:00 PM",
      title: "Guest Arrival & Champagne Reception",
      desc: "Arrive at the Palace of Westminster. Welcome drinks in the riverside rooms overlooking the Thames.",
    },
    {
      time: "6:45 PM",
      title: "Opening Remarks",
      desc: "Words from Global Education Lab and our co-hosts from the House of Lords.",
    },
    {
      time: "7:00 PM",
      title: "Cambridge Startup Showcase",
      desc: "Brief pitches and spotlights from Cambridge's most impactful ventures — across sectors including AI, biotech, fintech, and climate.",
    },
    {
      time: "7:45 PM",
      title: "Panel Discussion",
      desc: "A curated conversation between Cambridge founders, UK-India investors and policy-makers on the future of the innovation corridor.",
    },
    {
      time: "8:30 PM",
      title: "Dinner & Networking",
      desc: "Formal dinner in the historic dining rooms of the House of Lords. The evening continues with structured and informal networking.",
    },
    {
      time: "10:00 PM",
      title: "Closing & Private Tour",
      desc: "A private tour of the House of Lords chambers for a small group of guests before departure.",
    },
  ];
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {agenda.map((item, i) => (
            <div
              key={i}
              className="rounded-3xl border border-white/10 bg-white/5 p-8 hover:bg-white/10 hover:border-gold/30 transition-all duration-300"
            >
              <p className="text-[15px] font-bold text-gold uppercase tracking-[0.2em] mb-2">
                {item.time}
              </p>
  ...
  const profiles = [
    {
      ...
      title: "Lords & Peers",
      desc: "Members of the House of Lords with interests in business, innovation, education and the UK-India relationship.",
      color: "bg-forest-deep",
    },
    {
      icon: <Rocket className="h-6 w-6" />,
      title: "Cambridge Founders",
      desc: "Founders of high-growth Cambridge ventures across AI, biotech, fintech, climate and deep tech.",
      color: "bg-gold",
    },
    {
      icon: <Globe2 className="h-6 w-6" />,
      title: "Global Investors",
      desc: "VCs and family offices active in the UK-India corridor with strong interest in Cambridge's innovation output.",
      color: "bg-forest",
    },
    {
      icon: <Building2 className="h-6 w-6" />,
      title: "Business Leaders",
      desc: "Senior executives from UK and Indian corporates exploring innovation partnerships and ecosystem access.",
      color: "bg-forest/60",
    },
  ];
  return (
    <section className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            A genuinely curated room.
          </h2>
          <p className="mt-4 text-[15px] text-forest/65 max-w-xl mx-auto">
            Every guest is handpicked. The evening is designed for quality of connection, not
            quantity of attendance.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {profiles.map((p, i) => (
            <div
              key={i}
              className="group rounded-3xl border border-forest/8 bg-white overflow-hidden hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-500"
            >
              <div className={`h-1.5 w-full ${p.color}`} />
              <div className="p-7">
                <div
                  className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl ${p.color} text-white shadow-lg`}
                >
                  {p.icon}
                </div>
  ...
  const testimonials = [
    {
      ...
      initials: "LB",
      quote:
        "A remarkable evening that captured the very best of what the Cambridge-India relationship can produce. The calibre of founders and investors in the room was extraordinary.",
    },
    {
      name: "Priya Nair",
      ...
      initials: "PN",
      quote:
        "I made three introductions at this event that have since led to term sheets. There is nowhere else in London where you get this precise combination of Cambridge innovation and UK-India capital in one room.",
    },
    {
      name: "Dr. Arjun Singh",
      ...
      initials: "AS",
      quote:
        "Being showcased at the House of Lords was one of the proudest moments of our startup journey. The doors it opened — with investors, partners and policymakers — were genuinely transformative.",
    },
  ];
    ...
    <section className="bg-white py-24">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="text-[2rem] md:text-[2.4rem] font-bold text-forest-deep mb-16">
          What guests say about the evening.
        </h2>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          The October 2026 evening is now open for invitation requests. Submit your interest and our
