        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Invite-Only · UK Parliament</span>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 border border-forest/8">
              ...
              <div>
                <p className="text-[11px] font-bold text-forest-deep uppercase tracking-wider">UK Parliament</p>
                <p className="text-[10px] text-forest/55 mt-0.5">Westminster</p>
              </div>
            </div>
            <div className="absolute -top-5 -right-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 border border-forest/8">
              ...
              <div>
                <p className="text-[11px] font-bold text-forest-deep uppercase tracking-wider">By Invitation</p>
                <p className="text-[10px] text-forest/55 mt-0.5">Only</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">About the Evening</span>
            <div className="h-px w-8 bg-gold" />
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {items.map((it, i) => (
            <div key={i} className="group bg-[#F7F5F0] rounded-3xl p-8 border border-forest/8 hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-[13px] text-forest/70 leading-relaxed">{it.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="bg-forest-deep py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Evening Programme</span>
            <div className="h-px w-8 bg-gold" />
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {agenda.map((item, i) => (
            <div key={i} className="rounded-3xl border border-white/10 bg-white/5 p-8 hover:bg-white/10 hover:border-gold/30 transition-all duration-300">
              <p className="text-[11px] font-bold text-gold uppercase tracking-[0.2em] mb-2">{item.time}</p>
    ...
    <section className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Who Attends</span>
            <div className="h-px w-8 bg-gold" />
          </div>
  ...
  return (
    <section className="bg-white py-24">
      <div className="mx-auto max-w-4xl px-6 text-center">
        <div className="flex items-center justify-center gap-3 mb-5">
          <div className="h-px w-8 bg-gold" />
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Voices from Past Editions</span>
          <div className="h-px w-8 bg-gold" />
        </div>
  ...
  return (
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        <div className="flex items-center justify-center gap-3 mb-5">
          <div className="h-px w-8 bg-gold" />
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">By Invitation Only</span>
          <div className="h-px w-8 bg-gold" />
        </div>
