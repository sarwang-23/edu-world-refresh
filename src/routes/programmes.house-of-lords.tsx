        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          <div className="lg:col-span-6">
            ...
            <p className="mt-5 text-[15px] text-forest/80 leading-relaxed max-w-lg">
              ...
              bringing together global innovation leaders under one historic roof.
            </p>
            ...
            <div className="mt-10 flex gap-4 flex-wrap">
              <Link
                to="/apply-now"
                search={{ source: "House of Lords — Cambridge Startups" }}
          ...
          <div className="relative lg:col-span-6">
            <div className="relative aspect-[5/4] overflow-hidden rounded-[2rem] shadow-2xl shadow-forest/20 group">
              <img
                src={houseOfLordsImg}
                alt="UK Parliament House of Lords Delegation"
    ...
    <section className="bg-white py-24 border-t border-forest/5">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-[15px] text-forest/80 max-w-2xl mx-auto leading-relaxed">
            An evening that brings together two of the most important institutions in the UK — the
            University of Cambridge and the UK Parliament — to celebrate global innovation,
...
function WhatToExpect() {
  const agenda = [
    ...
    },
    {
      ...
      desc: "A curated conversation between Cambridge founders, global investors and policy-makers on the future of the innovation corridor.",
    },
    {
      time: "8:30 PM",
  ...
  const profiles = [
    {
      ...
      title: "Lords & Peers",
      desc: "Members of the House of Lords with interests in business, innovation, education and global policy.",
    ...
    },
    {
      ...
      desc: "VCs and family offices active globally with strong interest in Cambridge's innovation output.",
      color: "bg-forest",
    },
    {
      icon: <Building2 className="h-6 w-6" />,
      title: "Business Leaders",
      desc: "Senior executives from global corporates exploring innovation partnerships and ecosystem access.",
      color: "bg-forest/60",
    },
  ];
  return (
    <section className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-[15px] text-forest/80 max-w-xl mx-auto">
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          The invitation evening is now open for request submissions. Submit your interest and our
