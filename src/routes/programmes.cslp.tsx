...
function Testimonials() {
  const testimonials = [
    { name: 'Dr. Aparna S Porob Palyekar', school: 'Blooming Buds Primary School, Goa', quote: 'I am grateful for Cambridge Education Lab for conducting such an insightful educational exploration. It gave us an opportunity to experience the life at Cambridge University. We were able to learn from many educators and important dignitaries.', img: person8Img },
    { name: 'Suria Sharma', school: 'Education Leader, New Delhi', quote: 'An unmatched experience that transformed my perspective on school leadership. The Cambridge faculty sessions and school visits were eye-opening and gave us a truly global lens.', img: person9Img },
  ]
