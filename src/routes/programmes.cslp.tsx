        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          <div className="lg:col-span-6">
            ...
            <p className="mt-5 text-[15px] text-forest/80 leading-relaxed max-w-lg">
              The Global India Leadership Programme is a Cambridge–India executive leadership
            ...
            <div className="mt-10 flex gap-3.5 flex-wrap sm:flex-nowrap items-center">
              <Link
                to="/apply-now"
                search={{ source: "Cambridge School Leadership Programme" }}
