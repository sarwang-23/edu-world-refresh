  ...
  head: () => ({
    meta: [
      { title: "Cambridge School Leadership Programme — Global Edu Lab" },
      {
        name: "description",
        content:
          "Shape the future of your school with the Cambridge–India executive leadership bridge, accessible, affordable and globally relevant.",
      },
      { property: "og:title", content: "Cambridge School Leadership Programme" },
      {
        property: "og:description",
        content: "High-quality Cambridge leadership training for Indian school leaders.",
      },
    ],
  }),
  component: Page,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-[15px] text-forest/65 leading-relaxed max-w-lg">
              The Global India Leadership Programme 2026 is a Cambridge–India executive leadership
              bridge, designed to make high-quality leadership training at Cambridge accessible,
              affordable, and globally relevant, with a strong emphasis on AI, innovation,
              negotiation, finance, and cross-cultural leadership.
            </p>
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-forest/15 aspect-[4/3]">
              <img
                src={cambridgeImg}
                alt="Cambridge School Leadership Programme"
            ...
            <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 border border-forest/8">
              ...
              <div>
                ...
                <p className="text-[14px] text-forest/55 mt-0.5">Award Ceremony Included</p>
              </div>
            </div>
          </div>
        </div>
  ...
  const pillars = [
    {
      ...
      items: [
        "School visits & reflection",
        "Seminars by senior education researchers",
        "Learn from peers",
      ],
    },
    {
      ...
      items: [
        ...
        "Workshops by leading Cambridge Professors",
        "Interactions with global business leaders",
      ],
    },
    {
      ...
      items: [
        "Join networking dinner",
        "Socialising activities",
        "Become an Alumni for lifelong leader",
      ],
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Experience learning, the Cambridge way!
          </h2>
        </div>
  ...
  const profiles = [
    {
      ...
      desc: "Those who want to take away international best practices and strategies to elevate their schools to the next level.",
      icon: <Building2 className="h-6 w-6" />,
      color: "bg-forest",
    },
    {
      title: "Next-gen Edu Leaders",
      desc: "Those who want to step into a leadership role within the education sector & need the knowledge to succeed.",
      icon: <GraduationCap className="h-6 w-6" />,
      color: "bg-gold",
    },
    {
      title: "Policy Advisors / Experts",
      desc: "Those who want to equip themselves with global best practices and leverage it to analyse education policies.",
...
function Schedule() {
  const days = [
    { day: "Day 1", location: "Home to London", items: ["Arrival at Cambridge"] },
    {
      day: "Day 2",
      location: "Cambridge",
      items: ["Breakfast", "Workshops and sessions until 6 pm"],
    },
    {
      day: "Day 3",
      location: "Cambridge",
      items: [
        "Theme - Site visits",
        "Faculty of Education, Cambridge Judge Business School",
        "School Visit",
        "Networking Dinner",
      ],
    },
    {
      ...
      items: [
        "Cambridge city tour",
        "Leadership sessions",
        "Formal dinner at a Cambridge college",
...
function Testimonials() {
  const testimonials = [
    {
      name: "Dr. Aparna S Porob Palyekar",
      school: "Blooming Buds Primary School, Goa",
      quote:
        "I am grateful for Cambridge Education Lab for conducting such an insightful educational exploration. It gave us an opportunity to experience the life at Cambridge University. We were able to learn from many educators and important dignitaries.",
      initials: "AP",
    },
    {
      name: "Suria Sharma",
      school: "Education Leader, New Delhi",
      quote:
        "An unmatched experience that transformed my perspective on school leadership. The Cambridge faculty sessions and school visits were eye-opening and gave us a truly global lens.",
      initials: "SS",
    },
  ];
...
function ProgrammeDetails() {
  ...
  const exclusions = ["All travel and Visa costs", "Meals not mentioned in itinerary"];
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white leading-tight">
          Bring Cambridge home to your school.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications open for the March 2026 cohort. Limited seats - secure yours today.
        </p>
