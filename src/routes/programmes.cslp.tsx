          ...
          <div className="relative lg:col-span-6">
            <div className="relative aspect-[5/4] overflow-hidden rounded-[2rem] shadow-2xl shadow-forest/20 group">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between text-white">
                <div>
                  <p className="text-[13px] font-bold uppercase tracking-[0.25em] text-gold mb-1">Cambridge Certified</p>
                  <p className="text-[16px] font-bold">University of Cambridge, UK</p>
                </div>
              </div>
            </div>
          </div>
