        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3 border border-forest/8">
              ...
              <div>
                <p className="text-[13px] font-bold text-forest-deep uppercase tracking-wider">Cambridge Certified</p>
                <p className="text-[12px] text-forest/55 mt-0.5">Award Ceremony Included</p>
              </div>
            </div>
          </div>
        </div>
