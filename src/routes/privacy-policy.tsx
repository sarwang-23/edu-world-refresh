        ...
        <div className="mx-auto max-w-4xl px-6 py-12 lg:py-16">
          ...
          <div className="mt-8 rounded-[1.5rem] border border-forest/10 bg-white p-6 shadow-sm md:p-8">
            <p className="text-[15px] leading-[1.8] text-foreground">
              Global Education Lab Ltd (“we”, “our”, “us”) is committed to protecting and respecting
            ...
            <div className="mt-8 space-y-6 text-[15px] leading-[1.8] text-foreground">
              <section>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
                  ...
                  <li>
                    References to sub-clauses, clauses, schedules, or appendices refer to those
                    within this policy.
                  </li>
                  <li>
                    References to “person” include firms, companies, government entities, trusts,
                    and partnerships.
                  </li>
                  <li>“Including” is understood to mean “including without limitation.”</li>
                  <li>
                    References to statutory provisions include any modification or amendment
                    thereof.
                  </li>
                  <li>
                    Headings and sub-headings are for convenience only and do not affect
                    interpretation.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  This policy applies only to the actions of Global Education Lab Ltd and users with
                  respect to this website. It does not extend to any third-party websites accessible
                  through links on this site, including social media.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  For purposes of the UK Data Protection Act 2018 and UK GDPR, Global Education Lab
                  Ltd is the “data controller.” We determine the purposes and manner in which your
                  data is processed.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">a. You provide it directly:</p>
                <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
                ...
                <p className="mt-3 text-muted-foreground">b. Automatically collected:</p>
                <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
              ...
              <section>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
                  ...
                  <li>
                    Share anonymised data with accredited research organisations for educational
                    research
                  </li>
                </ul>
                <p className="mt-3 text-muted-foreground">Legal bases:</p>
                <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
              ...
              <section>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
                  <li>
                    Group companies/affiliates: administration, service delivery, personalised
                    recommendations
                  </li>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  If you suspect misuse, loss, or unauthorised access,{" "}
                  <a href="mailto:contactinfo@globaledulab.com" className="hover:text-forest">
                    contactinfo@globaledulab.com
                  </a>{" "}
                  immediately.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  We retain data only as long as necessary for the purposes outlined, unless law
                  requires longer. Deleted data may persist in backups for legal or regulatory
                  reasons.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  To exercise rights or withdraw consent, email{" "}
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  If our business is sold or reorganised, relevant user data may be transferred to
                  the new owner under this policy. We may also disclose data to prospective
                  purchasers. We will take steps to protect your privacy.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-muted-foreground">
                  (See our separate Cookie Policy for details on essential, analytics, and marketing
                  cookies.)
                </p>
              </section>
