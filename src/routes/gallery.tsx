        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 pb-20 lg:grid-cols-12 lg:gap-16 pt-28">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[14px] font-bold tracking-[0.25em] text-gold uppercase">
            ...
            <h1 className="text-[2.75rem] font-bold leading-[1.05] text-forest md:text-6xl lg:text-[4rem] xl:text-[4.5rem]">
              Rooms where <br />
              <span className="text-gold font-serif italic font-normal">futures</span>
              <br />
              are drafted.
            </h1>

            <p className="max-w-xl text-[17px] leading-[1.65] text-forest/70">
              A cinematic archive of leaders, educators and learners across our programmes —
              delivered in the UK, India, Finland, Estonia and Indonesia.
            </p>
            ...
            <div className="pt-8 border-t border-forest/10 grid grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-[15px] font-bold tracking-[0.2em] text-forest/50 uppercase">
                  Countries
                </p>
              </div>
              <div>
            ...
            <div key={i} className="flex gap-8 items-center shrink-0">
              {[
                ...
                <div key={`${i}-${j}`} className="flex items-center gap-8">
                  <span className="text-[14px] font-bold tracking-[0.2em] text-forest/40 uppercase">
                    {city}
                  </span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[14px] font-bold tracking-[0.3em] text-gold uppercase">
                  Chapter 01 — Corporate Leadership
                </span>
              </div>
            ...
            <p className="text-[14px] text-forest/70 max-w-sm leading-relaxed">
              Over 150 business leaders trained through advanced workshops delivered in partnership
              with the University of Cambridge and other trusted institutions.
            </p>
          </div>
      ...
      <section className="relative h-[600px] md:h-[800px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 md:p-24 z-10">
          ...
          <p className="text-[14px] text-white/80 max-w-lg leading-relaxed">
            Highlights from previous programmes across the UK, India, Finland, Estonia and
            Indonesia.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
            <div>
              ...
              <h2 className="text-[2.5rem] md:text-[3.5rem] font-bold text-forest-deep tracking-tight leading-[1.1]">
                Educators, <span className="font-serif italic text-gold">in dialogue.</span>
              </h2>
            </div>
            <p className="text-[14px] text-forest/70 max-w-sm leading-relaxed">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
            <div>
              ...
              <h2 className="text-[2.5rem] md:text-[3.5rem] font-bold text-forest-deep tracking-tight leading-[1.1] max-w-xl">
                The next generation, <span className="font-serif italic text-gold">at work.</span>
              </h2>
            </div>
            <p className="text-[14px] text-forest/70 max-w-sm leading-relaxed">
              STEM and Entrepreneurship workshops & summer camps for 5,000+ students — from young
              learners to undergraduates.
            </p>
          </div>
          ...
          <div className="columns-2 md:columns-4 gap-4 space-y-4">
            {[
              ...
              <div
                key={i}
                className={`rounded-[2rem] overflow-hidden relative break-inside-avoid group ${ratio}`}
              >
                <img
                  src={images[(i + 3) % images.length]}
                  alt="Student Programmes"
        ...
        <div className="mx-auto max-w-[1400px] flex flex-col lg:flex-row items-start lg:items-end justify-between gap-12">
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[14px] font-bold uppercase tracking-[0.3em] text-[#C19842]">
