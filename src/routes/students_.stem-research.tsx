  ...
  head: () => ({
    meta: [
      { title: "STEM Research Track | Young Leaders Summer Programme" },
      {
        name: "description",
        content:
          "Ask questions, explore data and discover insights on the STEM Research track at Cambridge.",
      },
    ],
  }),
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[14px] font-bold uppercase tracking-[0.3em] text-blue-600">
              What You'll Do
            </span>
            <div className="h-px w-8 bg-blue-500" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[14px] font-bold uppercase tracking-[0.3em] text-blue-400">
