...
export const Route = createFileRoute("/students_/stem-research")({
  head: () => buildMeta("/students/stem-research"),
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-[2rem] sm:text-[3rem] md:text-[4rem] font-bold text-forest-deep leading-[1.05] mb-5">
              Ask questions.
              <br />
            ...
            <p className="text-[15px] text-forest/80 leading-[1.8] max-w-md mb-10">
              ...
              insights create a better world — right at Cambridge University.
            </p>

            <div className="flex gap-3.5 flex-wrap sm:flex-nowrap items-center">
              <Link
                to="/apply-now"
                search={{ source: "STEM Research Track" }}
  ...
  const pillars = [
    {
      ...
      desc: "Learn scientific methods, hypothesis formation and evidence-based reasoning.",
    },
    {
      icon: <FlaskConical className="h-6 w-6" />,
      title: "Science Exploration",
      desc: "Hands-on experiments and lab-style workshops guided by Cambridge researchers.",
    },
    {
      icon: <BrainCircuit className="h-6 w-6" />,
      title: "AI in Research",
      desc: "Explore how artificial intelligence is transforming modern scientific discovery.",
    },
    {
      icon: <Telescope className="h-6 w-6" />,
      title: "Present Findings",
      desc: "Communicate your discoveries clearly and confidently to a real audience.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[15px] font-bold uppercase tracking-[0.3em] text-blue-600">
              What You'll Do
            </span>
            <div className="h-px w-8 bg-blue-500" />
          </div>
          ...
          <p className="text-[15px] text-forest/80 max-w-lg mx-auto leading-[1.75]">
            Everything is designed to build genuine research capability and scientific curiosity.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((p, i) => (
            <div
              key={i}
              className="group rounded-[1.5rem] border border-forest/8 bg-white p-7 hover:border-blue-400/35 hover:shadow-[0_16px_48px_rgba(37,99,235,0.10)] hover:-translate-y-1 transition-all duration-400 shadow-sm"
            >
              ...
              <h3 className="text-[15px] font-bold text-forest-deep mb-2 group-hover:text-blue-600 transition-colors duration-300">
                {p.title}
              </h3>
  ...
  const modules = [
    {
      num: "01",
      title: "Research Thinking",
      items: ["Scientific method", "Hypothesis formation", "Critical analysis"],
    },
    {
      num: "02",
      title: "AI in Research",
      items: ["AI tools overview", "Data-driven insights", "Future of science"],
    },
    {
      num: "03",
      title: "Science Exploration",
      items: ["Lab-style workshops", "Cambridge facilities", "Guided experiments"],
    },
    {
      num: "04",
      title: "Collaborative Inquiry",
      items: ["Team research projects", "Peer review", "Constructive debate"],
    },
    {
      num: "05",
      title: "Evidence Basics",
      items: ["Evaluating sources", "Building arguments", "Logical reasoning"],
    },
    {
      num: "06",
      title: "Present Findings",
      items: ["Research presentation", "Q&A preparation", "Audience engagement"],
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((m, i) => (
            <div
              key={i}
              className="rounded-[1.5rem] bg-white border border-forest/8 p-7 hover:border-blue-400/30 hover:shadow-[0_12px_36px_rgba(37,99,235,0.09)] transition-all duration-300 shadow-sm group"
            >
              <span className="text-[15px] font-black text-blue-500/50 tracking-[0.2em] group-hover:text-blue-500 transition-colors duration-300">
                {m.num}
              </span>
              <h3 className="text-[15px] font-bold text-forest-deep mt-2 mb-4 group-hover:text-blue-600 transition-colors duration-300">
                {m.title}
              </h3>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[15px] font-bold uppercase tracking-[0.3em] text-blue-400">
                What You'll Leave With
              </span>
            </div>
            <h2 className="text-[2.4rem] font-bold text-white mb-6 leading-tight">
              More than knowledge. A scientific mindset.
            </h2>
            <p className="text-[15px] text-white/80 leading-[1.8] mb-8">
              Participants leave with not just STEM skills, but the research mindset, confidence and
              network to keep asking great questions.
            </p>
            {[
              {
                icon: <Trophy className="h-5 w-5" />,
                text: "Research completion certificate from Cambridge",
              },
              {
                icon: <Users className="h-5 w-5" />,
                text: "Network of STEM-passionate peers from across India",
              },
              {
                icon: <Rocket className="h-5 w-5" />,
                text: "A completed research project to showcase",
              },
              {
                icon: <Globe2 className="h-5 w-5" />,
                text: "Exposure to world-class research environments",
              },
            ].map((o, i) => (
  ...
  return (
    <section className="bg-[#F4EFE6] py-24 text-center">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="text-[15px] text-forest/80 leading-[1.75] mb-10">
          Applications are open for the Cambridge summer track. Secure your place today.
        </p>
        <Link
          to="/contact"
          search={{ source: "STEM Research Track" }}
