        ...
        <div className="flex-1 min-w-0">
          {fileName ? (
            <>
              ...
              <p className="text-[13px] text-forest/70 mt-0.5">Click to change file</p>
            </>
          ) : (
            <>
              <p className="text-[15px] font-semibold text-forest/70">{label}</p>
              <p className="text-[13px] text-forest/70 mt-0.5">Click to upload</p>
            </>
          )}
        </div>
        {fileName && (
        ...
        <div className="relative lg:w-[45%] lg:sticky lg:top-[73px] lg:h-[calc(100vh-73px)] bg-forest-deep overflow-y-auto">
          ...
          <div className="relative z-10 px-10 md:px-12 pt-10 pb-12 flex flex-col min-h-full">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[13px] font-bold tracking-[0.3em] text-gold uppercase">Registration</span>
            </div>
            ...
            <div className="flex-1">
              <p className="text-[13px] font-bold tracking-[0.25em] text-gold uppercase mb-6 flex items-center gap-3">
                ...
                {steps.map((step, i) => (
                  <div key={i} className="relative pl-10">
                    <div className="absolute -left-[14px] top-0 h-7 w-7 rounded-full bg-forest-deep border border-gold/40 flex items-center justify-center">
                      <span className="text-[13px] font-bold text-gold">{step.num}</span>
                    </div>
        ...
        <div className="lg:w-[55%] bg-white overflow-y-auto">
          <div className="flex min-h-full items-start justify-center px-8 md:px-14 lg:px-20 py-20">
            <div className="w-full max-w-[560px]">
              ...
              {/* ── Form heading ── */}
              <div className="mb-10">
                <span className="inline-flex items-center gap-2 text-[13px] font-bold tracking-[0.22em] text-gold uppercase mb-5">
