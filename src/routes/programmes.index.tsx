      ...
      <section className="py-24 bg-[#F4EFE6] relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10 pt-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            ...
            <Link
              to="/past-programmes"
              className="group inline-flex items-center gap-2 text-[15px] font-bold uppercase tracking-[0.1em] text-forest-deep hover:text-gold transition-colors pb-2"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filtered.map((p, i) => (
              <Link
                key={i}
                to={p.link}
                className="group flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden border border-forest/10 hover:shadow-2xl hover:shadow-forest/5 hover:-translate-y-1 transition-all duration-500"
              >
                ...
                <div className="flex flex-col flex-1 p-8">
                  <h3 className="text-xl font-bold text-forest-deep mb-3 leading-tight group-hover:text-gold transition-colors">
                    {p.title}
                  </h3>
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5">
              ...
              <h3 className="text-[2.2rem] md:text-[3rem] font-bold text-white mb-6 leading-[1.1]">
                Custom Programmes for Institutions.
              </h3>
              <p className="text-[15px] text-cream/70 leading-relaxed mb-10">
                We design and deliver tailor-made programmes for schools, universities, engaging
                1,000+ learners and 500+ school leaders aligned with your goals. From custom modules
                to end-to-end logistics in Cambridge.
              </p>
              <Link
                to="/partner-with-gel"
                className="group inline-flex items-center gap-2 rounded-full bg-gold px-8 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-forest-deep transition-all hover:bg-white shadow-xl"
              >
                Partner with GEL{" "}
                <ArrowUpRight className="h-4 w-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </Link>
            ...
            <div className="lg:col-span-7">
              <div className="grid sm:grid-cols-2 gap-4">
                {institutionalPartners.map((item, i) => (
                  <div
                    key={i}
                    className="flex flex-col gap-4 bg-white/5 border border-white/10 p-8 rounded-[2rem] backdrop-blur-md hover:bg-white/10 transition-colors group"
                  >
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="text-[15px] text-forest/70 leading-relaxed max-w-2xl">
              Over the years, we have delivered impactful programmes across 5 countries, engaging
              1,000+ learners and 500+ school leaders. Here's a glimpse into the transformative
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12">
            {pastImpactImgs.map((src, i) => (
              <div
                key={i}
                className={`rounded-[2rem] overflow-hidden shadow-xl shadow-forest/5 group ${i === 0 || i === 3 ? "aspect-[4/5]" : "aspect-square mt-0 md:mt-12"}`}
              >
                <img
                  src={src}
                  alt="Impact"
          ...
          <div className="flex justify-center">
            <Link
              to="/past-programmes"
              className="group inline-flex items-center gap-2 rounded-full bg-forest-deep px-8 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-cream hover:bg-forest transition-all duration-300 shadow-xl shadow-forest/20"
            >
              Past Programmes{" "}
              <ArrowUpRight className="h-4 w-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
            </Link>
      ...
      <section className="bg-forest-deep py-24 relative overflow-hidden border-t border-white/5">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="text-[16px] text-white/80 leading-relaxed max-w-2xl mx-auto mb-12">
            Our team is here to help you find the best fit for your goals. Whether you're an
            individual learner or an organization seeking custom solutions, let's talk.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              search={{ source: "Programmes Overview" }}
              className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-gold px-9 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-forest-deep hover:bg-white transition-all duration-300 shadow-xl shadow-black/20"
            >
              Let's Talk{" "}
              <ArrowUpRight className="h-4 w-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
            </Link>
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-9 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-white backdrop-blur-sm hover:bg-white/10 transition-all duration-300"
            >
  ...
  const items = [
    {
      ...
      subtitle: "Global India Leadership Programme at Cambridge Judge",
    },
    {
      img: zeroToOneImg,
      label: "Venture Ideation",
      subtitle: "48-Hour Zero-to-One Venture Building Weekend",
    },
    {
      img: youngLeadersImg,
      label: "Young Leaders",
      subtitle: "Immersive Cambridge Summer Experience for Ages 13-17",
    },
    {
      img: finlandImg,
      label: "Teacher Training",
      subtitle: "International Educator & Pedagogy Immersion",
    },
    {
      img: cambridgeRealImg,
      label: "Cambridge Experience",
      subtitle: "Networking With Policy Makers, Global Experience",
    },
    {
      img: graduateSummerImg,
      label: "Graduate Summer",
      subtitle: "2-Week Entrepreneurship & AI Summer School",
    },
  ];
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative z-20">
            ...
            <p className="mt-4 text-[15px] text-forest/80 leading-[1.75] max-w-md">
              Explore our upcoming programmes designed for students, founders, educators and
              leaders. Learn in Cambridge. Connect globally. Create impact.
            </p>
                ...
                {items.map((item, idx) => (
                  ...
                  >
                    <img
                      ...
                      loading="lazy"
                    />
                    {activeIndex === idx && <div className="absolute inset-0 bg-gold/15" />}
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <div className="group relative rounded-3xl bg-forest-deep p-8 text-white shadow-xl border border-white/10 flex flex-col justify-between flex-1 overflow-hidden hover:border-gold/40 transition-colors duration-300">
              ...
              <div>
                ...
                <p className="text-[15px] md:text-[15.5px] text-cream/95 leading-[1.7] font-normal mb-6">
                  "GEL's programmes offer a roadmap for frugal innovation across a broad segment of
                  learners. Learners return with fresh ideas, deeper confidence, and a renewed sense
                  of purpose, ready to lead change for businesses, teams or themselves."
                </p>
              </div>

              <div className="flex items-center gap-4 pt-4 border-t border-white/15">
                <img
                  src={jaideepPrabhuImg}
                  alt="Prof. Jaideep Prabhu FBA"
                  className="w-14 h-14 rounded-full object-cover border-2 border-gold shrink-0 shadow-md"
                  loading="lazy"
                />
                <div>
                  <h4 className="text-[16px] font-bold text-white leading-tight">
                    Prof. Jaideep Prabhu FBA
                  </h4>
                  <p className="text-[13px] text-cream/75 leading-tight mt-0.5">
                    Professor of Marketing & Vice Dean, Cambridge Judge Business School, University
                    of Cambridge
                  </p>
                </div>
              </div>
            ...
            <div className="group relative rounded-3xl bg-forest-deep p-8 text-white shadow-xl border border-white/10 flex flex-col justify-between flex-1 overflow-hidden hover:border-gold/40 transition-colors duration-300">
              ...
              <div>
                ...
                <p className="text-[15px] md:text-[15.5px] text-cream/95 leading-[1.7] font-normal mb-6">
                  "Through my participation in both the Cambridge and Finland programmes, I gained
                  exceptional exposure to the best global practices in education. This experience
                  has truly inspired me to implement some of these changes, which will positively
                  impact over 30,000 students across our institutions."
                </p>
              </div>
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-white/15">
                <img
                  src={lakshmiKothaImg}
                  alt="Lakshmi Samyuktha Kotha"
                  className="w-14 h-14 rounded-full object-cover border-2 border-gold shrink-0 shadow-md"
                  loading="lazy"
                />
                <div>
                  <h4 className="text-[16px] font-bold text-white leading-tight">
                    Lakshmi Samyuktha Kotha
                  </h4>
                  <p className="text-[13px] text-cream/75 leading-tight mt-0.5">
                    Executive Dean, Narayana Group of Schools – India
                  </p>
                </div>
              </div>
            </div>
                ...
                <div>
                  <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                    <div className="flex gap-0.5">
                      {[...Array(5)].map((_, si) => (
                        <span key={si} className="text-gold text-[13px]">
                          ★
                        </span>
                      ))}
                    </div>
                  ...
                  <span className="block text-[2.5rem] text-gold/80 font-serif leading-none -mt-1 -ml-1 select-none">
                    "
                  </span>
