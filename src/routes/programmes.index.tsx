    ...
    <div className="flex min-h-screen flex-col bg-white font-sans text-foreground">
      ...
      <div className="sticky top-[73px] z-40 bg-white/70 backdrop-blur-xl border-b border-forest/10 shadow-sm">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center gap-3 overflow-x-auto scrollbar-hide">
          <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-forest/50 mr-4 shrink-0 flex items-center gap-2">
          ...
          {FILTERS.map((f) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-[11px] font-bold uppercase tracking-wider whitespace-nowrap transition-all duration-300 ${
                activeFilter === f
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Explore</span>
              </div>
              <h2 className="text-[2.2rem] md:text-[3rem] font-bold text-forest-deep leading-tight">
                Upcoming Programmes
              </h2>
            </div>
            <Link to="/past-programmes" className="group inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.1em] text-forest-deep hover:text-gold transition-colors pb-2">
            ...
            {filtered.map((p, i) => (
              <Link key={i} to={p.link} className="group flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden border border-forest/10 hover:shadow-2xl hover:shadow-forest/5 hover:-translate-y-1 transition-all duration-500">
                <div className="relative aspect-[4/3] md:w-2/5 overflow-hidden shrink-0">
                  ...
                  <span className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg text-[9px] font-bold uppercase tracking-[0.15em] text-forest-deep shadow-sm">
                    {p.tag}
                  </span>
                </div>
                <div className="flex flex-col flex-1 p-8">
                  ...
                  <p className="text-[13px] text-forest/70 leading-relaxed mb-6 flex-1">{p.desc}</p>
                  
                  <div className="space-y-2 mb-6 pt-5 border-t border-forest/5">
                    <div className="flex items-center gap-2 text-[11px] font-bold text-forest-deep/80">
                  ...
                  <span className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.15em] text-forest-deep group-hover:text-gold transition-colors">
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5">
              <div className="inline-flex items-center gap-3 rounded-full border border-gold/25 bg-gold/10 px-4 py-1.5 backdrop-blur-sm mb-6">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gold">Partner With Us</span>
              </div>
              ...
              <Link to="/partner-with-gel" className="group inline-flex items-center gap-2 rounded-full bg-gold px-8 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-forest-deep transition-all hover:bg-white shadow-xl">
                ...
                {institutionalPartners.map((item, i) => (
                  <div key={i} className="flex flex-col gap-4 bg-white/5 border border-white/10 p-8 rounded-[2rem] backdrop-blur-md hover:bg-white/10 transition-colors group">
                    ...
                    <div>
                      ...
                      <p className="text-[13px] text-cream/60 leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center mb-16">
            <div className="flex items-center gap-3 mb-5">
              <div className="h-px w-8 bg-gold" />
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Global Reach</span>
              <div className="h-px w-8 bg-gold" />
            </div>
          ...
          <div className="flex justify-center">
            <Link to="/past-programmes" className="group inline-flex items-center gap-2 rounded-full bg-forest-deep px-8 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-cream hover:bg-forest transition-all duration-300 shadow-xl shadow-forest/20">
        ...
        <div className="grid lg:grid-cols-12 gap-14 items-center">
          <div className="lg:col-span-6 relative z-20">
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-gold/25 bg-gold/8 px-5 py-2 backdrop-blur-sm">
              <span className="h-1.5 w-1.5 rounded-full bg-gold animate-pulse" />
              <span className="text-[10px] font-bold uppercase tracking-[0.28em] text-gold">Our Programmes</span>
            </div>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              {[
                ...
                <div key={idx} className="inline-flex items-center gap-2 rounded-full bg-white/70 border border-forest/10 px-4 py-2 text-[11px] font-semibold text-forest-deep shadow-sm backdrop-blur-sm">
          ...
          <div className="lg:col-span-6 relative z-10">
            ...
            <div className="absolute -bottom-6 -left-6 flex items-center gap-3 rounded-2xl bg-white p-4 shadow-2xl shadow-forest/15 border border-forest/8 backdrop-blur-sm animate-[float_6s_ease-in-out_infinite]">
              ...
              <div>
                ...
                <p className="text-[10px] text-forest/55 mt-0.5">5+ Countries</p>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 flex items-center gap-3 rounded-2xl bg-white p-4 shadow-2xl shadow-forest/15 border border-forest/8 backdrop-blur-sm animate-[float_8s_ease-in-out_infinite_reverse]">
              ...
              <div>
                <p className="text-[11px] font-bold text-forest-deep uppercase tracking-wider">Alumni Network</p>
                <p className="text-[10px] text-forest/55 mt-0.5">1000+ Learners</p>
              </div>
            </div>
          </div>
        </div>
