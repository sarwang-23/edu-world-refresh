  ...
  head: () => ({
    meta: [
      { title: "Partner with GEL | Global Education Lab" },
      {
        name: "description",
        content:
          "Partner with Global Education Lab to create transformative learning experiences and lasting impact across the globe.",
      },
    ],
  }),
        ...
        <div className="grid lg:grid-cols-12 gap-14 lg:gap-20 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="mt-5 text-[16px] text-forest/70 leading-[1.7] max-w-xl">
              We collaborate with institutions, organisations and ecosystems across the UK, India,
              the Gulf and beyond to design and deliver high-impact programmes that develop people,
              drive innovation and build global connections.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Cambridge roots, worldwide reach.",
                },
                {
                  icon: <Target className="h-5 w-5" />,
                  title: "Tailored Partnerships",
                  desc: "Co-created around your objectives.",
                },
                {
                  icon: <TrendingUp className="h-5 w-5" />,
                  title: "Measurable Impact",
                  desc: "Outcomes that create lasting value.",
                },
              ].map((f, i) => (
                <div key={i}>
                  <div className="text-gold mb-2">{f.icon}</div>
                  <h4 className="text-[15px] font-bold text-forest-deep mb-1">{f.title}</h4>
                  <p className="text-[14px] text-forest/60 leading-relaxed">{f.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative lg:col-span-5">
            ...
            <div className="absolute -bottom-6 -left-6 bg-forest-deep border border-gold/20 p-6 rounded-2xl shadow-2xl flex flex-col justify-center min-w-[160px]">
              ...
              <span className="text-[15px] font-bold uppercase tracking-[0.15em] text-cream/70 mt-1">
                Countries Engaged
              </span>
            </div>
          </div>
    ...
    <div className="bg-white border-y border-forest/8 py-10 overflow-hidden w-full">
      ...
      <div className="animate-marquee flex items-center">
        {duplicatedStats.map((s, i) => (
          <div
            key={i}
            className="flex flex-col items-center justify-center px-8 md:px-16 w-64 md:w-80 border-r border-forest/10 shrink-0 text-center"
          >
            <span className="text-[2.2rem] font-bold text-forest-deep">{s.v}</span>
            <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-forest/50 mt-1">
              {s.l}
            </span>
          </div>
        ))}
    ...
    <section className="bg-[#F9F7F1] py-28 md:py-36">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-forest-deep mb-4 leading-[1.1]">
    ...
    <section className="bg-forest-deep py-28 md:py-36 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white mb-5 leading-[1.1]">
            Why partner with GEL?
          </h2>
          <p className="text-[15px] text-white/65 leading-[1.75]">
            An{" "}
            <span className="italic font-serif text-gold">international standard of delivery</span>,
            backed by an ecosystem that global institutions trust.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((r, i) => (
            <div
              key={i}
              className="group rounded-[1.75rem] border border-white/8 bg-white/5 backdrop-blur-sm p-8 hover:border-gold/30 hover:bg-white/10 hover:-translate-y-1.5 transition-all duration-400"
            >
              ...
              <h3 className="text-[15px] font-bold text-white mb-3 group-hover:text-gold transition-colors duration-300">
                {r.title}
              </h3>
  ...
  const steps = [
    {
      ...
      num: "01",
      title: "Discover",
      desc: "We listen and understand your goals, challenges and context.",
    },
    {
      icon: <PenTool className="w-6 h-6" />,
      num: "02",
      title: "Design",
      desc: "We co-create a tailored programme aligned with your objectives.",
    },
    {
      icon: <PlayCircle className="w-6 h-6" />,
      num: "03",
      title: "Deliver",
      desc: "We execute with excellence using the best faculty, tools and ecosystem partners.",
    },
    {
      icon: <BarChart className="w-6 h-6" />,
      num: "04",
      title: "Evaluate",
      desc: "We measure outcomes and gather insights for continuous improvement.",
    },
    {
      icon: <Repeat className="w-6 h-6" />,
      num: "05",
      title: "Sustain & Scale",
      desc: "We build long-term value and explore opportunities to scale impact together.",
    },
  ];
  return (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 relative z-10">
            {steps.map((s, i) => (
              <div key={i} className="group flex flex-col items-center text-center">
                ...
                <span className="text-[15px] font-black text-gold/50 tracking-[0.2em] mb-1">
                  {s.num}
                </span>
                <h4 className="text-[14px] font-bold text-forest-deep mb-3 group-hover:text-gold transition-colors duration-300">
                  {s.title}
                </h4>
  ...
  const logos = [
    ...
    <div className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border border-forest/10 bg-white w-56 shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 90 70" className="h-16 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="27" y="24" fontSize="14" textAnchor="middle" fill="#f5c842">
          ♞
        </text>
        <text x="63" y="24" fontSize="14" textAnchor="middle" fill="#f5c842">
          ♞
        </text>
        <text x="27" y="48" fontSize="9" textAnchor="middle" fill="#f5c842">
          ✦✦✦
        </text>
        <text x="63" y="48" fontSize="14" textAnchor="middle" fill="#f5c842">
          ♞
        </text>
        <path
          d="M10,4 H80 V50 Q45,70 45,70 Q45,70 10,50 Z"
          fill="none"
          stroke="#c8a030"
          strokeWidth="1.5"
        />
      </svg>
      <span className="text-[14px] font-black text-[#003b5c] text-center leading-tight tracking-wider uppercase mt-2">
        University of
        <br />
        Cambridge
      </span>
    ...
    <div className="flex flex-col items-center justify-center gap-1 p-6 rounded-2xl border border-forest/10 bg-white w-56 shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 60 50" className="h-14 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="18" y="16" fontSize="7" textAnchor="middle" fill="#222">
          ⁘
        </text>
        <circle cx="42" cy="13" r="7" fill="white" />
        <text x="42" y="16" fontSize="9" textAnchor="middle" fill="#e8294b">
          ☽
        </text>
        <circle cx="18" cy="32" r="5" fill="white" />
        <text x="18" y="35" fontSize="8" textAnchor="middle" fill="#e8294b">
          ☽
        </text>
        <circle cx="42" cy="32" r="5" fill="white" />
        <text x="42" y="35" fontSize="6" textAnchor="middle" fill="#222">
          ⁘
        </text>
        <path
          d="M6,2 H54 V34 Q30,50 30,50 Q30,50 6,34 Z"
          fill="none"
          stroke="#1a6b2a"
          strokeWidth="1"
        />
    ...
    <div className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border border-forest/10 bg-white w-56 shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 80 40" className="h-12 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="13" y="28" fontSize="5" fill="#c8a951" fontWeight="bold" textAnchor="middle">
          E-LAB
        </text>
        <text x="54" y="17" fontSize="7.5" fill="#1a1a2e" fontWeight="900" textAnchor="middle">
          KING'S
        </text>
        <text x="54" y="27" fontSize="7" fill="#c8a951" fontWeight="900" textAnchor="middle">
          E-LAB
        </text>
      </svg>
      <span className="text-[14px] font-bold text-forest-deep text-center leading-tight mt-1">
        King's E-Lab
      </span>
    </div>,
    // CISL
    <div className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border border-forest/10 bg-white w-56 shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 80 40" className="h-12 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="16" y="23.5" fontSize="5.5" fill="#1a1a1a" fontWeight="900" textAnchor="middle">
          CISL
        </text>
        <text x="54" y="16" fontSize="6.5" fill="#1a1a1a" fontWeight="900" textAnchor="middle">
          CISL
        </text>
        <text x="54" y="25" fontSize="4" fill="#555" textAnchor="middle">
          Cambridge
        </text>
        <text x="54" y="32" fontSize="3.8" fill="#555" textAnchor="middle">
          Sustainability
        </text>
      </svg>
      <span className="text-[14px] font-bold text-forest-deep text-center leading-tight mt-1">
    ...
    <div className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border border-forest/10 bg-white w-56 shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 80 40" className="h-12 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="15" y="30" fontSize="3.5" fill="#c8a951" textAnchor="middle">
          EST. 1997
        </text>
        <text x="56" y="17" fontSize="6" fill="#1a3a6b" fontWeight="800" textAnchor="middle">
          American
        </text>
        <text x="56" y="25" fontSize="6" fill="#1a3a6b" fontWeight="800" textAnchor="middle">
          University
        </text>
        <text x="56" y="33" fontSize="5.5" fill="#888" textAnchor="middle">
          of Sharjah
        </text>
      </svg>
      <span className="text-[14px] font-bold text-forest-deep text-center leading-tight mt-1">
    ...
    <div className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border border-forest/10 bg-white w-56 shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 80 40" className="h-12 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="15" y="22" fontSize="9" fill="white" fontWeight="900" textAnchor="middle">
          KREA
        </text>
        <text x="15" y="30" fontSize="4" fill="rgba(255,255,255,0.7)" textAnchor="middle">
          university
        </text>
        <text
          x="56"
        ...
        <text x="56" y="30" fontSize="6" fill="#888" textAnchor="middle">
          University
        </text>
      </svg>
      <span className="text-[14px] font-bold text-forest-deep text-center leading-tight mt-1">
      ...
      <div className="mx-auto max-w-[1000px]">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[14px] font-bold uppercase tracking-[0.25em] text-[#C19842]">
              Partner Success
            </span>
          </div>
        ...
        <div className="relative bg-white rounded-[2.5rem] p-10 md:p-16 lg:p-20 shadow-[0_15px_40px_rgba(0,0,0,0.03)] border border-forest/5 flex flex-col items-center text-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-3xl mx-auto mb-10 md:mb-12">
            <p className="text-[1.5rem] md:text-[2rem] lg:text-[2.4rem] font-serif italic text-forest-deep leading-[1.5] tracking-tight">
              "Our partnership with GEL has opened new doors for our students and faculty. The
              Cambridge experience, combined with practical learning, created exceptional outcomes."
            </p>
          </div>
          ...
          <div className="flex flex-col items-center shrink-0 w-full relative z-10">
            ...
            />
            <h4 className="text-[17px] md:text-[19px] font-bold text-forest-deep mb-1">
              Dr. Ted Laursen
            </h4>
            <p className="text-[14px] md:text-[15px] text-forest/50 uppercase tracking-[0.2em] font-extrabold leading-[1.6]">
    ...
    <section className="bg-[#051108] w-full py-24 md:py-36 px-6 md:px-12 lg:px-20 border-t border-white/[0.04]">
      <div className="mx-auto max-w-[1400px] flex flex-col lg:flex-row items-start lg:items-end justify-between gap-12 lg:gap-20">
        <div className="flex-1 w-full max-w-3xl">
          <div className="mb-6">
            <span className="text-[14px] md:text-[15px] font-extrabold uppercase tracking-[0.25em] text-[#C19842]">
              Let's Begin
            </span>
          </div>
          ...
          <p className="text-[14px] md:text-[16px] text-[#A6B8AC] leading-[1.7] max-w-2xl font-medium tracking-wide">
            Tell us about your goals and explore how we can collaborate — our team responds within
            two working days, wherever you are in the world.
          </p>
        </div>
