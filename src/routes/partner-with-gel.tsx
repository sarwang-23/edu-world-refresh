...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-cream">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 pb-24 pt-6">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-20 items-start">
          <div className="lg:col-span-6">
            ...
            <h1 className="mt-4 text-[2rem] sm:text-[2.75rem] font-bold leading-[1.05] text-forest md:text-5xl lg:text-[3.25rem] xl:text-[4rem]">
              Partner with
              <br />
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/contact"
                search={{ source: "Partner with GEL" }}
            ...
            {/* Mini features */}
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-forest/10">
              {[
                {
      ...
      <div className="animate-marquee flex items-center">
        {duplicatedStats.map((s, i) => (
          ...
          >
            ...
            <span className="text-[15px] font-bold uppercase tracking-[0.2em] text-forest/70 mt-1">
              {s.l}
            </span>
          </div>
        ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 relative z-10">
            {steps.map((s, i) => (
              <div key={i} className="group flex flex-col items-center text-center">
                ...
                <span className="text-[15px] font-black text-gold/80 tracking-[0.2em] mb-1">
                  {s.num}
                </span>
  ...
  const logos = [
    ...
    <div className="flex flex-col items-center justify-center p-6 rounded-2xl border border-forest/10 bg-white w-56 h-[132px] shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 600 100" className="w-[95%] h-auto" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(5, 5) scale(1.8)">
          ...
          />
          <path
            d="M 27 2 L 33 2 L 33 18 L 54 18 L 54 24 L 33 24 L 33 47 L 27 47 L 27 24 L 6 24 L 6 18 L 27 18 Z"
            fill="#115740"
            stroke="#222"
            strokeWidth="0.8"
          />
    ...
    <div className="flex flex-col items-center justify-center p-6 rounded-2xl border border-forest/10 bg-white w-56 h-[132px] shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 200 100" className="h-[4.5rem] w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          d="M 160 65 L 190 65 L 190 82 C 190 95 175 100 175 100 C 175 100 160 95 160 82 Z"
          fill="#5B2468"
        />
    ...
    <div className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl border border-forest/10 bg-white w-56 h-[132px] shrink-0 shadow-sm hover:border-gold/30 hover:shadow-md transition-all">
      <svg viewBox="0 0 200 200" className="h-[5.5rem] w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text
          ...
          letterSpacing="0.2"
        >
          <textPath href="#ausTopCurve" startOffset="50%" textAnchor="middle">
        ...
        <text
          ...
          fontFamily="Arial, Helvetica, sans-serif"
        >
          <textPath href="#ausBotCurve" startOffset="50%" textAnchor="middle">
      ...
      <span className="text-[13px] font-bold text-forest-deep text-center leading-tight">
        American University
        <br />
        of Sharjah
      </span>
