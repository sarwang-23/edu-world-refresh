  ...
  head: () => ({
    meta: [
      { title: "Apply Now — Global Education Lab" },
      {
        name: "description",
        content:
          "Apply for our global education programmes for business leaders, educators, and young students.",
      },
    ],
  }),
});
            ...
            <div className="mt-12">
              <div className="inline-flex items-center gap-4 px-5 py-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-white/90 tracking-wide font-serif italic">
