  ...
  head: () => ({
    meta: [
      { title: "Zero-To-One Ideation Weekend | Cambridge Judge Business School — Global Edu Lab" },
      {
        name: "description",
        content:
          "A 48-hour venture-building format that takes you from idea to incubator-ready in Cambridge. June 19–21 2026 at Judge Business School.",
      },
      { property: "og:title", content: "Zero-To-One Ideation Weekend" },
      {
        property: "og:description",
        content: "From raw ideas to incubator-ready ventures in 48 hours at Cambridge.",
      },
    ],
  }),
  component: ZeroToOne,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] text-forest/65 leading-[1.75] max-w-lg">
              ...
              School, in partnership with King's E-Lab. Challenge your thinking, form a team, and
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
              ...
              <div className="grid grid-cols-3 gap-5">
                {[
                  ...
                  >
                    ...
                    <p className="text-[14px] text-forest/60 mt-1 leading-[1.5] uppercase tracking-wide font-bold">
                      {s.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="relative rounded-[2rem] overflow-hidden aspect-[16/10] cursor-pointer group shadow-xl border border-forest/8">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-gold drop-shadow-md">
  ...
  const schedule = [
    {
      ...
      sessions: [
        ...
        },
        {
          ...
          desc: "Expert panel on Food, Agriculture & Planetary Health. Landscape mapping and opportunity framing.",
        },
        {
          time: "Night",
          title: "Networking Dinner",
          desc: "Informal dinner to meet your cohort, mentors and Cambridge ecosystem leaders.",
        },
      ],
    },
    {
            ...
            <button
              ...
              className={
                ...
                (activeDay === i
                  ...
                  : "bg-[#F4EFE6] border border-forest/10 text-forest/60 hover:border-gold/40 hover:text-forest-deep shadow-sm")
              }
            >
              {d.day.split(" · ")[0]}
            </button>
    ...
    <section className="bg-forest-deep py-32 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-[15px] text-cream/65 max-w-xl mx-auto leading-[1.7]">
  ...
  const testimonials = [
    {
      ...
      initials: "SP",
      quote:
        "I came in with a vague idea about food systems and left with a real team, a validated direction, and an invitation to pitch to the Spark Incubator. Zero-to-One changed the trajectory of my research.",
    },
    {
      name: "James Okafor",
      ...
      initials: "JO",
      quote:
        "The AI prototyping workshop alone was worth it. We went from idea to working concept in three hours. The mentors were genuine and the format was relentlessly practical.",
    },
    {
      name: "Mia Chen",
      ...
      initials: "MC",
      quote:
        "We formed as a team at Zero-to-One, pitched on day three, and six months later we're in the Cambridge Spark Incubator. I would not have believed it was possible without this programme.",
    },
  ];
  ...
  return (
    <section className="bg-[#F4EFE6] py-32 border-t border-forest/5 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
        ...
        <h2 className="text-[2.2rem] md:text-[2.8rem] font-bold text-forest-deep mb-16">
        ...
        <div className="bg-white rounded-[2.5rem] p-12 border border-forest/8 shadow-[0_8px_32px_rgba(26,53,35,0.06)] relative">
          <div className="absolute -top-10 left-1/2 -translate-x-1/2">
            <div className="h-20 w-20 rounded-[1.25rem] bg-gold flex items-center justify-center text-2xl font-bold text-forest-deep shadow-xl border-4 border-[#F4EFE6]">
              {t.initials}
            </div>
          </div>
          ...
          <blockquote className="text-[17px] leading-[1.8] text-forest/75 max-w-2xl mx-auto italic mb-8">
            "{t.quote}"
          </blockquote>
          <p className="text-[15px] font-bold text-forest-deep">{t.name}</p>
          <p className="text-[14px] text-forest/55 mt-1.5 uppercase tracking-wide font-semibold">
            {t.role}
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            <button
              ...
              className="h-10 w-10 rounded-full border border-forest/15 bg-[#F4EFE6] flex items-center justify-center text-forest/50 hover:border-gold hover:text-gold hover:bg-gold/10 transition-all duration-300"
            >
