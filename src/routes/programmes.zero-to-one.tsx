        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-4">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">About Zero-To-One</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {ventureAreas.map((area, i) => (
                <div key={i} className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors duration-300 px-5 py-4 cursor-default">
                  ...
                  <span className="text-[12px] text-white/90 leading-snug font-medium">{area}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="h-full w-full overflow-hidden rounded-[2rem] shadow-2xl shadow-black/40 border border-white/10 min-h-[480px] group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-10">
                <div className="inline-flex items-center gap-2 mb-4 bg-gold/15 backdrop-blur-sm border border-gold/30 px-3.5 py-1.5 rounded-full">
                  ...
                  <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-gold">Why This Theme</p>
                </div>
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Alumni Impact</span>
            <div className="h-px w-8 bg-gold" />
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative rounded-[2rem] overflow-hidden aspect-[16/10] cursor-pointer group shadow-xl border border-forest/8">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gold drop-shadow-md">Watch the Experience</p>
    ...
    <section id="format" className="bg-[#F4EFE6] py-32 border-y border-forest/8 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-5">
            <div className="h-px w-8 bg-gold" />
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Programme Format</span>
          </div>
        ...
        <div className="bg-white rounded-[2rem] p-10 lg:p-12 border border-forest/8 shadow-[0_8px_40px_rgba(26,53,35,0.06)] relative overflow-hidden">
          ...
          <div className="mb-10 flex items-baseline gap-4 relative z-10">
            ...
            <p className="text-[13px] text-gold font-bold uppercase tracking-wider">{day.date}</p>
          </div>
    ...
    <section className="bg-[#F4EFE6] py-32 border-t border-forest/5 relative overflow-hidden">
      <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
        ...
        <div className="bg-white rounded-[2rem] p-12 border border-forest/8 shadow-[0_8px_32px_rgba(26,53,35,0.06)] relative">
          ...
          <p className="text-[12px] text-forest/55 mt-1.5 uppercase tracking-wide font-semibold">{t.role}</p>
    ...
    <section className="bg-forest-deep py-32 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className="h-px w-8 bg-gold" />
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Join the Next Cohort</span>
          <div className="h-px w-8 bg-gold" />
        </div>
        ...
        <div className="mt-12 flex gap-4 justify-center flex-wrap">
          ...
          <Link to="/contact" className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-8 py-4 text-[11px] font-bold uppercase tracking-[0.18em] text-white hover:border-white/35 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">
            Ask a Question
          </Link>
        </div>
      </div>
