    ...
    <section id="founder-story" className="border-b border-border/60 bg-cream">
      <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
        ...
        <div className="mb-16 flex items-center gap-4">
          ...
          <p className="text-[15px] font-bold uppercase tracking-[0.25em] text-gold">Our Founder's Story</p>
        </div>
          ...
          <div className="md:col-span-7 md:pr-8">
            ...
            <div className="mt-10 flex flex-wrap gap-2">
              {["Cambridge Alumnus & Fellow, CJBS", "14+ Years Global Experience", "Ecosystem Builder", "People & Purpose Driven"].map((tag) => (
                <span key={tag} className="rounded-full border border-forest/15 bg-white px-4 py-1.5 text-[15px] font-semibold tracking-wide text-forest-deep shadow-sm">
                  {tag}
                </span>
              ))}
            </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-border/60 shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <p className="text-[14px] font-bold uppercase tracking-[0.25em] text-gold">Founder & Director</p>
                </div>
                <p className="mt-1.5 text-[14px] uppercase tracking-[0.18em] text-cream/60">Cambridge Alumnus & Fellow, CJBS</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-4 relative z-10">
            {[
              ...
              <div key={item.year} className="flex flex-col items-center text-center group">
                ...
                <p className="mt-2 text-[15px] font-bold uppercase tracking-wider text-forest-deep leading-relaxed">{item.title}</p>
          ...
          {[
            ...
            <div key={item.title} className="flex flex-col overflow-hidden rounded-[2rem] border border-border/60 bg-white shadow-sm transition-all hover:shadow-lg hover:border-forest/20 group">
              ...
              <div className="flex flex-col flex-grow p-6 md:p-8">
                ...
                <Link to={item.link} className="mt-6 inline-flex items-center gap-2 text-[15px] font-bold uppercase tracking-[0.15em] text-gold transition-colors hover:text-gold/80">
  ...
  return (
    <section className="bg-forest-deep py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 items-end gap-12 md:gap-20">
        <div>
          <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-gold">FROM CAMBRIDGE TO THE WORLD</p>
