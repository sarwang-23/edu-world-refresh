        ...
        <div className="md:col-span-7 lg:col-span-7 xl:col-span-7 pr-0 md:pr-4">
          ...
          <div className="mt-8 flex gap-4 border-l-2 border-forest/15 pl-6">
            <p className="max-w-xl text-lg leading-relaxed text-forest/80 md:text-xl">
              GEL designs and delivers world-class learning experiences that empower individuals,
              build capability, and drive innovation for a better, more inclusive tomorrow.
            </p>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <article className="group flex flex-col rounded-[2rem] border border-border/60 bg-cream p-10 shadow-sm transition-all hover:border-forest/20 hover:shadow-md">
            ...
            <h3 className="mt-8 text-[15px] font-bold uppercase tracking-[0.18em] text-gold">
              OUR MISSION
            </h3>
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-4 text-4xl font-bold leading-tight tracking-tight md:text-5xl">
            Building capabilities for a{" "}
            <span className="italic font-serif text-gold">better tomorrow.</span>
          </h2>
        </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div
                    className={`flex h-12 w-12 items-center justify-center rounded-xl transition-colors duration-300 ${
                      isActive
                        ...
                        : "bg-forest text-gold group-hover:bg-forest-deep"
                    }`}
                  >
                  ...
                  {isActive ? (
                    ...
                    <span className="text-[15px] font-medium tracking-[0.2em] text-cream/50 transition-colors duration-300 group-hover:text-cream/70">
                      {p.tag}
                    </span>
                  )}
                </div>
        ...
        <div className="grid gap-12 md:grid-cols-12 md:items-start">
          ...
          <div className="md:col-span-7 md:pr-8">
            <h2 className="text-3xl font-bold leading-tight tracking-tight text-forest-deep md:text-[2.6rem]">
              ...
              <br />
              <span className="font-serif italic text-gold">continents ΓÇö a mission</span>
              <br />
              rooted in Cambridge.
            </h2>
            ...
            <div className="mt-8 border-l-2 border-gold/30 pl-6">
              ...
              <p className="mt-1 text-lg leading-[1.75] text-forest-deep/80 font-serif italic">
                ...
                Taiwan, India and the UK, Suyash Bharti moved to Cambridge with a vision to make
                world class education accessible, experiential and impactful.
              </p>
            </div>

            <div className="mt-8 space-y-4 text-[15px] leading-relaxed text-forest/70">
              <p>
                What began as a social impact initiative has grown into{" "}
                <strong className="text-forest-deep font-semibold">Global Education Lab</strong> ΓÇö
                an education innovation company delivering fast-paced, high-impact programmes for
                learners from age 14 to global CEOs.
              </p>
              <p>
                Today, GEL connects the Cambridge ecosystem with the world ΓÇö empowering
                individuals, organisations and communities to thrive.
              </p>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-2">
              {[
                "Cambridge Alumnus & Fellow, CJBS",
                "14+ Years Global Experience",
                "Ecosystem Builder",
                "People & Purpose Driven",
              ].map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-forest/15 bg-white px-4 py-1.5 text-[15px] font-semibold tracking-wide text-forest-deep shadow-sm"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-border/60 shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <p className="text-[14px] font-bold uppercase tracking-[0.25em] text-gold">
                    Founder & Director
                  </p>
                </div>
                <p className="mt-1.5 text-[14px] uppercase tracking-[0.18em] text-cream/60">
                  Cambridge Alumnus & Fellow, CJBS
                </p>
              </div>
            </div>
  ...
  return (
    <section className="border-b border-border/60 bg-[#F7F5F0]">
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-32 text-center">
        <p className="text-[15px] font-medium uppercase tracking-[0.22em] text-gold">OUR JOURNEY</p>
        <h2 className="mt-4 text-4xl font-bold leading-tight tracking-tight text-forest-deep md:text-5xl">
            ...
            {[
              {
                year: "2019",
                icon: Flag,
                title: "Founded in Cambridge",
                desc: "with a mission to transform education",
              },
              {
                year: "2020",
                icon: BookOpen,
                title: "Launched student programmes",
                desc: "and built global partnerships",
              },
              {
                year: "2021",
                icon: Briefcase,
                title: "Expanded our portfolio",
                desc: "across leadership, entrepreneurship, and innovation",
              },
              {
                year: "2022",
                icon: Network,
                title: "Strengthened global footprint",
                desc: "across universities, organisations and ecosystems",
              },
              {
                year: "2023",
                icon: Rocket,
                title: "Launched Zero-to-One",
                desc: "ideation weekend and entrepreneurship initiatives",
              },
              {
                year: "2024+",
                icon: Globe2,
                title: "Scaling impact globally",
                desc: "empowering learners and building a better tomorrow",
              },
            ].map((item, idx) => (
              <div key={item.year} className="flex flex-col items-center text-center group">
                <div className="relative mb-6">
                  ...
                  <div className="absolute -bottom-2 -right-2 flex h-7 w-7 items-center justify-center rounded-full bg-gold border-[3px] border-cream text-[14px] font-bold text-forest-deep">
                    0{idx + 1}
                  </div>
                </div>
                <h3 className="text-xl font-bold text-forest-deep">{item.year}</h3>
                <p className="mt-2 text-[15px] font-bold uppercase tracking-wider text-forest-deep leading-relaxed">
                  {item.title}
                </p>
                <p className="mt-1 text-[15px] text-forest/70">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          {[
            {
              ...
              tag: "01",
              title: "Our Team",
              desc: "A passionate team of educators, innovators and operators committed to excellence and impact.",
              link: "/team",
            },
            {
              icon: BookOpen,
              ...
              desc: "Deep collaborations with leading universities and research centres in Cambridge and beyond.",
              link: "/partner-with-gel",
            },
            {
              icon: Briefcase,
              tag: "03",
              title: "Industry & Ecosystem Partners",
              desc: "Working with corporates, governments and ecosystem enablers to co-create meaningful impact.",
              link: "/partner-with-gel",
            },
            {
              icon: Globe2,
              ...
              desc: "A vibrant network of learners, alumni, founders, leaders and changemakers across the world.",
              link: "/our-impact",
            },
          ].map((item) => (
            <div
              key={item.title}
              className="flex flex-col overflow-hidden rounded-[2rem] border border-border/60 bg-white shadow-sm transition-all hover:shadow-lg hover:border-forest/20 group"
            >
              <div className="h-48 relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full bg-gold text-[15px] font-bold text-forest-deep shadow-sm">
                  {item.tag}
                </div>
              </div>
              <div className="flex flex-col flex-grow p-6 md:p-8">
                <h3 className="text-lg font-bold text-forest-deep">{item.title}</h3>
                <p className="mt-3 text-[15px] leading-relaxed text-forest/75 flex-grow">
                  {item.desc}
                </p>
                <Link
                  to={item.link}
                  className="mt-6 inline-flex items-center gap-2 text-[15px] font-bold uppercase tracking-[0.15em] text-gold transition-colors hover:text-gold/80"
                >
  ...
  return (
    <section id="impact" className="border-b border-border/60 bg-forest-deep overflow-hidden">
      <div className="mx-auto max-w-7xl py-10 md:py-14 text-center relative">
        <p className="text-[15px] font-bold uppercase tracking-[0.25em] text-gold mb-10 px-6">
        ...
        <div className="relative flex overflow-hidden group">
          ...
          >
            {[...Array(2)].map((_, arrayIndex) => (
              <div
                key={arrayIndex}
                className="flex items-center gap-x-12 md:gap-x-20 px-6 md:px-10"
              >
                {stats.map((stat, i) => (
                  <div key={`${arrayIndex}-${i}`} className="flex items-center gap-4 text-left">
                    <span className="text-4xl md:text-[3rem] font-bold tracking-tight text-cream">
                      {stat.num}
                    </span>
  ...
  return (
    <section className="bg-forest-deep py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 items-end gap-12 md:gap-20">
        <div>
          <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-gold">
            FROM CAMBRIDGE TO THE WORLD
          </p>
          <h2 className="mt-4 text-5xl md:text-6xl font-bold leading-[1.05] tracking-tight text-cream">
            Learn <span className="text-cream">experientially.</span>
            <br />
            Innovate <span className="text-cream">boldly.</span>
            <br />
            <span className="text-gold">Create impact.</span>
          </h2>
          <p className="mt-6 text-[15px] text-cream/80 max-w-[320px] leading-relaxed">
            Global Education Lab empowers learners, educators and leaders to build a better future.
