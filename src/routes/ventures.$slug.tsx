...
export const VENTURES: Record<string, Venture> = {
  "kavach-ai": {
    ...
    intro:
      "KavachAI transforms passive CCTV into proactive security intelligence with real-time threat detection, behavior analysis, and crowd management.",
    ...
    heroImg:
      "https://images.unsplash.com/photo-1557597774-9d273605dfa9?q=80&w=2060&auto=format&fit=crop",
    color: "from-[#0A2733] via-[#0A1C24] to-[#0A1F11]",
    accentColor: "cyan",
    awards: ["🦈 Shark Tank India Season 3 Featured & Funded"],
    problem:
      "Current CCTV systems are recording-only — they capture footage but cannot detect, analyze, or prevent threats in real time. For industries like high-value logistics and critical infrastructure, human error, unverified access, or SOP deviations can lead to massive regulatory fines, disaster, or loss of life.",
    solution:
      "KavachAI offers a streamlined pipeline that turns raw video into real-time threat detection and predictive insights. It analyzes identity, movement, and distress cues to trigger preventive alerts before escalation, ensuring real-time process compliance and immediate intervention.",
    matters:
      'Early AI-powered threat detection can mean the difference between prevention and tragedy. By selling prevention against immediate inventory loss alongside protection from massive regulatory fines, KavachAI provides a "Dual ROI" for enterprises.',
    impact:
      "From retail storefronts to national transit infrastructure, KavachAI scales to protect any environment where people gather, preventing deliberate financial loss due to asset diversion and catastrophic operational abnormalities.",
    highlights: [
    ...
    team: [
      {
        name: "Pratyusha Vemuri Venkata",
        role: "Founder & CEO",
        bio: "Extensive background in cybersecurity with prior product leadership roles at Microsoft, Cisco, Palo Alto Networks, Zscaler, and Akamai.",
        img: "/team/kavach-founder.jpg",
      },
      {
        name: "Chegondi Abhiram",
        role: "Director",
        bio: "Guiding strategic operations and growth for KavachAI.",
      },
    ],
    seeking: [
      {
        ...
        d: "Deployments in critical infrastructure, logistics, and pharma sectors.",
      },
      {
        icon: <Handshake className="h-5 w-5" />,
        t: "Enterprise Pilots",
        d: "Organizations seeking to upgrade their passive CCTV to proactive AI intelligence.",
      },
    ],
    roadmap: [
      {
        ...
        items: [
          "Deploying predictive models in retail and logistics",
          "Validating dual ROI with early enterprise adopters",
        ],
      },
      {
        ...
        items: [
          "Scaling to smart city and national transit deployments",
          "Enhancing behavioral analysis for mass crowd management",
        ],
      },
    ],
  },
  ...
  "project-tacto": {
    ...
    intro:
      "Project TACTO replaces screens with physical, highly tactile blocks. It is an open-source hardware system designed to make computational thinking and coding education accessible to visually impaired learners by utilizing hands-on, tactile interaction and real-time audio feedback.",
    ...
    accentColor: "violet",
    awards: [
      "🏆 Top Prize — Global EDVentures Startup Competition",
      "☁️ AWS Championship Prize — Technical Rigor & Innovation",
    ],
    problem:
      "Visually impaired students face significant barriers in STEM education due to the heavy reliance on screen literacy and the lack of accessible tools for learning computational thinking and programming concepts.",
    solution:
      'An open-source hardware system that replaces screen-based interfaces with physical, modular blocks. Users snap these blocks together to create code, complemented by real-time audio feedback, allowing them to "hear" and "feel" their code without relying on screens.',
    matters:
      "It removes the need for screen literacy, addressing the barriers visually impaired students face in STEM. Designed to be affordable, scalable, and effective even in low-infrastructure settings, it contributes directly to UN Sustainable Development Goal 4 — Inclusive and Equitable Quality Education.",
    impact:
      "Winner of the top prize and the AWS Championship Prize at the Global EDVentures Startup Competition. TACTO aims to democratize coding education and empower visually impaired learners globally.",
    highlights: [
    ...
    team: [
      {
        name: "Gaurang Pant",
        role: "Co-Founder",
        bio: "Innovator and developer focused on accessible education technologies and open-source hardware systems.",
      },
      {
        name: "Shristi Mandoliya",
        role: "Co-Founder",
        bio: "Passionate about creating inclusive learning experiences and breaking down barriers in STEM for every learner.",
      },
      {
        name: "Kavya Singh",
        role: "Co-Founder",
        bio: "Dedicated to leveraging technology for social impact and equitable quality education across the globe.",
      },
    ],
    seeking: [
      {
        ...
        t: "Pilot Partners",
        d: "Schools, educational institutions, and NGOs working with visually impaired students to pilot and refine the tactile learning system.",
      },
      {
        icon: <Handshake className="h-5 w-5" />,
        t: "Strategic Partners",
        d: "Organizations and tech companies interested in supporting inclusive education and scaling open-source hardware initiatives.",
      },
      {
        icon: <Lightbulb className="h-5 w-5" />,
        t: "Mentors & Experts",
        d: "Experts in hardware manufacturing, accessible design, and international education distribution.",
      },
      {
        icon: <Globe2 className="h-5 w-5" />,
        t: "Ecosystem Collaboration",
        d: "Foundations and public sector bodies to co-develop solutions and promote accessible STEM education globally.",
      },
    ],
    roadmap: [
      {
        period: "Phase 1 — Build",
        phase: "NOW",
        icon: <Rocket className="h-5 w-5" />,
        items: [
          "Refine hardware prototypes based on feedback",
          "Conduct initial pilot testing with students",
        ],
      },
      {
        period: "Phase 2 — Refine",
        phase: "NEXT",
        icon: <TrendingUp className="h-5 w-5" />,
        items: [
          "Incorporate pilot feedback into hardware iterations",
          "Optimize audio and tactile responsiveness",
        ],
      },
      {
        period: "Phase 3 — Scale",
        phase: "SOON",
        icon: <Globe className="h-5 w-5" />,
        items: [
          "Scale production of open-source kits globally",
          "Partner with educational NGOs for distribution",
        ],
      },
      {
        period: "Phase 4 — Impact",
        phase: "FUTURE",
        icon: <Target className="h-5 w-5" />,
        items: [
          "Global distribution to visually impaired learners",
          "Expand curriculum integration across institutions",
        ],
      },
    ],
  },
  ...
  carbonsynq: {
    ...
    intro:
      "AI-driven sustainability analytics and carbon accounting platform for the modern enterprise. Transforming ESG compliance into strategic value creation with unparalleled precision.",
    ...
    logo: (
      <img
        src="https://www.carbonsynqearth.com/unnamed.webp"
        alt="CarbonSynq"
        className="w-12 h-12 object-contain drop-shadow-md"
        loading="lazy"
      />
    ...
    accentColor: "teal",
    problem:
      "Organizations face growing pressure to measure and report their carbon footprint accurately, but existing processes are manual, fragmented, and hard to verify. This makes carbon accounting slow, error-prone, and difficult to trust — creating barriers to credible climate action and regulatory compliance.",
    solution:
      "CarbonSynq lets organizations automate emissions measurement, verify data with greater confidence, and connect directly to a transparent carbon marketplace. We convert raw operational data into certified Scope 1, 2, and 3 emissions using AI-powered analytics and satellite-backed MRV.",
    matters:
      "Accurate, verifiable carbon accounting is foundational to credible climate action and trust in carbon markets. By streamlining compliance with global mandates like CSRD and ISSB, we help organizations reduce risk and turn sustainability into a measurable competitive advantage.",
    impact:
      "Driving credible climate action through data. CarbonSynq empowers businesses to transition from mere measurement to meaningful action, deploying targeted carbon reduction initiatives to reach net-zero goals faster.",
    highlights: [
    ...
    seeking: [
      {
        icon: <Users className="h-5 w-5" />,
        t: "Pilot Partners",
        d: "Enterprises seeking to automate their carbon accounting and streamline ESG compliance.",
      },
      {
        icon: <Handshake className="h-5 w-5" />,
        t: "Strategic Partners",
        d: "Organizations in the climate tech and sustainability space for joint initiatives.",
      },
      {
        icon: <Globe2 className="h-5 w-5" />,
        t: "Ecosystem Collaboration",
        d: "Working with regulatory bodies to standardize carbon measurement.",
      },
    ],
    roadmap: [
      {
        period: "Phase 1",
        icon: <Rocket className="h-5 w-5" />,
        items: ["Platform launch and early enterprise pilots"],
      },
      {
        period: "Phase 2",
        icon: <TrendingUp className="h-5 w-5" />,
        items: ["Scale automation and integrate satellite MRV"],
      },
      {
        period: "Phase 3",
        icon: <Globe className="h-5 w-5" />,
        items: ["Global expansion and marketplace integration"],
      },
    ],
  },
  ...
  saivyy: {
    ...
    intro:
      "Saivyy Technologies Pvt. Ltd. develops enterprise AI, machine learning, big data analytics and intelligent automation solutions that help organisations turn complex data into actionable insight and automate critical business processes — improving efficiency, accelerating decisions and driving sustainable digital transformation.",
    ...
    heroImg: "/saivyy/saivvyMain.jpeg",
    problem:
      "Organisations generate vast amounts of data but struggle to convert it into actionable business intelligence. Legacy systems, manual processes and fragmented digital infrastructure lead to inefficiency, delayed decisions, higher costs and limited scalability — while technical complexity, integration barriers and scarce expertise slow AI adoption.",
    solution:
      "Saivyy delivers end-to-end AI-driven digital transformation combining Artificial Intelligence, Machine Learning, Big Data Analytics, Intelligent Automation and Cloud. Scalable platforms help organisations automate workflows, extract meaningful insight, optimise operations and accelerate innovation through secure, enterprise-ready technology.",
    matters:
      "Digital transformation is essential to remain competitive in a data-driven economy. Intelligent automation and data-driven decision-making improve productivity, reduce operational costs and enable organisations to focus on innovation and growth.",
    impact:
      "Saivyy has delivered AI, analytics and digital transformation solutions across multiple industry domains. Our ambition is to become a globally recognised AI and intelligent automation partner for enterprises across the UK, Europe, North America and the Middle East.",
    highlights: [
    ...
    team: [
      {
        name: "Keshav Madan",
        role: "Founder & CEO",
        bio: "Expert in enterprise technology, Artificial Intelligence and digital transformation. Leads product innovation, strategic partnerships and business growth, driving AI-powered solutions that help organisations modernise operations and make data-driven decisions.",
        img: "/saivyy/KESHAV.jpeg",
      },
      {
        name: "Manas Saxena",
        role: "Tech Lead / CTO",
        bio: "Leads technology strategy, product engineering and innovation — overseeing AI-driven, cloud-enabled and data-centric enterprise solutions that accelerate digital transformation and operational excellence.",
        img: "/saivyy/MAN.jpg",
      },
    ],
    seeking: [
      {
        icon: <Users className="h-5 w-5" />,
        t: "Pilot Partners",
        d: "Manufacturing, education, software and logistics organisations in India and the UK to validate and deploy AI, analytics and automation solutions. Typical pilots run 8–16 weeks.",
      },
      {
        icon: <Handshake className="h-5 w-5" />,
        t: "Strategic Partners",
        d: "Companies seeking advanced software or hardware integration, technology co-development, or joint innovation on AI-driven solutions with a strong technical or commercial fit.",
      },
      {
        icon: <Lightbulb className="h-5 w-5" />,
        t: "Mentors & Experts",
        d: "Mentors in enterprise AI commercialisation, international market expansion, product strategy, cybersecurity, regulatory compliance and B2B enterprise sales.",
      },
      {
        icon: <Globe2 className="h-5 w-5" />,
        t: "Ecosystem Collaboration",
        d: "Industry associations, research organisations, innovation hubs, incubators, universities and public sector bodies to co-develop AI solutions and promote responsible digital innovation.",
      },
    ],
    roadmap: [
      {
        ...
        icon: <Rocket className="h-5 w-5" />,
        items: [
          "Enter and establish presence in the UK market",
          "Close first UK pilots and implementation projects",
        ],
      },
      {
        period: "Phase 2",
        icon: <TrendingUp className="h-5 w-5" />,
        items: [
          "Scale UK operations through rapid delivery",
          "Build case studies and strengthen delivery bandwidth",
        ],
      },
      {
        period: "Phase 3",
        icon: <Globe className="h-5 w-5" />,
        items: [
          "Deepen UK market share",
          "Open early conversations across target European markets",
        ],
      },
      {
        period: "2028 onward",
        icon: <Target className="h-5 w-5" />,
        items: [
          "Go-to AI implementation partner across UK & Europe",
          "Expand delivery team and technical partnerships",
        ],
      },
    ],
  },
  ...
  if (!hasFullData) {
    return (
      <div className="min-h-screen bg-[#F8F9FB] font-sans flex flex-col items-center justify-center text-center px-6">
        <div className="w-16 h-16 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-center mb-6 text-slate-600">
          {v.logo}
        </div>
        <h1 className="text-4xl font-bold text-slate-900 mb-3">{v.name}</h1>
        <p className="text-slate-500 text-[15px] max-w-sm mb-8 leading-relaxed">
          Full venture profile coming soon.
        </p>
        <Link
          to="/global-ventures"
          className="inline-flex items-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-xl font-semibold text-[14px] hover:bg-slate-800 transition-colors shadow-md"
        >
...
function getThemeStyles(slug: string) {
  if (slug === "project-tacto") {
    return {
      ...
      gradient: "from-violet-600 via-indigo-500 to-teal-400",
      ...
      darkBg: "bg-[#100820]",
      orb1: "bg-violet-600/12",
      orb2: "bg-teal-500/10",
      metricsIcon: "text-violet-400/60",
...
function Hero({ v }: { v: Venture }) {
  ...
  return (
    ...
    >
      ...
      <>
        <div
          className={`absolute top-0 left-1/4 sm:left-1/3 w-[500px] sm:w-[600px] h-[500px] sm:h-[600px] blur-[150px] rounded-full pointer-events-none ${isTacto ? "bg-violet-600/20" : v.slug === "carbonsynq" ? "bg-teal-600/20" : "bg-blue-600/15"}`}
        />
        <div
          className={`absolute bottom-0 right-0 sm:right-1/4 w-[350px] sm:w-[400px] h-[350px] sm:h-[400px] blur-[120px] rounded-full pointer-events-none ${isTacto ? "bg-teal-500/15" : v.slug === "carbonsynq" ? "bg-cyan-500/15" : "bg-indigo-500/10"}`}
        />
        {isTacto && (
      ...
      <div className="relative mx-auto max-w-7xl w-full px-4 sm:px-6 pt-14 pb-32 z-10">
        ...
        <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-white/50 mb-14">
          <Link
            to="/global-ventures"
            className="hover:text-white/90 transition-colors flex items-center gap-1.5"
          >
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-end">
          ...
          <div className="lg:col-span-8 xl:col-span-7">
            ...
            <div className="flex items-center gap-3 mb-7">
              <span
                className={`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[10.5px] font-black uppercase tracking-[0.2em] border ${
                  isTacto
            ...
            {/* Intro */}
            <p className="text-[14.5px] text-white/75 leading-[1.9] max-w-xl mb-10">{v.intro}</p>
            ...
            {v.awards && v.awards.length > 0 && (
              <div className="flex flex-col sm:flex-row gap-2.5 mb-10">
                {v.awards.map((award, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-2 px-4 py-2 bg-white/[0.08] border border-white/20 rounded-xl text-[12.5px] text-white/80 backdrop-blur-sm font-medium"
                  >
                    {award}
                  </span>
                ))}
          ...
          <div className="hidden lg:flex lg:col-span-4 xl:col-span-5 justify-end items-end">
            <div className="relative">
              <div
                className={`absolute inset-0 rounded-[2.5rem] blur-[60px] scale-110 pointer-events-none ${isTacto ? "bg-violet-500/20" : v.slug === "carbonsynq" ? "bg-teal-500/20" : "bg-blue-500/15"}`}
              />
              <div className="relative bg-white/[0.06] backdrop-blur-2xl border border-white/[0.1] rounded-[2.5rem] p-10 flex flex-col items-center gap-5 shadow-2xl min-w-[230px]">
                {/* Logo icon container */}
                <div
                  className={`w-24 h-24 rounded-3xl border flex items-center justify-center shadow-inner shrink-0 ${
                    isTacto
                      ? "bg-gradient-to-br from-violet-500/20 to-indigo-500/10 border-violet-400/20"
                      : v.slug === "carbonsynq"
                        ? "bg-gradient-to-br from-teal-500/20 to-cyan-500/10 border-teal-400/20"
                ...
                <div className="text-center">
                  <p className="text-[9.5px] font-black uppercase tracking-[0.28em] text-white/50 mb-1.5">
                    Venture
                  </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
          {items.map((item, i) => (
            <div key={i} className="flex items-start gap-4 px-6 py-6 lg:px-8 lg:py-7">
              <div
                className={`p-2 rounded-lg border shrink-0 mt-0.5 ${`${theme.text} ${theme.bg} ${theme.border}`}`}
              >
                {item.icon}
              </div>
...
function SectionHeader({ label, id, accent }: { label: string; id?: string; accent?: boolean }) {
  return (
    <div className="flex items-center gap-4 mb-8" id={id}>
      <span className="text-[10px] font-black uppercase tracking-[0.28em] text-slate-500 shrink-0">
        {label}
      </span>
      <div
        className={`flex-1 h-px ${accent ? "bg-gradient-to-r from-violet-200 to-transparent" : "bg-slate-200"}`}
      />
    </div>
  );
}
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-14 pb-16 w-full">
      <div className="grid lg:grid-cols-[1fr_320px] xl:grid-cols-[1fr_348px] gap-10 xl:gap-12 items-start">
        ...
        <div className="space-y-16 min-w-0">
          ...
          <div id="overview" className="scroll-mt-52">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {opportunityCards.map((c, i) => (
                ...
                >
                  <div
                    className={`w-11 h-11 rounded-xl ${c.bg} border ${c.border} ${c.iconColor} flex items-center justify-center mb-6 shrink-0 group-hover:scale-105 transition-transform duration-300`}
                  >
                    {c.icon}
                  </div>
                  <h4 className="text-[15px] font-bold text-slate-900 mb-3 leading-snug tracking-tight">
                    {c.title}
                  </h4>
          ...
          <div id="progress" className="scroll-mt-52">
            ...
            <div className={`rounded-2xl overflow-hidden relative shadow-xl ${theme.darkBg}`}>
              ...
              <>
                <div
                  className={`absolute top-0 right-0 w-72 h-72 blur-[100px] rounded-full pointer-events-none ${theme.orb1}`}
                />
                <div
                  className={`absolute bottom-0 left-0 w-56 h-56 blur-[80px] rounded-full pointer-events-none ${theme.orb2}`}
                />
              </>
              <div className="relative z-10 p-8 sm:p-10 lg:p-12">
                ...
                <div className="space-y-5 mb-10">
                  {v.progress.map((p, i) => (
                    <div key={i} className="flex items-start gap-4">
                      <div
                        className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 border ${`${theme.badgeBg} ${theme.badgeBorder}`}`}
                      >
                ...
                <div className="border-t border-white/[0.06] pt-7">
                  <p className="text-[9.5px] font-black uppercase tracking-[0.25em] text-slate-400 mb-5">
                    Key Metrics
                  </p>
                  <div
                    className={`grid gap-4 ${v.metrics.length === 4 ? "grid-cols-2 sm:grid-cols-4" : "grid-cols-2 sm:grid-cols-3 lg:grid-cols-5"}`}
                  >
                    {v.metrics.map((m, i) => (
                      <div
                        key={i}
                      ...
                      >
                        {m.icon && (
                          <div
                            className={`flex justify-center mb-3 ${theme.metricsIcon} group-hover:scale-110 transition-transform`}
                          >
                            {m.icon}
                          </div>
                        )}
                        <div
                          className={`font-black text-white tracking-tight leading-none mb-2 ${m.v.length > 6 ? "text-xl sm:text-2xl" : "text-2xl sm:text-3xl"}`}
                        >
                          {m.v}
                        </div>
                        <div className="text-[11px] text-slate-400 leading-snug">{m.l}</div>
                        {m.subtitle && (
                          <div className="text-[10px] text-slate-500 mt-1">{m.subtitle}</div>
                        )}
                      </div>
                    ))}
                  </div>
          ...
          <div id="team" className="scroll-mt-52">
            ...
            />
            <div
              className={`grid gap-6 ${v.team.length === 3 ? "sm:grid-cols-3" : v.team.length === 2 ? "sm:grid-cols-2" : "sm:grid-cols-2 xl:grid-cols-3"}`}
            >
              {v.team.map((member, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-b from-slate-50 to-slate-100/80 px-6 pt-7 pb-6 flex flex-col items-center text-center border-b border-slate-100">
                    <div
                      className={`w-20 h-20 rounded-2xl overflow-hidden shrink-0 border-2 border-white shadow-lg ring-1 mb-4 ${theme.ring}`}
                    >
                      {member.img ? (
                        <img
                          src={member.img}
                        ...
                        <div
                          className={`w-full h-full flex items-center justify-center text-white text-2xl font-black ${`bg-gradient-to-br ${theme.avatar}`}`}
                        >
                    ...
                    <p
                      className={`text-[11px] font-black mt-1 uppercase tracking-[0.15em] ${theme.text}`}
                    >
                      {member.role}
                    </p>
                  </div>
                  ...
                  <div className="px-7 py-6">
                    <p className="text-[13.5px] text-slate-600 leading-relaxed text-center">
                      {member.bio}
                    </p>
                  </div>
                </div>
            ...
            <p className="text-[12.5px] text-slate-500 italic mt-5 text-center leading-relaxed">
              {v.slug === "project-tacto"
                ...
                : v.slug === "carbonsynq"
                  ? "Driving climate tech innovation and AI sustainability analytics."
            ...
            >
              ...
              <div className="p-8 sm:p-10 lg:p-12">
                <div className="relative">
                  ...
                  <div
                    className={`grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10 ${v.roadmap.length === 4 ? "md:grid-cols-4" : "md:grid-cols-3"}`}
                  >
                      ...
                      <div key={i} className="flex flex-col items-start">
                        ...
                        <ul className="space-y-2">
                          {stage.items.map((item, j) => (
                            <li
                              key={j}
                              className="flex items-start gap-2.5 text-[13px] text-slate-600 leading-[1.7]"
                            >
                              <span
                                className={`mt-[8px] w-1.5 h-1.5 rounded-full shrink-0 ${(v.slug === "project-tacto" || v.slug === "carbonsynq") && i === 0 ? (v.slug === "project-tacto" ? "bg-violet-400" : "bg-teal-400") : "bg-slate-300"}`}
                              />
                              <span>{item}</span>
                            </li>
                          ))}
        ...
        <div className="w-full mt-2 lg:mt-0 lg:sticky lg:top-[172px] flex flex-col gap-6 lg:gap-8">
          {/* Quick Actions CTA */}
          <div
            className={`rounded-2xl p-8 lg:p-9 text-white relative overflow-hidden shadow-2xl ${v.slug === "project-tacto" ? "bg-[#18082E]" : v.slug === "carbonsynq" ? "bg-[#042A27]" : "bg-slate-900"}`}
          >
            {v.slug === "project-tacto" || v.slug === "carbonsynq" ? (
              <>
                <div
                  className={`absolute top-0 right-0 w-48 h-48 blur-[80px] rounded-full pointer-events-none ${v.slug === "project-tacto" ? "bg-violet-500/15" : "bg-teal-500/15"}`}
                />
                <div
                  className={`absolute bottom-0 left-0 w-36 h-36 blur-[60px] rounded-full pointer-events-none ${v.slug === "project-tacto" ? "bg-teal-500/10" : "bg-cyan-500/15"}`}
                />
              </>
            ) : (
              <>
            ...
            {(v.slug === "project-tacto" || v.slug === "carbonsynq") && (
              <div
                className={`absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r ${theme.gradient}`}
              />
            )}
            <div className="relative z-10">
              <h3
                className="text-[18px] font-bold mb-3 leading-tight tracking-tight text-white"
                id="collaborate"
              >
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-lg shadow-slate-200/40 overflow-hidden">
            <div className="p-7 lg:p-8">
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-8 h-8 rounded-lg border flex items-center justify-center shadow-sm ${v.slug === "project-tacto" ? "bg-violet-50 border-violet-100 text-violet-500" : v.slug === "carbonsynq" ? "bg-teal-50 border-teal-100 text-teal-600" : "bg-amber-50 border-amber-100 text-amber-500"}`}
                >
                ...
                {v.highlights.map((h, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-start gap-3">
                      <div
                        className={`w-4 h-4 rounded-md border flex items-center justify-center shrink-0 mt-0.5 ${v.slug === "project-tacto" ? "bg-violet-50 border-violet-100" : v.slug === "carbonsynq" ? "bg-teal-50 border-teal-100" : "bg-amber-50 border-amber-100"}`}
                      >
                        <CheckCircle2
                          className={`h-2.5 w-2.5 ${v.slug === "project-tacto" ? "text-violet-500" : v.slug === "carbonsynq" ? "text-teal-600" : "text-amber-500"}`}
                        />
                      </div>
          ...
          {/* Collaboration Areas */}
          <div
            className="bg-white rounded-2xl border border-slate-200 shadow-lg shadow-slate-200/40 overflow-hidden"
            id="collaboration"
          >
            <div className="p-7 lg:p-8">
              <div className="flex items-center gap-3 mb-6">
                <div
                  className={`w-8 h-8 rounded-lg border flex items-center justify-center shadow-sm ${v.slug === "project-tacto" ? "bg-violet-50 border-violet-100 text-violet-500" : v.slug === "carbonsynq" ? "bg-teal-50 border-teal-100 text-teal-600" : "bg-blue-50 border-blue-100 text-blue-500"}`}
                >
              ...
              <div className="space-y-4">
                {v.seeking.map((s, i) => (
                  <div key={i} className="flex items-start gap-3.5">
                    <div
                      className={`w-8 h-8 rounded-xl border flex items-center justify-center shrink-0 shadow-sm ${v.slug === "project-tacto" ? "bg-violet-50/80 border-violet-100 text-violet-600" : v.slug === "carbonsynq" ? "bg-teal-50/80 border-teal-100 text-teal-600" : "bg-slate-50 border-slate-100 text-slate-600"}`}
                    >
                      {s.icon}
                    </div>
                    <div className="min-w-0">
                      <h4 className="text-[13.5px] font-bold text-slate-900 leading-tight mb-0.5">
                        {s.t}
                      </h4>
  ...
  const supports = [
    {
      ...
      desc: "Growth planning and international positioning for scale.",
    },
    {
      icon: <Users className="h-4 w-4" />,
      title: "Investor Access",
      desc: "Fundraising guidance and curated investor introductions.",
    },
    {
      icon: <Globe className="h-4 w-4" />,
      title: "UK Market Entry",
      desc: "International market pathways, visas and connections.",
    },
    {
      icon: <Lightbulb className="h-4 w-4" />,
      title: "Expert Mentorship",
      desc: "Guidance from industry and academic leaders.",
    },
    {
      icon: <Network className="h-4 w-4" />,
      title: "Ecosystem Access",
      desc: "Partnerships with research bodies and innovation hubs.",
    },
  ];
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-10 w-full">
      ...
      >
        ...
        {v.slug === "project-tacto" || v.slug === "carbonsynq" ? (
          <>
            <div
              className={`absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] ${v.slug === "project-tacto" ? "from-violet-700/15" : "from-teal-700/15"} via-transparent to-transparent`}
            />
            <div
              className={`absolute bottom-0 left-0 w-[500px] h-[500px] blur-[130px] rounded-full pointer-events-none ${v.slug === "project-tacto" ? "bg-violet-700/[0.08]" : "bg-teal-700/[0.08]"}`}
            />
            <div
              className={`absolute top-0 right-0 w-[300px] h-[300px] blur-[80px] rounded-full pointer-events-none ${v.slug === "project-tacto" ? "bg-teal-500/[0.05]" : "bg-cyan-500/[0.05]"}`}
            />
          </>
        ) : (
          <>
        ...
        <div className="relative z-10 p-8 sm:p-10 lg:p-14">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div>
              <span
                className={`text-[9.5px] font-black uppercase tracking-[0.28em] mb-5 block ${theme.textAccent}`}
              >
                Strategic Support
              </span>
              <h2 className="text-2xl sm:text-3xl font-bold text-white leading-tight mb-5">
                GEL's Role in <span className={theme.textAccent}>{v.name.split(" ")[0]}'s</span>{" "}
                Journey
              </h2>
              <p className="text-[15px] text-slate-300 leading-[1.88] mb-6">
                Through the Global Ventures Programme, GEL supports{" "}
                <strong className="text-white font-semibold">{v.name}</strong> with venture
                strategy, international positioning, expert mentoring and access to investors,
              ...
              {(v.slug === "project-tacto" || v.slug === "carbonsynq") && (
                <div className="flex flex-wrap gap-2">
                  {(v.slug === "project-tacto"
                    ...
                    <span
                      key={tag}
                      className={`px-3 py-1 rounded-full text-[11px] font-bold ${theme.badgeBg} ${theme.badgeBorder} ${theme.badgeText}`}
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {supports.map((s, i) => (
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-xl border flex items-center justify-center mb-3 ${theme.iconBg} ${theme.iconBorder} ${theme.textAccent}`}
                  >
                    {s.icon}
                  </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left max-w-2xl">
            <div
              className={`w-16 h-16 rounded-2xl border flex items-center justify-center shrink-0 shadow-sm ${
                v.slug === "saivyy"
            ...
            <div>
              ...
              <p className="text-[15px] text-slate-600 leading-relaxed">
                {v.slug === "project-tacto"
                  ...
                  : v.slug === "carbonsynq"
                    ? "If you are a corporate pilot partner, ESG expert, or climate investor, we would love to connect and facilitate a meaningful introduction."
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0 w-full sm:w-auto">
            <Link
              to="/contact"
              search={{ source: v.name }}
              className={`w-full sm:w-auto text-white px-8 py-4 rounded-xl text-[14px] font-bold transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 duration-200 inline-flex items-center justify-center gap-2 ${`${theme.bgSolid} ${theme.bgHover}`}`}
            >
              Request Introduction <ArrowUpRight className="h-4 w-4" />
            </Link>
            {v.website ? (
