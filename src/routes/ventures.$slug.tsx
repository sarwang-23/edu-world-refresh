...
const VENTURES: Record<string, Venture> = {
  "kavach-ai": {
    ...
    intro:
      "Kavach AI is an emerging artificial intelligence venture developing intelligent solutions for complex operational, security and resilience-related challenges.",
    sector: "Artificial Intelligence",
    stage: "Early-stage Venture",
    origin: "India",
    markets: "UK, EU, Middle East, Asia-Pacific",
    logo: <span className="text-5xl font-bold font-serif text-white">K</span>,
    color: "from-slate-900 via-indigo-950 to-slate-900",
    problem:
      "Many organisations face rising security and operational risks due to fragmented systems, manual monitoring and slow response times.",
    solution:
      "Kavach AI uses advanced artificial intelligence to detect risks in real time, predict threats and automate intelligent responses.",
    matters:
      "More resilient operations, lower risk exposure and better decision-making lead to safer businesses and communities.",
    impact:
      "Enabling organisations to act faster, reduce incidents and build a safer, more resilient future for all stakeholders.",
    highlights: [
      "AI-powered real-time risk detection and prediction",
      "Adaptive to multiple industries and use cases",
      "Proprietary algorithms for high accuracy and low false alerts",
      "Scalable and secure architecture built for global deployment",
      "Strong founding team with deep tech and domain expertise",
    ],
    progress: [
      "MVP developed and tested across pilot deployments",
      "Successful pilots with early enterprise users",
      "Proprietary AI models trained on multi-domain datasets",
      "Strategic partnerships in progress",
      "Patent application filed",
    ],
    metrics: [
      { l: "Pilots Completed", v: "3", subtitle: "Pilot Stage" },
      { l: "Accuracy", v: "92%+" },
      { l: "Early Customers", v: "5" },
      { l: "Alerts Processed", v: "50K+" },
      { l: "Incidents Mitigated", v: "37%", subtitle: "reduction" },
    ],
    team: [
      {
        name: "Aarav Sharma",
        role: "Co-founder & CEO",
        bio: "AI and cybersecurity expert with 10+ years of experience building scalable enterprise solutions.",
      },
      {
        name: "Neha Iyer",
        role: "Co-founder & CTO",
        bio: "Former research scientist in machine learning with expertise in predictive analytics and deep learning.",
      },
    ],
    seeking: [
      {
        ...
        t: "Investment",
        d: "Pre-seed / Seed investment to scale product, expand pilots and accelerate market entry.",
      },
      {
        icon: <Users className="h-5 w-5" />,
        t: "Pilot Partners",
        d: "Enterprises and institutions interested in piloting AI-driven risk intelligence solutions.",
      },
      {
        icon: <Handshake className="h-5 w-5" />,
        t: "Strategic Partners",
        d: "Technology partners, system integrators and consultants.",
      },
      {
        icon: <Lightbulb className="h-5 w-5" />,
        t: "Mentors & Experts",
        d: "Domain experts in AI, cybersecurity, enterprise sales and product strategy.",
      },
    ],
    roadmap: [
      {
        ...
        items: ["Scale pilots across multiple sectors", "Enhance AI models and platform"],
      },
      {
        period: "6 \u2013 12 Months",
        icon: <TrendingUp className="h-6 w-6" />,
        items: ["Commercial launch in target markets", "Expand enterprise customer base"],
      },
      {
        period: "12 \u2013 18 Months",
        icon: <Globe className="h-6 w-6" />,
        items: ["International expansion through UK", "Strategic partnerships and integrations"],
      },
      {
        period: "18 \u2013 24 Months",
        icon: <Target className="h-6 w-6" />,
        items: ["Platform scaling and market leadership", "Sustainable revenue and profitability"],
      },
    ],
  },
  ...
  if (v.slug !== "kavach-ai") {
    return (
      <div className="p-24 text-center">
        Content placeholder for {v.name}. (Only Kavach AI is fully implemented for this demo)
      </div>
    );
  }
    ...
    <section className="bg-forest-deep text-white pt-10 pb-16 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-28">
        <div className="flex items-center gap-2 text-[14px] uppercase tracking-wider text-white/50 mb-8">
          <Link to="/global-ventures" className="hover:text-white transition-colors">
            Global Ventures
          </Link>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-8">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">{v.name}</h1>
            <p className="text-2xl md:text-[2rem] font-bold text-gold leading-tight max-w-2xl mb-6">
              {v.tagline.split(".")[0]}
              <span className="text-white italic">.</span>
            </p>
            <p className="text-[15px] text-white/80 leading-relaxed max-w-2xl mb-8">{v.intro}</p>
          </div>
          ...
          <div className="lg:col-span-4 relative flex flex-col items-center">
            ...
            <div className="w-32 h-32 md:w-48 md:h-48 mb-8 relative flex items-center justify-center">
              ...
              <Shield className="absolute inset-2 w-[calc(100%-16px)] h-[calc(100%-16px)] text-white/20 stroke-1" />
              <Shield className="absolute inset-4 w-[calc(100%-32px)] h-[calc(100%-32px)] text-white stroke-2 fill-white/5 backdrop-blur-md" />
              <span className="relative z-10 text-5xl md:text-7xl font-sans font-medium text-white mb-4">
                K
              </span>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl text-forest-deep w-full max-w-sm">
              ...
              <p className="text-[14px] text-forest/70 mb-6">
                We facilitate introductions to founders and support meaningful collaborations.
              </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 divide-x divide-forest/10">
          {items.map((item, i) => (
            <div key={i} className={`flex items-center gap-4 ${i !== 0 ? "pl-4 md:pl-8" : ""}`}>
              <div className="text-forest/30">{item.icon}</div>
              <div>
                <p className="text-[15px] font-bold uppercase tracking-widest text-forest/50">
                  {item.l}
                </p>
        ...
        <div className="space-y-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {problemCards.map((c, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl p-6 border border-forest/10 shadow-sm flex flex-col items-center text-center"
              >
              ...
              <div className="bg-cream rounded-xl p-6 mt-auto">
                ...
                <div className="space-y-3">
                  {v.metrics.map((m, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between border-b border-forest/10 pb-2 last:border-0 last:pb-0"
                    >
                      ...
                      <div className="text-right">
                        ...
                        {m.subtitle && (
                          <p className="text-[15px] text-forest/50 leading-none">{m.subtitle}</p>
                        )}
                      </div>
                    </div>
                  ))}
            ...
            <div className="bg-white rounded-2xl p-8 border border-forest/10 shadow-sm">
              ...
              <div className="space-y-6">
                {v.team.map((member, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-4 pb-6 border-b border-forest/5 last:border-0 last:pb-0"
                  >
              ...
              <div className="mt-6 pt-6 border-t border-forest/5">
                <p className="text-[14px] text-forest/70 italic mb-4">
                  Advisors and domain experts from security, AI and enterprise technology.
                </p>
      ...
      <div className="relative grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-[15px] text-white/80 leading-relaxed">
            Through the Global Ventures Programme, GEL supports Kavach AI with venture strategy,
            international positioning, expert mentoring and access to investors, researchers and
            strategic partners. Our objective is to help the venture scale globally through the UK
            and beyond.
          </p>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-[15px] text-forest/70">
              If you are an investor, corporate, university or expert interested in collaborating
              with Kavach AI, we would love to connect.
            </p>
          </div>
        </div>
