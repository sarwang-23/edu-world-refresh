  ...
  head: () => ({
    meta: [
      { title: "Cambridge Student Summer Camps — Global Edu Lab" },
      {
        name: "description",
        content:
          "Residential summer camps at Hughes Hall and Girton College, University of Cambridge — covering STEM, Entrepreneurship, AI and more.",
      },
      { property: "og:title", content: "Cambridge Student Summer Camps" },
      {
        property: "og:description",
        content: "Residential summer programmes at the University of Cambridge for students.",
      },
    ],
  }),
  component: Page,
          ...
          <div className="relative">
            <div className="rounded-3xl bg-forest-deep p-10 shadow-2xl border border-white/10 relative overflow-hidden">
              ...
              <div className="mt-6 p-4 bg-gold/10 rounded-xl border border-gold/20 relative z-10">
                ...
                <p className="text-[14px] text-cream/60 mt-1">
    ...
    <section id="camps" className="bg-forest-deep py-24 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-[14px] text-cream/60 max-w-lg mx-auto">
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications for 2026 cohorts are open — early acceptance is limited.
        </p>
