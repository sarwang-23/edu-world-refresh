...
function Hero() {
  return (
    <section className="relative bg-[#F4EFE6] overflow-hidden pt-4 pb-16 md:pt-4 md:pb-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10 pt-6">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              <div className="h-px w-8 bg-gold" />
              <span className="text-[15px] font-bold uppercase tracking-[0.3em] text-gold">
                Programmes for Students &amp; Young Learners
              </span>
            </div>
            <h1 className="text-[2rem] sm:text-[2.4rem] md:text-[3.6rem] font-bold text-forest-deep leading-[1.05] tracking-tight">
              Young Leaders
              <br />
            ...
            <p className="mt-5 text-[15px] text-forest/80 leading-relaxed max-w-lg">
              Residential summer programmes at the University of Cambridge — covering Economics,
              Business, STEM, Public Speaking, English, Entrepreneurship and Sustainability. Live,
              learn and grow alongside the next generation of global leaders.
            </p>
            <div className="mt-8 flex flex-wrap gap-5 text-[15px] text-forest/70">
              <span className="inline-flex items-center gap-2 font-semibold">
                <Calendar className="h-4 w-4 text-gold" /> Summer Intake
              </span>
              <span className="inline-flex items-center gap-2 font-semibold">
          ...
          <div className="relative">
            <div className="rounded-3xl bg-forest-deep p-6 sm:p-10 shadow-2xl border border-white/10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gold/10 rounded-full blur-[80px] pointer-events-none" />
              <div className="grid grid-cols-2 gap-6 relative z-10">
                {[
                  { val: "5,000+", label: "Students Impacted", sub: "Trusted Reach" },
                  { val: "2", label: "Flagship Camps", sub: "At Cambridge colleges" },
                  { val: "14–17", label: "& 18+ Age Groups", sub: "Both programmes" },
                  { val: "Summer", label: "Next Intake", sub: "Applications Open" },
                ].map((s) => (
              ...
              <div className="mt-6 p-4 bg-gold/10 rounded-xl border border-gold/20 relative z-10">
                <p className="text-[15px] font-bold text-gold uppercase tracking-wider">
                  Hughes Hall &amp; Girton College · Cambridge
                </p>
                <p className="text-[15px] text-cream/80 mt-1">
                  Prestigious residential college experience
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-8">
              <div className="rounded-2xl border border-forest/8 p-6 bg-[#F7F5F0]">
                ...
                <p className="mt-2 text-[15px] font-semibold uppercase tracking-widest text-forest/70">
                  Students Impacted
                </p>
              </div>
              <div className="rounded-2xl border border-forest/8 p-6 bg-[#F7F5F0]">
          ...
          <div className="flex flex-col justify-center gap-6 text-[15px] leading-relaxed text-forest/80">
            <p>
              ...
              <span className="font-bold text-forest-deep">
                Hughes Hall &amp; Girton College, University of Cambridge
              </span>
              , where students get a taste of Cambridge life, world-class lectures and peers from
              across the globe.
            </p>
            <p>
              Programmes inspire students to think globally, act locally, and prepare for higher
  ...
  const camps = [
    {
      ...
      when: "Summer Residential Experience",
      ...
      highlights: [
        "STEM thinking & innovation",
        "Entrepreneurship workshops",
        "Pitch competition",
        "Cambridge college residential",
      ],
    ...
    },
    {
      ...
      highlights: [
        "AI & entrepreneurship deep-dive",
        "Cambridge faculty lectures",
        "Startup pitching & mentorship",
        "Girton College residential",
      ],
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-white">
            Two flagship Cambridge camps.
          </h2>
          <p className="mt-4 text-[15px] text-cream/80 max-w-lg mx-auto">
            Two distinct programmes for two age groups — both delivering an unforgettable Cambridge
            experience.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          {camps.map((camp, i) => (
            <div
              key={i}
              className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm hover:border-gold/40 hover:bg-white/10 hover:-translate-y-1 transition-all duration-500 overflow-hidden group flex flex-col"
            >
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <h3 className="text-[19px] font-bold text-white mb-3 leading-tight group-hover:text-gold transition-colors duration-300">
                  {camp.title}
                </h3>
  ...
  const profiles = [
    {
      ...
      title: "School Students (14–17)",
      desc: "Motivated secondary school students who want an academic challenge, global exposure and the confidence that comes from studying at Cambridge.",
      color: "bg-gold",
    },
    {
      icon: <GraduationCap className="h-6 w-6" />,
      title: "Undergraduates & Gap Year (18+)",
      desc: "University students and gap year learners who want to explore entrepreneurship and AI in the world's most innovative academic environment.",
      color: "bg-forest",
    },
    {
      icon: <Globe2 className="h-6 w-6" />,
      title: "International Students",
      desc: "Students from across the world who want a prestigious summer experience, global peers and an academic credential from Cambridge.",
      color: "bg-forest/60",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Built for ambitious young minds.
          </h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {profiles.map((p, i) => (
            <div
              key={i}
              className="bg-white rounded-3xl border border-forest/8 hover:border-gold/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group"
            >
              <div className={`h-1.5 w-full ${p.color}`} />
              <div className="p-8">
                <div
                  className={`mb-6 inline-flex h-12 w-12 items-center justify-center rounded-2xl ${p.color} text-white shadow-lg`}
                >
                  {p.icon}
                </div>
                <h3 className="text-[17px] font-bold text-forest-deep mb-3 group-hover:text-gold transition-colors duration-300">
                  {p.title}
                </h3>
  ...
  const pillars = [
    {
      ...
      title: "World-Class Academic Sessions",
      desc: "Lectures, seminars and workshops delivered in the Cambridge tradition — rigorous, interactive and thought-provoking.",
    },
    {
      icon: <Users className="h-7 w-7" />,
      title: "Residential College Life",
      desc: "Live in a Cambridge college, dine in the great hall and experience the full Cambridge residential lifestyle that has inspired generations.",
    },
    {
      icon: <Rocket className="h-7 w-7" />,
      title: "Practical Innovation Challenges",
      desc: "Hands-on STEM, entrepreneurship and AI challenges where students work in teams to solve real-world problems and pitch their solutions.",
    },
    {
      icon: <Globe2 className="h-7 w-7" />,
      title: "Global Peer Network",
      desc: "Form lifelong friendships with students from 20+ countries. Leave Cambridge with a global network and a genuinely international worldview.",
    },
  ];
  return (
    <section className="bg-white py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            More than a programme — a life-defining summer.
          </h2>
        </div>
...
function Testimonials() {
  const testimonials = [
    {
      name: "Arya Sharma",
      school: "Grade 11, Delhi Public School",
      quote:
        "The Cambridge Summer Camp was the most challenging and rewarding two weeks of my life. The mentors were brilliant, the peers were inspiring, and the college experience was something I'll never forget.",
      img: person11Img,
    },
    {
      name: "Lucas Ferreira",
      school: "Year 12, São Paulo International School",
      quote:
        "I came to Cambridge not knowing what I wanted to study. I left with a clear plan to pursue AI and entrepreneurship. The Girton programme opened my eyes to what's possible.",
      img: person12Img,
    },
    {
      name: "Meera Nair",
      school: "Gap Year Student, Kerala",
      quote:
        "Being in a Cambridge college, learning from faculty and working on real startup pitches gave me the confidence I needed to apply for university with a genuine point of view.",
      img: person11Img,
    },
  ];
  ...
  return (
    <section className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="text-[2rem] md:text-[2.4rem] font-bold text-forest-deep mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 mt-12 w-full">
          {[1, 2, 3].map((_, i) => (
            <div
              key={i}
              className="aspect-video w-full rounded-xl bg-black/5 overflow-hidden relative border border-black/10 shadow-sm"
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-black/40 text-[13px] font-bold uppercase tracking-widest">
                  Video Frame
                </span>
              </div>
            </div>
        ...
        <div className="mx-auto h-20 w-20 rounded-full overflow-hidden shadow-xl mb-6 border-2 border-gold/30">
        ...
        <blockquote className="text-[15px] leading-relaxed text-forest/70 max-w-2xl mx-auto italic mb-6">
          "{t.quote}"
        </blockquote>
        ...
        <div className="flex items-center justify-center gap-4 mt-10">
          <button
            ...
            className="h-10 w-10 rounded-full border border-forest/15 flex items-center justify-center text-forest/70 hover:border-forest-deep hover:text-forest-deep transition-all"
          >
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                className={
                  ...
                  (i === current ? "w-6 bg-gold" : "w-1.5 bg-forest/20")
                }
              />
            ))}
          </div>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white leading-tight">
          A Cambridge summer awaits.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications for the next cohort are open — early acceptance is limited.
        </p>
