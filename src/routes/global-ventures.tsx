      ...
      <div className="flex w-max animate-marquee">
        {duplicateStats.map((s, i) => (
          ...
          >
            ...
            <p className="text-[15px] font-bold uppercase tracking-[0.2em] text-white/80 whitespace-nowrap">
              {s.label}
            </p>
          </div>
        ))}
    ...
    <section className="py-32 md:py-40 bg-[#F9F6F0] relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="flex items-center gap-3 mb-24 justify-center">
          ...
          <span className="text-[15px] font-bold uppercase tracking-[0.35em] text-gold">
            About the Programme
          </span>
          <div className="h-px w-12 bg-gold/40" />
        </div>
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="pt-6">
              <Link
                to="/contact"
                search={{ source: "Global Ventures" }}
                className="group inline-flex items-center gap-3 rounded-full bg-forest-deep px-9 py-4.5 text-[15px] font-bold uppercase tracking-[0.2em] text-white transition-all hover:bg-forest shadow-xl shadow-forest/15 hover:shadow-forest/30"
              >
            ...
            {pillars.map((p, i) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Typography */}
                  <h4 className="text-[15px] font-bold text-forest-deep mb-4 leading-tight tracking-wide group-hover:text-forest transition-colors duration-300">
                    {p.title}
                  </h4>
...
const VENTURES = [
  {
    ...
    slug: "carbonsynq",
    name: "CARBONSYNQ",
    tagline: "From Carbon Accounting to Offsetting — All at One Platform",
  ...
  },
  {
    ...
    slug: "project-tacto",
    name: "PROJECT TACTO",
    tagline: "The first programming language you don't need eyes to learn",
  ...
  },
  {
    ...
    desc: "Enterprise AI, machine learning, big data analytics and intelligent automation solutions that help organisations turn complex data into actionable insight and drive sustainable digital transformation.",
            ...
            >
              ...
              <div className="relative h-full w-full rounded-[2.4rem] bg-black/20 p-8 lg:p-10 flex flex-col z-10 backdrop-blur-sm border border-white/5 group-hover:bg-black/0 transition-colors duration-700">
                ...
                <div className="relative mb-5 p-3 rounded-r-xl border-l-[3px] border-gold/40 bg-gradient-to-r from-gold/[0.08] to-transparent group-hover:border-gold group-hover:from-gold/[0.15] transition-all duration-500 w-fit">
                  <p className="text-[12px] font-bold uppercase tracking-[0.15em] text-gold/90 group-hover:text-gold transition-colors duration-300">
                    {v.tagline}
                  </p>
                </div>

                <p className="text-[15px] text-white/70 leading-[1.8] font-medium flex-1 group-hover:text-white/90 transition-colors duration-300">
                  {v.desc}
                </p>
                ...
                <div className="mt-8 pt-6 border-t border-white/10 group-hover:border-gold/30 transition-colors duration-500 flex items-center justify-between">
                  <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-white/60 group-hover:text-gold transition-colors duration-300">
                    Explore Venture
                  </span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6 relative z-10">
            {steps.map((s, i) => (
              <div key={i} className="group flex flex-col items-center text-center">
                ...
                <p className="text-[15px] text-[#0A1F11]/55 leading-[1.7] max-w-[120px]">
                  {s.desc}
                </p>
              </div>
            ))}
          ...
          <div className="relative group overflow-hidden rounded-[2.5rem] min-h-[640px] flex flex-col justify-end shadow-2xl transition-all duration-500 hover:-translate-y-2">
            ...
            <div className="relative p-10 lg:p-14 z-10">
              <div className="mb-10 transform transition-transform duration-500 group-hover:-translate-y-2">
                ...
                <p className="text-[16px] text-white/70 font-medium leading-relaxed min-h-[50px] lg:min-h-[48px]">
              ...
              <div className="space-y-4 mb-10 transform transition-all duration-500 group-hover:-translate-y-2 min-h-[260px] lg:min-h-[240px]">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <span className="text-[16px] text-white/90 leading-relaxed font-medium">
                      {item}
                    </span>
                  </div>
                ))}
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-20 items-center">
          <div>
            ...
            <div className="mt-8">
              <Link
                to="/contact"
                search={{ source: "Global Ventures - Who Should Apply" }}
              ...
              >
                Apply Now{" "}
                <ArrowUpRight className="h-4 w-4 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform duration-200" />
              </Link>
            </div>
          </div>
