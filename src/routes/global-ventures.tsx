        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            <p className="text-[17px] text-forest/65 leading-[1.8] max-w-xl">
              We support promising startups and research-led innovations with venture strategy,
              mentoring, investor access and business collaboration—until they become
              self-sustainable.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              {pills.map((p, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 rounded-full border border-forest/12 bg-white/80 backdrop-blur-sm px-4 py-2 shadow-sm"
                >
          ...
          <div className="lg:col-span-5 hidden lg:block">
            <div className="relative">
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden aspect-[4/5] shadow-2xl shadow-forest/15 border border-forest/8">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-[15px] font-bold uppercase tracking-[0.25em] text-gold/60">
                      Featured Venture
                    </span>
                    <div className="h-px flex-1 bg-gold/30" />
                  </div>
              ...
              <div className="absolute -top-6 -right-8 bg-white border border-forest/10 rounded-2xl p-5 shadow-xl">
                <p className="text-[15px] font-bold uppercase tracking-[0.2em] text-gold/70 mb-1">
                  Portfolio
                </p>
              ...
              <div className="absolute -bottom-6 -left-8 bg-gold rounded-2xl px-5 py-4 shadow-xl">
                <p className="text-[15px] font-bold uppercase tracking-[0.2em] text-forest-deep/60 mb-0.5">
                  Countries
                </p>
    ...
    <div className="bg-[#0A1F11] border-y border-white/5 overflow-hidden py-8">
      <div className="flex w-max animate-marquee">
        {duplicateStats.map((s, i) => (
          <div
            key={i}
            className="flex flex-col items-center text-center px-16 border-r border-white/5 last:border-r-0"
          >
            <p className="text-[1.8rem] font-bold text-gold leading-none mb-1">{s.num}</p>
            <p className="text-[15px] font-bold uppercase tracking-[0.2em] text-white/40 whitespace-nowrap">
              {s.label}
            </p>
          </div>
        ))}
  ...
  const pillars = [
    {
      ...
      desc: "Sharpen your vision, business model and growth roadmap.",
    },
    {
      icon: <Globe2 className="h-5 w-5" strokeWidth={1.5} />,
      title: "Global Market Readiness",
      desc: "Validate your solution for international markets.",
    },
    {
      icon: <Users className="h-5 w-5" strokeWidth={1.5} />,
      title: "Mentoring & Expertise",
      desc: "Learn from founders, industry leaders and sector specialists.",
    },
    {
      icon: <LineChart className="h-5 w-5" strokeWidth={1.5} />,
      title: "Investor Access",
      desc: "Build investor-ready narratives and connect with the right investors.",
    },
    {
      icon: <Handshake className="h-5 w-5" strokeWidth={1.5} />,
      title: "Business Collaboration",
      desc: "Access partners, customers and pilot opportunities worldwide.",
    },
    {
      icon: <Rocket className="h-5 w-5" strokeWidth={1.5} />,
      title: "UK Launchpad",
      desc: "Establish credibility, partnerships and market access via UK.",
    },
  ];
    ...
    <section className="py-32 md:py-40 bg-[#F9F6F0] relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="flex items-center gap-3 mb-24 justify-center">
          ...
          <span className="text-[14px] font-bold uppercase tracking-[0.35em] text-gold">
            About the Programme
          </span>
          <div className="h-px w-12 bg-gold/40" />
        </div>
        ...
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-6">
              <p className="text-[16px] md:text-[17px] text-forest/70 leading-[1.8] font-light max-w-lg">
                The Global Ventures Programme is GEL's international launchpad for high-potential
                startups, research-led innovations and impact ventures seeking to expand beyond
                their home markets.
              </p>
              <p className="text-[16px] md:text-[17px] text-forest/70 leading-[1.8] font-light max-w-lg">
                We connect selected ventures with the UK's business, academic, investor and
                innovation ecosystems—helping them validate, grow and scale globally.
              </p>
            </div>
            <div className="pt-6">
              <Link
                to="/contact"
                className="group inline-flex items-center gap-3 rounded-full bg-forest-deep px-9 py-4.5 text-[14px] font-bold uppercase tracking-[0.2em] text-white transition-all hover:bg-forest shadow-xl shadow-forest/15 hover:shadow-forest/30"
              >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 relative z-10">
            {pillars.map((p, i) => (
              <div
                key={i}
                className="group bg-white rounded-[2rem] p-8 lg:p-9 transition-all duration-500 hover:-translate-y-2 shadow-[0_15px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_30px_60px_rgba(201,168,76,0.12)] flex flex-col items-start relative overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Typography */}
                  <h4 className="text-[14px] font-bold text-forest-deep mb-4 leading-tight tracking-wide group-hover:text-forest transition-colors duration-300">
                    {p.title}
                  </h4>
...
const VENTURES = [
  {
    ...
    isVenture: true,
    name: "KAVACH AI",
    desc: "AI-powered solutions for security and risk management across critical infrastructure, enterprises and public systems.",
    bgClass: "from-[#0A2733] via-[#0A1C24] to-[#0A1F11]",
  },
  {
    ...
    isVenture: true,
    name: "CARBONSYNQ",
    desc: "A sustainability intelligence platform that helps organisations measure, manage and reduce carbon impact with precision and transparency.",
    bgClass: "from-[#163B21] via-[#0E2715] to-[#0A1F11]",
  },
  {
    ...
    isVenture: true,
    name: "PROJECT TACTO",
    desc: "Building advanced tactile sensing solutions that enhance human-machine interaction across robotics, healthcare and assistive technologies.",
    bgClass: "from-[#2A163B] via-[#170E24] to-[#0A1F11]",
  },
  {
    ...
    isVenture: false,
    name: "VYOMVEDA",
    desc: "Researching space weather intelligence and predictive modelling to support resilient space and satellite operations.",
    bgClass: "from-[#3D2812] via-[#1F170D] to-[#0A1F11]",
  },
  {
    ...
    isVenture: false,
    name: "CELLUNOVA",
    desc: "Developing innovative cells for therapeutics and biomaterials through cutting-edge research in regenerative medicine.",
    bgClass: "from-[#3B1622] via-[#210D15] to-[#0A1F11]",
  },
  {
    ...
    isVenture: true,
    name: "SAIVVY",
    desc: "A digital health platform bringing AI to quality care through AI-driven diagnostics and patient empowerment tools.",
    bgClass: "from-[#16213B] via-[#0D1526] to-[#0A1F11]",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-[2.4rem] md:text-[3.2rem] font-bold text-white mb-4 tracking-tight leading-tight">
            A portfolio of <span className="font-serif italic text-gold">exceptional</span>{" "}
            innovations
          </h2>
          <p className="text-[15px] text-white/50 max-w-xl leading-relaxed">
            Startup and research-led innovations from emerging economies, shaping the future of
            global industries.
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 relative z-10">
          {filtered.map((v, i) => (
            ...
            >
              ...
              {/* Track badge */}
              <div
                className={`inline-flex items-center gap-2.5 self-start px-4 py-2 rounded-full border text-[15px] font-bold uppercase tracking-[0.2em] mb-8 transition-all duration-500 shadow-sm ${v.isVenture ? "bg-gold/15 text-gold border-gold/30 group-hover:border-gold/60 group-hover:bg-gold/25 group-hover:shadow-[0_0_20px_rgba(201,168,76,0.3)]" : "bg-white/10 text-white/80 border-white/20 group-hover:border-white/50 group-hover:bg-white/15"}`}
              >
                {v.icon} {v.track}
              </div>

              <h3 className="text-[20px] font-bold text-white mb-4 group-hover:text-gold transition-colors duration-300 tracking-wide">
                {v.name}
              </h3>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 group-hover:border-gold/30 transition-colors duration-500 flex items-center justify-between">
                <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-white/50 group-hover:text-gold transition-colors duration-300">
                  Explore Venture
                </span>
  ...
  const steps = [
    {
      ...
      title: "Discover",
      desc: "We identify high-potential ventures with the potential to solve meaningful problems at scale.",
    },
    {
      num: "02",
      icon: <ClipboardCheck className="h-5 w-5" />,
      title: "Diagnose",
      desc: "A deep-dive assessment of your strategy, market, team, technology and global readiness.",
    },
    {
      num: "03",
      icon: <TrendingUp className="h-5 w-5" />,
      title: "Strengthen",
      desc: "Tailored plan with mentoring, expert input, validation and venture-building support.",
    },
    {
      num: "04",
      icon: <Network className="h-5 w-5" />,
      title: "Connect",
      desc: "Introductions to investors, researchers, corporates and ecosystem partners.",
    },
    {
      num: "05",
      icon: <Send className="h-5 w-5" />,
      title: "Launch",
      desc: "Support for partnerships, pilots, viability and market entry through the UK.",
    },
    {
      num: "06",
      icon: <Target className="h-5 w-5" />,
      title: "Sustain & Scale",
      desc: "Continued support until you achieve sustainable, independent and scalable growth.",
    },
  ];
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6 relative z-10">
            {steps.map((s, i) => (
              <div key={i} className="group flex flex-col items-center text-center">
                ...
                <p className="text-[14px] text-[#0A1F11]/55 leading-[1.7] max-w-[120px]">
                  {s.desc}
                </p>
              </div>
            ))}
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-white/50">
                    For startups ready to grow and scale globally.
                  </p>
                </div>
              </div>
            ...
            <div className="relative p-10 lg:p-14">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-[#0A1F11]/60">
                    For research-led innovations before commercialisation.
                  </p>
                </div>
              </div>
              <div className="space-y-3">
...
function WhoShouldApply() {
  const items = [
    ...
    { icon: <FlaskConical className="h-6 w-6" />, title: "Research-led innovations" },
    {
      ...
      title: "University spinouts & researcher teams",
    },
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid md:grid-cols-[1fr_2fr] gap-20 items-center">
          <div>
            ...
            <h2 className="text-[2.2rem] font-bold text-[#0A1F11] mb-5 leading-tight">
              Who Should Apply?
            </h2>
            <p className="text-[14px] text-[#0A1F11]/60 leading-[1.8]">
              We seek ambitious founders and researchers creating solutions with the potential for
          ...
          <div className="flex flex-wrap gap-6">
            {items.map((item, i) => (
              <div
                key={i}
                className="group flex items-center gap-4 bg-white rounded-2xl border border-[#0A1F11]/6 px-6 py-4 hover:border-gold/25 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 flex-1 min-w-[200px]"
              >
  ...
  const ctas = [
    {
      icon: <TrendingUp className="h-5 w-5" />,
      title: "For Investors",
      desc: "Access a curated pipeline of high-potential ventures.",
      link: "Explore Opportunities",
    },
    {
      icon: <Building2 className="h-5 w-5" />,
      title: "For Universities",
      desc: "Collaborate on research, innovation and impact.",
      link: "Become a Partner",
    },
    {
      icon: <Briefcase className="h-5 w-5" />,
      title: "For Corporates",
      desc: "Pilot, co-create and access new solutions.",
      link: "Work With Us",
    },
    {
      icon: <Users className="h-5 w-5" />,
      title: "For Mentors",
      desc: "Guide exceptional founders globally.",
      link: "Join the Mentor Network",
    },
  ];
  return (
          ...
          <div className="relative grid lg:grid-cols-[380px_1fr]">
            ...
            <div className="p-12 lg:p-16 flex flex-col justify-center border-r border-white/8">
              ...
              <h2 className="text-[2rem] font-bold text-white leading-tight mb-4">
                Let's build global impact—
                <span className="font-serif italic text-gold">together.</span>
              </h2>
              ...
              <Link
                to="/contact"
                className="self-start inline-flex items-center gap-2 rounded-full bg-gold px-7 py-3.5 text-[15px] font-bold uppercase tracking-[0.2em] text-[#0A1F11] transition-all hover:bg-white"
              >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4">
              {ctas.map((cta, i) => (
                <div
                  key={i}
                  className={`p-10 flex flex-col border-white/8 hover:bg-white/[0.04] transition-colors ${i > 0 ? "border-l" : ""} ${i >= 2 ? "border-t lg:border-t-0" : ""}`}
                >
                  ...
                  <p className="text-[15px] text-white/45 leading-relaxed mb-5 flex-1">
                    {cta.desc}
                  </p>
