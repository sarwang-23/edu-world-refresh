      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 pt-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-[2rem] sm:text-[2.8rem] md:text-[4rem] font-bold text-forest-deep leading-[1.05] tracking-tight">
              Mentorship &<br />
            ...
            <p className="mt-4 text-[15px] text-forest/80 leading-[1.75] max-w-lg">
              Gain private introductions and ongoing guidance from a vetted network of successful
              founders, industry veterans, and Cambridge alumni. The right connection at the right
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              <Link
                to="/contact"
                search={{ source: "Mentorship & Founder Network" }}
      ...
      <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <h2 className="text-[2.2rem] font-bold text-forest-deep leading-tight mb-6">
            Build alongside those who have been there.
          </h2>
          <p className="text-[15px] text-forest/70 leading-relaxed mb-8">
            Entrepreneurship can be lonely, but building a venture shouldn't happen in a silo. Our
            network ensures you are surrounded by people who challenge your assumptions, open doors,
            and provide the hard-won insights you need to avoid common pitfalls.
          </p>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Access to the network is currently open for eligible founders. Get in touch to learn how
