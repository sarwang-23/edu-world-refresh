...
function Page() {
  const baliTestimonials = [
    {
      q: "The Bali experience shook every preconception I had about what a school could look like. Green School has created something truly miraculous — and GEL brought us inside it. I returned with a completely refreshed vision for our institution.",
      a: "Priya Menon",
      r: "The Orchid School, Pune",
      tag: "Bali Programme",
      img: person6Img,
      featured: true,
    },
    {
      q: "Five days among bamboo classrooms and student-led sustainability projects transformed the way I think about curriculum design. The immersion with Global Edu Lab was deeply impactful — both personally and professionally.",
      a: "Rajesh Nair",
      r: "Principal, Kerala International School",
      tag: "Bali Programme",
      img: person7Img,
      featured: false,
    },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <h1 className="text-[2rem] sm:text-[2.4rem] md:text-[3.2rem] font-bold text-forest-deep leading-[1.08] tracking-tight">
            ...
            <div className="mt-10 flex gap-3.5 flex-wrap sm:flex-nowrap items-center">
              <Link
                to="/apply-now"
                search={{ source: "Bali Green School Immersive Programme" }}
          ...
          <div className="relative order-1 md:order-2">
            <div className="relative aspect-[5/4] overflow-hidden rounded-[2rem] shadow-2xl shadow-forest/20 group">
              <img
                src={bali4Img}
                alt="Green School Bali"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                loading="lazy"
              />
            </div>
            <div className="absolute -bottom-5 -right-5 hidden sm:flex items-center gap-3 rounded-2xl bg-white shadow-xl p-4 border border-forest/8">
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {images.map((img, i) => (
            <div
              key={i}
              className={`relative rounded-2xl overflow-hidden shadow-md aspect-[4/3] group ${i === 4 ? "md:col-span-2 md:row-span-2" : ""}`}
            >
              <img
                src={img}
                alt={`Bali Visit ${i + 1}`}
