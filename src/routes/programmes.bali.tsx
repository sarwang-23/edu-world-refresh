  ...
  head: () => ({
    meta: [
      { title: "Bali Green School Immersive Programme — Global Edu Lab" },
      {
        name: "description",
        content:
          "An immersive study visit to the iconic Green School Bali — discover how sustainability, nature-based learning and creative curriculum design can transform your school.",
      },
      { property: "og:title", content: "Bali Green School Immersive Programme" },
      {
        property: "og:description",
        content:
          "Experience the world's most iconic green school and bring sustainable education principles back to your institution.",
      },
    ],
  }),
  component: Page,
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-5 text-[15px] text-forest/65 leading-relaxed max-w-lg">
              The Bali Green School Immersive Programme is a transformative 5-day experience at the
              legendary Green School in Ubud, Bali — the world's most celebrated sustainable school.
              Discover nature-based learning, bamboo architecture, circular design, student-led
              projects and curriculum models that are redefining education globally.
            </p>
  ...
  const pillars = [
    {
      ...
      items: [
        "Explore nature-based & project-based learning",
        "Visit bamboo classrooms & green infrastructure",
        "Learn circular design principles in curriculum",
      ],
    },
    {
      ...
      items: [
        "Leadership workshops with Green School founders",
        "Sessions on student-agency & self-directed learning",
        "Interact with global education reformers",
      ],
    },
    {
      ...
      items: [
        "Connect with school leaders from 20+ countries",
        "Community dinners & cultural immersion",
        "Become a Global Edu Lab Sustainability Alumni",
      ],
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Experience education, the Green School way!
          </h2>
        </div>
  ...
  const profiles = [
    {
      ...
      desc: "Leaders who want to transform their school culture, integrate sustainability and bring cutting-edge pedagogical models to their institution.",
      icon: <Building2 className="h-6 w-6" />,
      color: "bg-forest",
    },
    {
      title: "Curriculum Designers & HoDs",
      desc: "Those who want to redesign curricula using project-based, nature-connected and experiential learning frameworks.",
      icon: <Lightbulb className="h-6 w-6" />,
      color: "bg-gold",
    },
    {
      title: "Innovation & Eco Educators",
      desc: "Teachers and leaders passionate about embedding environmental awareness, student agency, and circular thinking into school programmes.",
  ...
  const days = [
    {
      ...
      items: ["Welcome & orientation at hotel", "Evening welcome dinner with the cohort"],
    },
    {
      day: "Day 2",
      location: "Green School — Immersion",
      items: [
        "Full campus tour & bamboo architecture walk",
        "Classroom observations & student project showcases",
        "Session: Nature-based curriculum design",
      ],
    },
    {
      day: "Day 3",
      location: "Deep-Dive Learning",
      items: [
        "Workshop: Project-based learning frameworks",
        "Farm-to-table & circular economy session",
        "Networking dinner with Green School founders",
      ],
    },
    {
      day: "Day 4",
      location: "Leadership & Culture",
      items: [
        "Leadership workshop: Building a green school culture",
        "Ubud cultural excursion & reflection walk",
        "Certificate ceremony & group dinner",
      ],
    },
    {
      day: "Day 5",
      location: "Departure",
      items: ["Final group debrief & action planning", "Check out & departures"],
    },
  ];
  return (
  ...
  const testimonials = [
    {
      ...
      quote:
        "The Bali experience shook every preconception I had about what a school could look like. Green School has created something truly miraculous — and GEL brought us inside it. I returned with a completely refreshed vision for our institution.",
      initials: "PM",
    },
    {
      name: "Rajesh Nair",
      school: "Principal, Kerala International School",
      quote:
        "Five days among bamboo classrooms and student-led sustainability projects transformed the way I think about curriculum design. The immersion with Global Edu Lab was deeply impactful — both personally and professionally.",
      initials: "RN",
    },
  ];
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-2xl p-8 bg-forest-deep text-white border border-forest-deep relative overflow-hidden shadow-xl">
              ...
              <p className="text-[24px] font-bold text-white mb-3">
                Early bird starts at 1,500 USD
              </p>
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl h-full min-h-[400px] lg:min-h-[500px] bg-gradient-to-br from-emerald-700 via-green-600 to-teal-700 flex items-center justify-center relative">
            ...
            <div className="relative text-center text-white p-8">
              ...
              <p className="text-[15px] opacity-70">
                The world's most celebrated sustainable school
              </p>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white leading-tight">
          Bring the Green School spirit to your institution.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications open for the May 2026 cohort. Limited to 20 participants — secure your seat
          today.
        </p>
