        ...
        <div className="relative lg:col-span-5 lg:mt-14">
          <div className="relative overflow-hidden rounded-[2rem] shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 z-20 bg-gradient-to-t from-forest-deep/90 via-forest-deep/40 to-transparent">
              <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-gold mb-2">
                LATEST EDITION
              </p>
              <p className="text-white font-bold text-xl leading-snug">
                White Paper — Cambridge, March
              </p>
            </div>
          </div>
          ...
          <div className="absolute -bottom-6 -left-6 z-30 rounded-2xl border border-forest/10 bg-white p-6 shadow-xl w-40">
            <p className="text-[14px] font-bold uppercase tracking-widest text-forest/40 mb-1">
              PUBLICATIONS
            </p>
        ...
        <div className="grid gap-12 lg:grid-cols-12 items-center">
          <div className="lg:col-span-5 order-2 lg:order-1">
            ...
            <h2 className="text-4xl font-bold tracking-tight text-cream md:text-6xl leading-[1.1]">
              ...
              <span className="font-serif italic text-gold">Cambridge 2026.</span>
            </h2>
            <p className="mt-6 text-[15px] leading-relaxed text-cream/80 max-w-md">
              Perspectives from global business leaders and Judge Business School faculty on how
              artificial intelligence, sustainability, governance and shifting economic dynamics are
            ...
            <div className="mt-10 flex flex-wrap items-center gap-6">
              ...
              <span className="text-[14px] font-bold uppercase tracking-widest text-cream/40">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border border-white/5">
              ...
              <div className="absolute bottom-0 left-0 p-8 w-full">
                <span className="inline-block px-2 py-1 bg-gold/20 text-gold text-[14px] font-bold uppercase tracking-widest rounded mb-3 border border-gold/30">
                  PRIMARY PAPER
                </span>
    ...
    <section className="py-24 bg-cream">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Link
            to="/insights"
            className="text-[15px] font-bold uppercase tracking-widest text-forest-deep hover:text-forest flex items-center gap-1 group"
          >
            FULL ARCHIVE
          ...
          {reports.map((r, idx) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-8">
                <p className="text-[14px] font-bold uppercase tracking-widest text-gold mb-3">
                  {r.category}
                </p>
                ...
                <div className="flex items-center justify-between border-t border-forest/10 pt-4 mt-auto">
                  ...
                  {r.downloadLink !== "#" ? (
                    <button
                      onClick={() => onDownload(r.downloadLink)}
                      className="text-[14px] font-bold uppercase tracking-widest text-forest-deep flex items-center gap-1 hover:text-gold transition-colors"
                    >
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-forest-deep/80 backdrop-blur-sm">
      <div className="bg-white rounded-3xl w-full max-w-md p-8 relative shadow-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-[15px] text-forest/70 mt-2">
            Please provide your details to download the report.
          </p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-[15px] font-bold text-forest-deep uppercase tracking-widest mb-1.5">
              Full Name
            </label>
            <input
              required
          ...
          <button
            type="submit"
            className="w-full mt-6 bg-gold text-forest-deep font-bold rounded-xl px-6 py-4 flex items-center justify-center gap-2 transition-colors hover:bg-gold/90"
          >
