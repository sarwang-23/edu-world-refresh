          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 pb-16 lg:grid-cols-12 lg:gap-12 pt-8 md:pt-12">
            ...
            <div className="lg:col-span-6">
              ...
              <h2 className="text-xl md:text-2xl font-medium text-forest-deep mb-4 leading-snug">
                A Scalable Platform for Global Education, Research, Innovation and Institutional
                Partnerships
              </h2>

              <p className="max-w-xl text-[17px] leading-[1.65] text-forest/75 mb-8">
                We help universities create long-term impact through student mobility, executive
                education, faculty engagement, research collaboration and innovation partnerships
                across Cambridge, Oxford and the wider UK ecosystem.
              </p>
          ...
          <div className="relative mx-auto max-w-7xl px-6 z-10">
            ...
            <div className="max-w-4xl mx-auto text-center mb-10">
              ...
              <p className="text-forest/80 text-lg leading-relaxed mb-4 max-w-2xl mx-auto">
                We help universities establish their own UK-facing Global Centre through a lean,
                scalable model. A university-branded platform that brings together multiple
                international activities under one strategic umbrella.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-forest/70 max-w-2xl mx-auto">
                We design and deliver initiatives that create meaningful, measurable and long-term
                outcomes.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white rounded-[2rem] overflow-hidden border border-forest/10 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
                >
              ...
              {[
                {
                  ...
                  desc: "Deep connections across Cambridge, Oxford and the UK ecosystem.",
                  icon: Globe2,
                },
                {
                  title: "END-TO-END SUPPORT",
                  desc: "From strategy and design to delivery and long-term engagement.",
                  icon: Network,
                },
                {
                  title: "BESPOKE & FLEXIBLE",
                  desc: "Tailored solutions aligned with your institution's goals.",
                  icon: Target,
                },
                {
                  title: "MEASURABLE IMPACT",
                  desc: "Programs designed for real outcomes and sustainable partnerships.",
                  icon: Zap,
                },
                {
                  title: "GLOBAL NETWORK ACCESS",
                  desc: "Academia, industry, research, investors and policy leaders.",
                  icon: Users,
                },
                {
                  title: "TRUSTED PARTNER",
                  desc: "Committed to integrity, quality and long-term collaboration.",
                  icon: ShieldCheck,
                },
              ].map((item, i) => (
                <div key={i} className="flex flex-col items-center px-4">
                  ...
                  <p className="text-[13px] text-cream/70 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8 md:p-10">
              ...
              <p className="text-forest/80 text-lg leading-relaxed mb-6">{selectedOffering.desc}</p>
