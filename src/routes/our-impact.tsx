        ...
        <div className="relative md:col-span-5 md:pl-2 mt-10 md:mt-8">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-border/60 shadow-2xl group">
            <img
              src={heroImg}
              alt="Impact"
              className="h-[500px] md:h-[650px] w-full object-cover object-center transition-transform duration-1000 group-hover:scale-105"
            />
              ...
              <div key={arrayIndex} className="flex items-center gap-x-10 md:gap-x-16 px-5 md:px-8">
                {stats.map((stat, i) => (
                  <div key={`${arrayIndex}-${i}`} className="flex items-center gap-4 text-left">
                    ...
                    <span className="text-[14px] font-bold uppercase tracking-[0.15em] text-cream/70 max-w-[90px] leading-snug">
                      {stat.label}
                    </span>
                  </div>
                ))}
  ...
  const items = [
    {
      ...
      tag: "FOUNDER",
      t: "Ideas into Impact",
      d: "Arjun and his team developed a solution that has helped over 2,000 young people access quality education.",
      link: "Read Arjun's Story",
      content:
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-20">
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-forest-deep md:text-[3.5rem]">
            Stories that <span className="font-serif italic text-gold">inspire.</span>
          </h2>
          <p className="mt-6 text-[15px] font-medium text-forest/70 max-w-lg leading-relaxed">
            Real people, real outcomes — hear journeys that show what our programmes make possible.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 relative group overflow-hidden rounded-[2.5rem] border border-border/60 shadow-2xl flex flex-col justify-end min-h-[550px] lg:min-h-full">
            ...
            <div className="relative p-10 md:p-12">
              <span className="inline-block rounded-full bg-gold px-3.5 py-1.5 text-[14px] font-bold uppercase tracking-[0.2em] text-forest-deep mb-6">
                {mainStory.tag}
              </span>
              <h3 className="text-3xl md:text-4xl font-bold text-cream mb-5 leading-tight">
                {mainStory.t}
              </h3>
              <p className="text-cream/80 text-[15px] md:text-base leading-relaxed mb-8">
                {mainStory.d}
              </p>
              <button
                onClick={() => setActiveStory(mainStory)}
                className="inline-flex items-center gap-2 text-[15px] font-bold uppercase tracking-[0.2em] text-gold hover:text-cream transition-colors group/link text-left"
              >
                {mainStory.link}{" "}
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            {items.map((s) => (
              <article
                key={s.t}
                className="flex flex-col sm:flex-row gap-8 p-6 md:p-8 rounded-[2.5rem] border border-forest/10 bg-white hover:border-gold/40 hover:shadow-xl transition-all duration-300 group"
              >
                <div className="sm:w-56 shrink-0 overflow-hidden rounded-2xl border border-border/60">
                  <img
                    src={s.img}
                    alt={s.t}
                    className="h-40 sm:h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                </div>
                <div className="flex flex-col justify-center py-2 items-start">
                  <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-gold mb-3">
                    — {s.tag}
                  </span>
                  <h3 className="text-2xl font-bold text-forest-deep mb-3 group-hover:text-gold transition-colors">
                    {s.t}
                  </h3>
                  <p className="text-[15px] text-forest/70 leading-relaxed mb-6">{s.d}</p>
                  <button
                    onClick={() => setActiveStory(s)}
                    className="inline-flex items-center gap-2 text-[15px] font-bold uppercase tracking-[0.15em] text-forest hover:text-gold transition-colors group/link text-left"
                  >
                    {s.link}{" "}
                    <ArrowUpRight className="h-4 w-4 transition-transform group-hover/link:-translate-y-0.5 group-hover/link:translate-x-0.5" />
                  </button>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 lg:p-12">
          ...
          <div className="relative w-full max-w-5xl bg-white rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-300 max-h-[90vh]">
            ...
            <div className="w-full md:w-3/5 p-8 md:p-12 lg:p-16 flex flex-col overflow-y-auto">
              <button
                onClick={() => setActiveStory(null)}
                className="absolute top-6 right-6 p-2.5 rounded-full bg-forest/5 text-forest hover:bg-forest/10 hover:text-forest-deep transition-colors z-10"
              >
                <X className="w-5 h-5" />
              </button>

              <span className="text-[14px] font-bold uppercase tracking-[0.25em] text-gold mb-4">
                — {activeStory.tag}
              </span>
              <h3 className="text-3xl md:text-4xl font-bold text-forest-deep mb-5 leading-tight">
                {activeStory.t}
              </h3>
              ...
              <div className="mt-auto pt-8 border-t border-forest/10 flex justify-between items-center">
                <span className="text-[15px] font-bold uppercase tracking-[0.2em] text-forest/40">
                  Global Education Lab
                </span>
                <button
                  onClick={() => setActiveStory(null)}
                  className="text-[14px] font-bold uppercase tracking-[0.2em] text-forest hover:text-gold transition-colors"
                >
                  Close Story
                </button>
              </div>
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sdgs.map((sdg) => (
            <div
              key={sdg.num}
              className="bg-[#0A2215]/50 rounded-[1.5rem] border border-white/5 p-8 flex flex-col justify-between min-h-[180px] hover:bg-[#0A2215]/80 hover:border-gold/20 hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 group"
            >
    ...
    <section className="bg-[#F7F5F0] py-24 md:py-32 border-b border-border/60">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
          ...
          <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-forest/50 md:pb-2 border-b border-forest/10 pb-1">
            ...
            <div className="flex flex-col gap-10 relative z-10">
              ...
              <ul className="space-y-4 w-full">
                {regions.map((r, i) => (
                  <li
                    key={r.label}
                    className="flex justify-between items-center text-[14px] font-bold text-forest-deep group/item"
                  >
          ...
          <div className="group rounded-[2.5rem] border border-white bg-gradient-to-b from-white to-white/60 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500 backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="flex h-[200px] items-end justify-between gap-3 relative mt-10 z-10">
              ...
              {growth.map((g, i) => (
                <div
                  key={g.y}
                  className="flex flex-col items-center gap-4 relative z-10 w-full group/bar"
                >
                  <div
                  ...
                  <span className="text-[15px] font-bold text-forest/40 group-hover/bar:text-gold transition-colors">
                    {g.y}
                  </span>
                </div>
              ))}
...
function Testimonials() {
  const testimonials = [
    {
      q: "The ecosystem approach adopted by GEL is truly transformative. It doesn't just educate; it builds bridges between continents.",
      a: "Dr. Sarah Jenkins",
      r: "University of Oxford",
    },
    {
      q: "Our partnership with GEL has accelerated our research commercialisation beyond our initial expectations.",
      a: "Marcus Thorne",
      r: "Tech Innovators Alliance",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="rounded-[2.5rem] border border-forest/10 bg-white p-12 relative shadow-xl hover:shadow-2xl transition-shadow duration-500"
            >
              <Quote className="absolute top-12 right-12 h-16 w-16 text-forest/5" />
              <p className="text-2xl md:text-3xl font-serif italic text-forest-deep leading-relaxed mb-10 relative z-10">
                "{t.q}"
              </p>
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-forest/10 flex items-center justify-center text-forest font-serif italic text-xl">
                  {t.a.charAt(0)}
                </div>
                <div>
                  <p className="text-[15px] font-bold text-forest-deep">{t.a}</p>
                  <p className="text-[14px] font-bold uppercase tracking-[0.2em] text-forest/50 mt-1">
                    {t.r}
                  </p>
                </div>
              </div>
    ...
    <section className="bg-cream py-24 md:py-32 relative overflow-hidden border-b border-border/60">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight text-forest-deep md:text-[3.5rem]">
            Connecting <span className="font-serif italic text-gold">continents.</span>
          </h2>
          <p className="mt-8 max-w-2xl text-lg text-forest/70 leading-relaxed">
            From Cambridge to the world, our network spans over 25 countries, fostering cross-border
        ...
        <div className="relative mx-auto max-w-5xl h-[400px] md:h-[500px] bg-forest-deep rounded-[2.5rem] border border-white/10 shadow-2xl p-10 overflow-hidden group">
          ...
          {nodes.map((n) => (
            <div
              key={n.id}
              className="absolute flex flex-col items-center gap-2 group/node cursor-pointer"
              style={{ left: `${n.x}%`, top: `${n.y}%`, transform: "translate(-50%, -50%)" }}
            >
              <div
                className={`absolute rounded-full animate-ping opacity-50 ${n.isMain ? "w-8 h-8 bg-gold" : "w-4 h-4 bg-cream"}`}
                style={{ animationDuration: "3s" }}
              />
              <div
                className={`rounded-full relative z-10 transition-transform duration-300 group-hover/node:scale-150 ${n.isMain ? "w-4 h-4 bg-gold shadow-[0_0_15px_rgba(200,160,90,0.8)]" : "w-2.5 h-2.5 bg-cream shadow-[0_0_8px_rgba(250,248,240,0.6)]"}`}
              />
          ...
          <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 bg-forest-deep border border-forest/50 shadow-2xl rounded-2xl p-5 max-w-[200px]">
            ...
            <div className="text-[14px] font-bold uppercase tracking-[0.15em] text-cream/70">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col items-start justify-between gap-12 lg:flex-row lg:items-end">
          ...
          <div className="flex flex-col items-start lg:items-end gap-6">
            ...
            <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-cream/50 pl-4 lg:pl-0">
