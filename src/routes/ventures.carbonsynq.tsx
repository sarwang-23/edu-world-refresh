...
const VENTURE: Venture = {
  ...
  accentColor: 'emerald',
  problem: 'Organisations face growing pressure to measure and report their carbon footprint accurately, but existing processes are manual, fragmented and hard to verify. This makes carbon accounting slow, error‑prone and difficult to trust — creating barriers to credible climate action, regulatory compliance and participation in carbon markets.',
  solution: "CarbonSynq lets organisations automate emissions measurement, verify data with greater confidence, and connect directly to a transparent, trustworthy carbon marketplace — all on one platform. This is powered by our proprietary blend of AI‑driven accounting and satellite + blockchain‑based MRV.",
  matters: 'Accurate, verifiable carbon accounting is foundational to credible climate action, regulatory compliance, and trust in carbon markets.',
  impact: 'Facilitates credible climate action, unlocks market participation, and drives measurable progress toward net‑zero commitments.',
  highlights: [
    {
  ...
  seeking: [
    { icon: <Building2 className="h-5 w-5" />, t: 'Pilot Partners', d: "Enterprises to validate and deploy CarbonSynq's AI carbon accounting platform." },
    { icon: <Handshake className="h-5 w-5" />, t: 'Strategic Partners', d: 'Carbon registries, satellite data providers, or enterprise integration partners.' },
    { icon: <Lightbulb className="h-5 w-5" />, t: 'Mentors & Experts', d: 'Experts in climate finance, carbon markets, enterprise sales, and regulatory compliance.' },
    { icon: <Globe2 className="h-5 w-5" />, t: 'Ecosystem Collaboration', d: 'Regulators, research labs, and sustainability-focused corporates who want to co-develop credible MRV standards.' },
  ],
  roadmap: [
    { period: 'Current', icon: <Rocket className="h-5 w-5" />, items: ['Deploy pilots with early adopters', 'Refine AI accounting engine'], phase: 'MVP' },
    { period: 'Next 12 Months', icon: <TrendingUp className="h-5 w-5" />, items: ['Scale platform, add marketplace features', 'Onboard first 10 enterprise clients'], phase: 'Growth' },
    { period: '2027+', icon: <Globe className="h-5 w-5" />, items: ['Global expansion', 'Regulatory certifications across key markets'], phase: 'Scale' },
  ],
  heroImg: 'https://images.unsplash.com/photo-1618044733300-9472054094ee?q=80&w=2071&auto=format&fit=crop',
    ...
    <section className="mx-auto max-w-7xl px-4 sm:px-6 pt-14 pb-20">
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-12">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm flex flex-col md:flex-row">
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <h3 className="text-emerald-600 font-black uppercase tracking-widest text-[10px] mb-5">Why It Matters</h3>
          ...
          <div id="team" className="scroll-mt-52">
            ...
            <div className={`grid gap-5 ${v.team.length === 2 ? 'sm:grid-cols-2' : 'sm:grid-cols-2 xl:grid-cols-3'}`}>
              {v.team.map((member, i) => (
                <div
                  key={i}
                ...
                >
                  <div className="relative bg-gradient-to-b from-slate-50 to-slate-100/80 px-6 pt-7 pb-6 flex flex-col items-center text-center border-b border-slate-100">
                    ...
                    <p className="text-[11px] font-black mt-1 uppercase tracking-[0.15em] text-emerald-600">{member.role}</p>
                  </div>
                        ...
                        <ul className="space-y-2">
                          {stage.items.map((item, j) => (
                            <li key={j} className="flex items-start gap-2.5 text-[13px] text-slate-500 leading-[1.7]">
                              <span className={`mt-[8px] w-1.5 h-1.5 rounded-full shrink-0 ${i === 0 ? 'bg-emerald-400' : 'bg-slate-300'}`} />
                              <span>{item}</span>
                            </li>
                          ))}
                        </ul>
        ...
        <div className="w-full lg:w-[300px] xl:w-[320px] shrink-0 mt-2 lg:mt-0 lg:sticky lg:top-[172px] flex flex-col gap-5 self-start">
          ...
          <div id="collaborate" className="rounded-2xl p-7 text-white relative overflow-hidden shadow-xl bg-[#071A10]">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-6">
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-400 mb-5">Currently Seeking</p>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-400 mb-5">Quick Stats</p>
...
function GelsRole({ v }: { v: Venture }) {
  const items = [
    { icon: <Rocket className="h-5 w-5 text-emerald-500" />, title: 'Accelerate Product-Market Fit', desc: "GEL helps ventures like CarbonSynq sharpen their go-to-market strategy and connect with early enterprise customers." },
    { icon: <Users className="h-5 w-5 text-emerald-500" />, title: 'Mentorship Network', desc: "Access to GEL's global network of domain experts in climate finance, enterprise sales, and regulatory compliance." },
    { icon: <Globe2 className="h-5 w-5 text-emerald-500" />, title: 'Global Exposure', desc: "Opportunities to present at international forums like GSDC and connect with investors and partners worldwide." },
  ]
  return (
    <section id="gels-role" className="bg-slate-50 border-t border-b border-slate-200 py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center gap-4 mb-10">
          <p className="text-[11px] font-black uppercase tracking-[0.22em] text-slate-400">GEL's Role</p>
          <div className="flex-1 h-px bg-slate-200" />
        </div>
  ...
  return (
    <section className="relative overflow-hidden bg-[#071A10] text-white py-20">
      ...
      <div className="relative mx-auto max-w-4xl text-center px-6 z-10">
        <p className="text-[10.5px] font-black uppercase tracking-[0.25em] text-emerald-400/60 mb-4">Join the Journey</p>
        ...
        <p className="text-white/50 text-[15px] mb-10 max-w-xl mx-auto leading-relaxed">
          Whether you're an enterprise, investor, or domain expert — there's a role for you in the net-zero transition.
        </p>
