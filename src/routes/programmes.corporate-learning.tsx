  ...
  head: () => ({
    meta: [
      { title: "Corporate Learning & ESG Workshops — Global Edu Lab" },
      {
        name: "description",
        content:
          "Bespoke leadership workshops for boards and executive teams on ESG, corporate governance, entrepreneurship and organisational behaviour. On-site or at Cambridge.",
      },
      { property: "og:title", content: "Corporate Learning & ESG Workshops" },
      {
        property: "og:description",
        content:
          "Custom Cambridge-quality leadership workshops for boards and senior leadership teams.",
      },
    ],
  }),
  component: Page,
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[14px] font-bold uppercase tracking-[0.3em] text-gold">
                Bespoke Advisory · Rolling Calendar
              </span>
            </div>
            ...
            <p className="mt-5 text-[15px] text-forest/65 leading-relaxed max-w-lg">
              Custom workshops and learning programmes for boards and senior leadership teams —
              designed around the themes we have delivered since 2022: ESG leadership, corporate
              governance, entrepreneurship, organisational behaviour and AI strategy.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Six core themes, infinitely customisable.
          </h2>
          <p className="mt-4 text-[15px] text-forest/65 max-w-2xl mx-auto leading-relaxed">
            Each workshop theme can be delivered as a half-day, full-day or multi-session learning
            journey — tailored to your board, your sector and your strategic priorities.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {themes.map((t, i) => (
            <div
              key={i}
              className="group bg-[#F7F5F0] rounded-3xl border border-forest/8 overflow-hidden hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className={`h-1.5 w-full ${t.color}`} />
              <div className="p-8">
                <div
                  className={`mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl ${t.color} text-white shadow-lg group-hover:scale-105 transition-transform duration-300`}
                >
                  {t.icon}
                </div>
  ...
  const steps = [
    {
      ...
      desc: "We begin with a conversation to understand your organisation, your leadership team, your sector and the specific challenges you are navigating.",
    },
    {
      n: "02",
      title: "Bespoke Design",
      desc: "Our academic team designs a programme precisely calibrated to your context — selecting themes, faculty, case studies and formats that fit your needs.",
    },
    {
      n: "03",
      title: "Proposal & Brief",
      desc: "We present a detailed proposal including suggested agenda, faculty profiles, delivery format and indicative investment.",
    },
    {
      n: "04",
      title: "Programme Delivery",
      desc: "We deliver the workshop — on-site at your offices or at Cambridge. Our faculty bring cutting-edge insight and genuine interactivity to every session.",
    },
    {
      n: "05",
      title: "Follow-Through",
      desc: "Optional: post-programme reflection sessions, action planning workshops, and ongoing advisory access to ensure learning translates to impact.",
    },
  ];
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-white">
            From enquiry to impact — five steps.
          </h2>
        </div>
        <div className="grid md:grid-cols-5 gap-4">
          {steps.map((s, i) => (
            <div
              key={i}
              className="rounded-3xl border border-white/10 bg-white/5 p-6 hover:bg-white/10 hover:border-gold/30 transition-all duration-300 text-center"
            >
    ...
    <section className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            We come to you — or you come to Cambridge.
          </h2>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          {formats.map((f, i) => (
            <div
              key={i}
              className="bg-white rounded-3xl p-10 border border-forest/10 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-forest-deep text-gold mb-6 shadow-lg">
                {f.icon}
              </div>
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-forest-deep px-6 py-3 text-[15px] font-bold uppercase tracking-widest text-white hover:bg-forest transition-all duration-300"
              >
  ...
  const clients = [
    {
      ...
      title: "FTSE-Listed Companies",
      desc: "Board-level ESG, governance and strategy workshops for listed UK and Indian companies.",
      color: "bg-forest-deep",
    },
    {
      icon: <Globe2 className="h-6 w-6" />,
      title: "Family Offices & Business Houses",
      desc: "Governance and succession planning workshops for large family-owned business groups.",
      color: "bg-gold",
    },
    {
      icon: <Briefcase className="h-6 w-6" />,
      title: "Private Equity & VC",
      desc: "Portfolio company leadership development and ESG integration workshops.",
      color: "bg-forest",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Startups & Scale-ups",
      desc: "Leadership capability building for founder-led teams preparing for rapid growth.",
      color: "bg-forest/60",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {clients.map((c, i) => (
            <div
              key={i}
              className="group rounded-3xl border border-forest/8 bg-[#F7F5F0] overflow-hidden hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-500"
            >
              <div className={`h-1.5 w-full ${c.color}`} />
              <div className="p-7">
                <div
                  className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl ${c.color} text-white shadow-lg`}
                >
                  {c.icon}
                </div>
                <h3 className="text-[15px] font-bold text-forest-deep mb-3 group-hover:text-gold transition-colors duration-300">
                  {c.title}
                </h3>
  ...
  const testimonials = [
    {
      ...
      initials: "VM",
      quote:
        "The ESG workshop delivered by Global Education Lab was the single most impactful board development exercise we have run in five years. The faculty brought genuine Cambridge rigour to our specific business context.",
    },
    {
      name: "Sarah Okafor",
      ...
      initials: "SO",
      quote:
        "The Corporate Governance workshop cut through the theoretical noise and gave our board a clear, actionable framework. We implemented changes in our committee structure within two weeks of the session.",
    },
    {
      name: "Arjun Nair",
      ...
      initials: "AN",
      quote:
        "We had the workshop at Cambridge — two days at Judge Business School. My entire leadership team came back transformed. The combination of intellectual challenge and Cambridge atmosphere was extraordinary.",
    },
  ];
  ...
  return (
    <section className="bg-[#F7F5F0] py-24">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mx-auto h-20 w-20 rounded-full bg-gradient-to-br from-forest-deep to-forest flex items-center justify-center text-2xl font-bold text-white shadow-xl mb-6">
          {t.initials}
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mt-10">
          <button
            ...
            className="h-10 w-10 rounded-full border border-forest/15 flex items-center justify-center text-forest/50 hover:border-forest-deep hover:text-forest-deep transition-all"
          >
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white leading-tight">
          Build a workshop for your team.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Tell us about your organisation and your goals. We'll design a bespoke workshop that
          creates real, lasting impact for your leadership team.
        </p>
