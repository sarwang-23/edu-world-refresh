...
function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F4EFE6] pt-4 pb-16 md:pt-6 md:pb-20 border-b border-forest/10">
      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 relative z-10 pt-4">
        <div className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-6">
            ...
            <h1 className="text-[2rem] sm:text-[2.5rem] md:text-[3.25rem] lg:text-[3.75rem] font-bold text-forest-deep leading-[1.05] tracking-tight">
            ...
            <p className="mt-3 max-w-[520px] text-[15px] text-forest/75 leading-[1.7]">
              Learn from leading minds, explore world-class institutions, build global connections
              and turn ideas into real-world impact.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-2.5">
              {[
                ...
                <div
                  key={i}
                  className="inline-flex items-center gap-2 rounded-full bg-white/70 border border-forest/10 px-3.5 py-1.5 text-[14px] font-semibold text-forest-deep shadow-sm backdrop-blur-sm"
                >
            ...
            <div className="mt-6 flex flex-wrap gap-3.5">
              <a
                href="#tracks"
                className="group inline-flex items-center gap-2 rounded-full bg-forest-deep px-7 py-3.5 text-[14px] font-bold uppercase tracking-[0.15em] text-white hover:bg-forest transition-all duration-300 shadow-xl shadow-forest/25"
              >
                Explore Tracks
              ...
              <Link
                to="/contact"
                search={{ source: "Graduate Summer Programme (Hero)" }}
                className="inline-flex items-center gap-2 rounded-full bg-gold px-7 py-3.5 text-[14px] font-semibold tracking-wide text-forest-deep transition-all hover:bg-gold-deep shadow-md shadow-gold/20 hover:shadow-xl hover:-translate-y-1 animate-float uppercase tracking-[0.15em]"
              >
              ...
              <div className="absolute bottom-4 right-4 flex items-center gap-2.5 z-20">
                ...
                >
                  {isPlaying ? (
                    ...
                    <Play className="h-5 w-5 text-gold ml-0.5 fill-current" />
                  )}
                </button>
  ...
  const elements = [
    {
      ...
      tag: "World-Class",
      desc: "Engage with world-class teaching and cutting-edge research.",
    },
    {
      img: cambridgeEcosystemImg,
      icon: <Building2 className="h-5 w-5" />,
      num: "02",
      title: "Cambridge Ecosystem",
      tag: "Innovation",
      desc: "Access universities, research centres, startups, investors and innovation hubs.",
    },
    {
      img: handsOnImg,
      ...
      tag: "Practical",
      desc: "Interactive workshops, team projects and real-world problem solving.",
    },
    {
      img: siteVisitImg,
      ...
      title: "Site Visits",
      tag: "Real-World",
      desc: "Visit leading institutions, labs, companies and cultural landmarks.",
    },
    {
      ...
      tag: "Connections",
      desc: "Build lifelong friendships and professional connections.",
    },
    {
      img: socialCulturalImg,
      icon: <Heart className="h-5 w-5" />,
      num: "06",
      title: "Social & Cultural",
      tag: "Experience",
      desc: "Explore Cambridge life, activities and the rich UK culture.",
    },
  ];
  return (
    <section className="bg-white py-32 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="mb-16">
          ...
          <h2 className="text-[2.2rem] md:text-[2.8rem] font-bold text-forest-deep mb-6 leading-[1.1]">
            Why this programme is different.
          </h2>
          <p className="text-[15px] text-forest/70 max-w-2xl leading-[1.75] mb-8">
            Most summer programmes offer lectures and tours. We go further — combining deep academic
            engagement with real-world exposure, peer collaboration and personal growth.
          </p>
          <div className="inline-flex items-center gap-4 overflow-hidden rounded-2xl bg-[#F4EFE6] border border-gold/20 px-6 py-4 shadow-sm group">
            ...
            <div>
              <span className="text-[15px] font-bold text-forest-deep leading-[1.6]">
                It's not just a summer.{" "}
              </span>
              <span className="text-[15px] font-bold text-gold leading-[1.6]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {elements.map((e, i) => (
            <div
              key={i}
              className="group relative flex flex-col rounded-[1.75rem] overflow-hidden border border-forest/8 bg-white shadow-[0_4px_24px_rgba(26,53,35,0.07)] hover:shadow-[0_20px_60px_rgba(26,53,35,0.18)] hover:-translate-y-2 transition-all duration-500 cursor-pointer"
            >
              {/* ── Image frame ── */}
              <div className="relative aspect-[4/5] w-full overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gold/20 border border-gold/30 text-gold backdrop-blur-sm group-hover:bg-gold group-hover:text-forest-deep group-hover:border-gold transition-all duration-300 shadow-lg">
                    {e.icon}
                  </div>
  ...
  const elements = [
    {
      ...
      desc: "Learn from academics, researchers and industry leaders.",
    },
    {
      img: globalNetworkImg,
      title: "Workshops & Projects",
      desc: "Collaborate, ideate and build solutions with global peers.",
    },
    {
      img: siteVisitImg,
      title: "Site Visits",
      desc: "Explore universities, labs, companies and innovation hubs.",
    },
    {
      img: cambridgeEcosystemImg,
      title: "Startup & Research Access",
      desc: "Meet founders, researchers and innovators driving change.",
    },
    {
      img: socialCulturalImg,
      title: "Social & Cultural Activities",
      desc: "Punting, college visits, dinners, city tours and more.",
    },
  ];
  return (
    <section className="py-32 bg-forest-deep relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <h2 className="text-[2.2rem] md:text-[3rem] font-bold text-white mb-4 leading-tight">
          Experience the Cambridge Ecosystem
        </h2>
        <p className="text-[15px] text-cream/75 leading-[1.8] mb-16 max-w-2xl">
          More than a classroom — immerse yourself in the people, places and communities that make
          Cambridge a global centre of knowledge and innovation.
        </p>
        ...
        <div className="grid md:grid-cols-5 gap-4">
          {elements.map((e, i) => (
            <div
              key={i}
              className="group relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-400 hover:-translate-y-1"
            >
    ...
    <section id="tracks" className="py-32 bg-[#F4EFE6] relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-[15px] text-forest/80 max-w-lg mx-auto leading-[1.75]">
            Three unique pathways. One unforgettable Cambridge experience.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-white border border-forest/8 shadow-[0_4px_32px_rgba(26,53,35,0.08)] hover:shadow-[0_32px_80px_rgba(26,53,35,0.2)] hover:-translate-y-3 transition-all duration-500 flex flex-col">
            ...
            <div className="p-9 pb-6">
              <div className="flex items-center justify-between mb-8">
                ...
                <span className="text-[15px] font-semibold text-forest/80 uppercase tracking-widest">
                  Entrepreneurship
                </span>
              </div>
              <h3 className="text-[2rem] font-bold text-forest-deep leading-[1.1] mb-2 group-hover:text-gold transition-colors duration-400">
                Entrepreneurship
                <br />& AI
              </h3>
              <p className="text-[15px] font-semibold text-forest/80 mb-4 tracking-wide">
                Build ideas. Solve problems.
              </p>
              <p className="text-[15px] text-forest/80 leading-[1.65] mb-6">
                Build ideas for an AI-enabled world and transform them into viable ventures.
              </p>
              <div className="flex flex-col gap-3">
                {[
                  "Opportunity discovery",
                  "AI tools in real world",
            ...
            <div className="relative h-48 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7 right-7">
                <Link
                  to="/students/entrepreneurship"
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-gold px-7 py-3 text-[15px] font-bold uppercase tracking-[0.2em] text-forest-deep shadow-xl shadow-gold/30 hover:bg-amber-400 transition-all duration-300 group/btn"
                >
                  Explore Track
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-white border border-forest/8 shadow-[0_4px_32px_rgba(26,53,35,0.08)] hover:shadow-[0_32px_80px_rgba(37,99,235,0.18)] hover:-translate-y-3 transition-all duration-500 flex flex-col">
            ...
            <div className="p-9 pb-6">
              ...
              <h3 className="text-[2rem] font-bold text-forest-deep leading-[1.1] mb-2 group-hover:text-blue-600 transition-colors duration-400">
                Research
                <br />
                Methods
              </h3>
              ...
              <p className="text-[15px] text-forest/80 leading-[1.65] mb-6">
                Develop research skills, explore topics and connect ideas with impact.
              </p>
              <div className="flex flex-col gap-3">
                {[
                  "Research design",
            ...
            <div className="relative h-48 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7 right-7">
                <Link
                  to="/students/stem-research"
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-blue-500 px-7 py-3 text-[15px] font-bold uppercase tracking-[0.2em] text-white shadow-xl shadow-blue-500/30 hover:bg-blue-400 transition-all duration-300 group/btn"
                >
                  Explore Track
                  <ArrowUpRight className="h-4 w-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                </Link>
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-white border border-forest/8 shadow-[0_4px_32px_rgba(26,53,35,0.08)] hover:shadow-[0_32px_80px_rgba(180,124,53,0.18)] hover:-translate-y-3 transition-all duration-500 flex flex-col">
            ...
            <div className="p-9 pb-6">
              ...
              <h3 className="text-[2rem] font-bold text-forest-deep leading-[1.1] mb-2 group-hover:text-orange-600 transition-colors duration-400">
                Architecture
                <br />& Design
              </h3>
              <p className="text-[15px] font-semibold text-forest/80 mb-4 tracking-wide">
              ...
              <p className="text-[15px] text-forest/80 leading-[1.65] mb-6">
                Explore architecture through design, heritage and human-centred spaces.
              </p>
              <div className="flex flex-col gap-3">
                {[
                  "Sustainable design",
                  "Heritage & urban design",
                  "Site analysis workshops",
            ...
            <div className="relative h-48 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7 right-7">
                <Link
                  to="/students/architecture"
                  className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#B47C35] px-7 py-3 text-[15px] font-bold uppercase tracking-[0.2em] text-white shadow-xl shadow-orange-500/30 hover:bg-[#966526] transition-all duration-300 group/btn"
                >
                  Explore Track
                  <ArrowUpRight className="h-4 w-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                </Link>
    ...
    <section className="bg-white py-32 relative overflow-hidden border-y border-forest/10">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2.2rem] md:text-[3rem] font-bold text-forest-deep mb-6 leading-tight">
            Campus Life & Accommodation
          </h2>
          <p className="text-[15px] text-forest/70 max-w-2xl mx-auto leading-[1.75]">
            Live, learn, and grow at one of Cambridge's historic colleges. From formal dinners to
            comfortable dormitories, experience the true essence of university life.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 group relative overflow-hidden rounded-[2rem] border border-forest/10 shadow-md">
            ...
            <img
              src={campusLifeWorkshop}
              alt="Classroom and Workshops"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-20">
              ...
              <p className="text-cream/80 text-[15px]">
                Engage deeply with peers and facilitators in modern, dynamic learning spaces.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="group relative overflow-hidden rounded-[2rem] border border-forest/10 shadow-md h-[200px] md:h-[238px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 via-black/40 to-transparent z-20">
                ...
                <p className="text-cream/80 text-[15px]">
                  Modern, single en-suite rooms for delegates.
                </p>
              </div>
            </div>
          </div>
...
function Impact() {
  const stats = [
    { icon: <Users className="h-6 w-6" />, v: "500+", l: "Participants from multiple countries" },
    {
      ...
      v: "50+",
      l: "Institutions, labs & innovation hubs visited",
    },
    {
      icon: <GraduationCap className="h-6 w-6" />,
      v: "100+",
      l: "Experts, academics & entrepreneurs engaged",
    },
    {
      icon: <Globe2 className="h-6 w-6" />,
      v: "Lasting",
      l: "Networks, friendships & professional growth",
    },
  ];
  return (
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <h2 className="text-[2.2rem] md:text-[3rem] font-bold text-forest-deep mb-16 leading-tight">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {stats.map((s, i) => (
            <div
              key={i}
              className="group relative overflow-hidden rounded-[1.75rem] border border-forest/10 bg-white p-7 hover:border-gold/40 hover:shadow-[0_16px_48px_rgba(26,53,35,0.12)] hover:-translate-y-1 transition-all duration-400 cursor-default shadow-sm"
            >
              ...
              <div className="text-3xl font-bold text-forest-deep mb-2 group-hover:text-gold transition-colors duration-300">
                {s.v}
              </div>
  ...
  return (
    <section className="bg-forest-deep py-32 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[3rem] font-bold text-white leading-[1.08] tracking-tight">
          Your Cambridge journey starts here.
        </h2>
        <p className="mt-5 text-[15px] text-cream/80 leading-[1.75] max-w-xl mx-auto">
          Gain knowledge, build global connections and create the future you envision. A lifetime of
          impact. A summer to remember.
        </p>

        <div className="mt-12 flex gap-4 justify-center flex-wrap">
          <Link
            to="/contact"
            search={{ source: "Graduate Summer Programme (Bottom CTA)" }}
          ...
          <Link
            to="/contact"
            search={{ source: "Graduate Summer Programme (Bottom CTA Secondary)" }}
