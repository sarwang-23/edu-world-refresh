          ...
          <div className="mt-0 pt-0">
            <div className="flex flex-wrap gap-2 mb-8">
              {pills.map((p) => (
                <span
                  key={p.t}
                  className="inline-flex items-center gap-2 rounded-full border border-forest/15 bg-white/60 backdrop-blur-sm px-4 py-2 text-[14px] font-bold uppercase tracking-[0.2em] text-forest-deep shadow-sm"
                >
                  {p.icon} {p.t}
                </span>
              ))}
            ...
            <p className="mt-3 text-forest/70 font-medium text-lg uppercase tracking-widest text-[15px]">
              From campus to global markets.
            </p>
            <p className="mt-8 text-[15px] leading-relaxed text-forest/70 max-w-lg">
              Empowering the next generation of founders and innovators with world-class programmes,
              mentorship and direct access to Cambridge's innovation ecosystem.{" "}
              <span className="font-semibold text-forest-deep">
                This is where research, capital and entrepreneurial energy meet.
              </span>
            </p>
            <div className="mt-12 flex flex-wrap gap-4">
              <Link
                to="/contact"
                className="group relative inline-flex items-center gap-2 rounded-full bg-forest px-8 py-4 text-[15px] font-bold uppercase tracking-[0.2em] text-cream transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(20,40,30,0.3)] overflow-hidden"
              >
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full border border-forest/20 bg-white/50 backdrop-blur-sm px-8 py-4 text-[15px] font-bold uppercase tracking-[0.2em] text-forest-deep transition-all hover:bg-forest/5 hover:border-forest/40"
              >
          ...
          <div className="relative mt-16 flex gap-4 h-[480px]">
            ...
            <div className="relative flex-[3] overflow-hidden rounded-[2rem] bg-forest-deep shadow-2xl border border-white/10">
              ...
              <div className="absolute top-5 left-5 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full flex items-center gap-2 shadow-lg">
                ...
                <span className="text-[14px] font-bold text-forest-deep tracking-[0.2em] uppercase">
                  100+ Startups
                </span>
              </div>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 px-8">
                <div className="text-center">
                  ...
                  <p className="text-[15px] text-cream/60 mt-2 uppercase tracking-widest font-semibold">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-4">
                ...
                <p className="text-[14px] text-cream/60 mt-1 uppercase tracking-widest">
                  Cambridge · London · Singapore
                </p>
              </div>
            </div>
            ...
            <div className="relative flex-[2] overflow-hidden rounded-[2rem] bg-forest-deep shadow-2xl border border-white/10 h-[480px]">
              <div
                className="absolute inset-0 flex flex-col h-max"
                style={{ animation: "marquee-y 15s linear infinite reverse" }}
              >
                <img
                  src={placeholderImg3}
                  alt="Ecosystem"
                  className="w-full h-[480px] object-cover shrink-0"
                />
                <img
                  src={placeholderImg4}
                  alt="Pitch"
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-4 text-center">
                ...
                <p className="text-[14px] text-cream/90 mt-1 uppercase tracking-widest font-semibold">
                  Funded Startups
                </p>
              </div>
            </div>
        ...
        <div className="animate-marquee-reverse">
          {[...stats, ...stats, ...stats, ...stats].map((s, i) => (
            <div key={i} className="flex items-center gap-3 px-8 shrink-0 group">
              ...
              <div>
                <h4 className="text-[14px] font-bold text-cream uppercase tracking-widest whitespace-nowrap">
                  {s.label}
                </h4>
                ...
                <div className="p-8 flex flex-col flex-1 relative z-10">
                  ...
                  <div className="flex items-center justify-between pt-5 border-t border-forest/10 mb-6 group-hover:border-gold/20 transition-colors">
                    {p.stats.map((s, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-1.5 text-[15px] text-forest/60 uppercase font-bold tracking-wider"
                      >
                  ...
                  <Link
                    to={p.link}
                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-forest/5 py-3 text-[14px] font-bold uppercase tracking-[0.15em] text-forest-deep group-hover:bg-forest-deep group-hover:text-cream transition-colors w-full"
                  >
          ...
          <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 lg:gap-16 items-start relative">
            ...
            <div className="lg:sticky lg:top-32 relative z-10">
              <div className="inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-1.5 mb-6">
                <span className="w-2 h-2 rounded-full bg-gold animate-pulse" />
                <span className="text-[14px] font-bold uppercase tracking-[0.2em] text-gold">
                  THE FOUNDER JOURNEY
                </span>
              </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4 relative z-10">
                    ...
                    <span className="text-2xl font-serif text-forest/20 group-hover:text-gold transition-colors">
                      {s.n}
                    </span>
                  </div>
...
function Community() {
  const testimonials = [
    {
      q: "Zero-to-One gave us clarity, mentors and the confidence to build our MVP in just 48 hours.",
      a: "Avani Patel",
      r: "CO-FOUNDER, EDTECH HUB \u00b7 IDEATION ALUMNI",
    },
    {
      q: "The accelerator and mentor network helped us secure our first round of funding.",
      a: "Ravi Kapoor",
      r: "FOUNDER, GREENGRID \u00b7 ACCELERATOR COHORT",
    },
    {
      q: "The Cambridge ecosystem is unmatched. It opened doors we never imagined.",
      a: "David Lee",
      r: "CO-FOUNDER, DEEPSEARCH \u00b7 ACCELERATOR COHORT",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="group rounded-[2rem] border border-forest/10 bg-white p-10 hover:shadow-[0_20px_40px_rgba(20,40,30,0.08)] hover:-translate-y-2 hover:border-gold/30 transition-all duration-500 relative overflow-hidden flex flex-col"
            >
              ...
              <p className="text-[15px] text-forest-deep/80 font-medium leading-relaxed mb-10 flex-1">
                "{t.q}"
              </p>
              <div className="flex items-center gap-4 mt-auto">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-forest/50 uppercase tracking-[0.15em] font-semibold mt-1">
                    {t.r}
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <div className="flex flex-col items-start md:items-end gap-5 shrink-0 md:pb-2">
              ...
              <a
                ...
                className="text-[14px] font-bold uppercase tracking-[0.25em] text-cream/60 hover:text-gold transition-colors"
              >
