        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex gap-3.5 flex-wrap sm:flex-nowrap items-center">
              <Link
                to="/apply-now" search={{ source: "Entrepreneurship Track" }}
                className="inline-flex items-center gap-2 rounded-full bg-gold px-6 sm:px-8 py-4 text-[14px] sm:text-[15px] font-bold uppercase tracking-[0.18em] text-forest-deep hover:bg-amber-400 transition-all duration-300 shadow-xl shadow-gold/25 whitespace-nowrap shrink-0"
              >
                Apply Now <ArrowUpRight className="h-4 w-4" />
              </Link>
              <Link
                to="/students"
                className="inline-flex items-center gap-2 rounded-full border border-forest/20 bg-white px-6 sm:px-7 py-4 text-[14px] sm:text-[15px] font-bold uppercase tracking-[0.18em] text-forest hover:border-gold/40 transition-all duration-300 whitespace-nowrap shrink-0"
              >
                View All Tracks
              </Link>
            </div>
  ...
  return (
    <section className="bg-[#F4EFE6] py-24 text-center">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <Link
          to="/contact" search={{ source: "Entrepreneurship Track (Students)" }}
