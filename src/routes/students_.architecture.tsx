        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex gap-3.5 flex-wrap sm:flex-nowrap items-center">
              <Link
                to="/apply-now"
                search={{ source: "Architecture Track" }}
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-[15px] font-bold uppercase tracking-[0.3em] text-orange-600">
              What You'll Do
            </span>
            <div className="h-px w-8 bg-orange-500" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-[15px] font-bold uppercase tracking-[0.3em] text-orange-200">
