    ...
    <section className="relative bg-[#F4EFE6] overflow-hidden pt-20 pb-36 md:pt-28 md:pb-44">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            {/* badge */}
            <span className="inline-flex items-center gap-2 bg-orange-500/10 text-orange-600 text-[13px] font-bold uppercase tracking-[0.22em] px-4 py-2 rounded-full border border-orange-400/25 mb-7">
