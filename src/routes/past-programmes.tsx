  ...
  head: () => ({
    meta: [
      { title: "Past Programmes | Global Education Lab" },
      {
        name: "description",
        content:
          "Explore our portfolio of past programmes — global learning experiences with lasting institutional impact.",
      },
    ],
  }),
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] text-forest/65 leading-[1.75] max-w-lg">
              Global Education Lab designs and delivers international programmes for education
              leaders, entrepreneurs and business executives. Each programme combines expert
              learning, institutional engagement and cultural immersion to create insights that
  ...
  const past = [
    {
      ...
      bullets: [
        "School & institutional visits",
        "Expert interactions",
        "Policy & system insights",
        "Cultural engagement",
      ],
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto flex flex-col items-center">
          ...
          <p className="text-[15px] text-forest/70 leading-[1.7] mb-6">
            Each programme is carefully designed to deliver real-world learning, meaningful
            connections, and lasting professional impact.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {past.map((p, i) => (
            <div
              key={i}
              className="group flex flex-col bg-white rounded-[1.75rem] overflow-hidden border border-forest/8 hover:border-gold/40 hover:shadow-[0_16px_48px_rgba(26,53,35,0.10)] hover:-translate-y-2 transition-all duration-400"
            >
              <div className="relative h-44 overflow-hidden">
                ...
                <span className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-[8px] font-bold uppercase tracking-[0.1em] text-forest-deep">
                  {p.tag}
                </span>
              ...
              <div className="flex flex-col flex-1 p-6 pt-9">
                <h3 className="text-[14px] font-bold text-forest-deep mb-2 leading-tight group-hover:text-gold transition-colors duration-300">
                  {p.title}
                </h3>
                ...
                <div className="flex flex-col gap-2 mb-6 flex-1">
                  {p.bullets.map((b, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      ...
                      <span className="text-[14px] font-semibold text-forest-deep/80 leading-snug">
                        {b}
                      </span>
                    </div>
                  ))}
...
function ImpactBanner() {
  const stats = [
    { icon: <Users className="h-6 w-6" />, v: "500+", l: "Leaders & Professionals Empowered" },
    {
      ...
      v: "100+",
      l: "Institutions & Organisations Engaged",
    },
    { icon: <Globe2 className="h-6 w-6" />, v: "15+", l: "Countries Represented" },
    {
      icon: <TrendingUp className="h-6 w-6" />,
      v: "Lasting",
      l: "Partnerships & Collaborations Established",
    },
  ];
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[15px] text-cream/75 leading-[1.8] mb-10 max-w-lg">
              Our programmes create long-term value for individuals and organisations through
              knowledge, networks and real-world application.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            {stats.map((s, i) => (
              <div
                key={i}
                className="flex flex-col items-center text-center bg-white/5 border border-white/10 p-8 rounded-[2rem] backdrop-blur-md hover:bg-white/10 transition-colors duration-300 group"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gold/10 border border-gold/20 text-gold mb-4 group-hover:scale-110 transition-transform">
                  {s.icon}
                </div>
                <div className="text-2xl font-bold text-white mb-2 group-hover:text-gold transition-colors duration-300">
                  {s.v}
                </div>
                <div className="text-[15px] font-bold uppercase tracking-[0.1em] text-cream/60 leading-tight max-w-[120px]">
                  {s.l}
                </div>
              </div>
            ))}
    ...
    <section className="bg-white py-32 border-t border-forest/5 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <h2 className="text-[2.2rem] md:text-[2.8rem] font-bold text-forest-deep mb-5 leading-[1.1]">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="group bg-[#F4EFE6] rounded-[1.75rem] p-8 border border-forest/8 flex flex-col hover:border-gold/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-400 relative overflow-hidden"
            >
              <span className="text-6xl text-gold/20 font-serif leading-none absolute top-5 right-7 group-hover:text-gold/40 transition-colors duration-300">
                "
              </span>
              <img
                src={t.img}
                alt={t.a}
                className="w-14 h-14 rounded-2xl object-cover border-2 border-white shadow-md mb-5"
              />
              ...
              <div>
                ...
                <p className="text-[15px] text-forest/60 mt-0.5 uppercase tracking-wide font-semibold">
                  {t.r}
                </p>
              </div>
            </div>
  ...
  return (
    <section className="bg-forest-deep py-32 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2.2rem] md:text-[3rem] font-bold text-white leading-[1.08] tracking-tight">
          Let's create the next transformational learning experience.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-[1.75] max-w-xl mx-auto">
          We partner with schools, universities, corporations and governments to design impactful
          global programmes.
        </p>
