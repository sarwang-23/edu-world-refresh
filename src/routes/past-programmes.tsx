        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mt-8 flex items-center gap-3.5 flex-wrap sm:flex-nowrap">
              <Link
                to="/programmes"
                className="group inline-flex items-center gap-2 rounded-full bg-forest-deep px-5 sm:px-6 py-3.5 text-[13.5px] sm:text-[14px] font-bold uppercase tracking-[0.12em] text-white hover:bg-forest transition-all duration-300 shadow-xl shadow-forest/25 whitespace-nowrap shrink-0"
              >
                Explore Portfolio
              ...
              <Link
                to="/contact"
                search={{ source: "Past Programmes" }}
                className="inline-flex items-center gap-2 rounded-full border border-forest/20 bg-white/70 px-5 sm:px-6 py-3.5 text-[13.5px] sm:text-[14px] font-bold uppercase tracking-[0.12em] text-forest-deep backdrop-blur-sm hover:border-forest-deep hover:bg-white transition-all duration-300 whitespace-nowrap shrink-0"
              >
          ...
          {past.map((p, i) => (
            ...
            >
              <div className="relative h-44 overflow-hidden">
                ...
                <span className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-[15px] font-bold uppercase tracking-[0.1em] text-forest-deep">
                  {p.tag}
                </span>
              ...
              <div className="flex flex-col flex-1 p-6 pt-9">
                <h3 className="text-[15px] font-bold text-forest-deep mb-2 leading-tight group-hover:text-gold transition-colors duration-300">
                  {p.title}
                </h3>
                ...
                <div className="flex flex-col gap-2 mb-6 flex-1">
                  {p.bullets.map((b, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      ...
                      <span className="text-[15px] font-semibold text-forest-deep/80 leading-snug">
                        {b}
                      </span>
                    </div>
                  ))}
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div className="text-[15px] font-bold uppercase tracking-[0.1em] text-cream/80 leading-tight max-w-[120px]">
                  {s.l}
                </div>
              </div>
            ))}
