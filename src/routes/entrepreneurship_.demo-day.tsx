        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              <Link
                to="/contact"
                search={{ source: "Demo Day & Investor Connect" }}
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 hidden sm:flex items-center gap-3 rounded-2xl bg-white p-4 shadow-2xl shadow-forest/15 border border-forest/8 backdrop-blur-sm">
