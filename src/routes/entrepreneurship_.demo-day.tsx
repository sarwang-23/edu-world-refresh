...
import detailImg from '../assets/Public speaking.jpg'
...
export const Route = createFileRoute('/entrepreneurship_/demo-day')({
  head: () => buildMeta("/entrepreneurship/demo-day"),
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-gold/25 bg-gold/8 px-5 py-2 backdrop-blur-sm">
              ...
              <span className="text-[15px] font-bold uppercase tracking-[0.28em] text-gold">Twice a Year</span>
            </div>
            ...
            <p className="mt-4 text-[15px] text-forest/80 leading-[1.75] max-w-lg">
              Showcase your progress, traction, and vision to a curated room of venture capitalists, angel networks, and corporate partners. This is your platform to secure funding, pilot opportunities, and strategic global expansion.
            </p>
            ...
            <div className="mt-8 flex gap-4 flex-wrap">
              <Link
                to="/contact" search={{ source: "Demo Day & Investor Connect" }}
          ...
          <div className="relative">
            <div className="rounded-[2.5rem] overflow-hidden aspect-[4/3] shadow-[0_32px_80px_-12px_rgba(26,53,35,0.25)] relative ring-1 ring-forest/10">
              <img src={heroImg} alt="Investor Pitching" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" loading="lazy" />
            ...
            <div className="absolute -bottom-6 -left-6 flex items-center gap-3 rounded-2xl bg-white p-4 shadow-2xl shadow-forest/15 border border-forest/8 backdrop-blur-sm">
              ...
              <div>
                <p className="text-[15px] font-bold text-forest-deep uppercase tracking-wider">Showcase</p>
                <p className="text-[15px] text-forest/80 mt-0.5">Your next round</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-16 items-center">
        <div>
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[15px] font-bold uppercase tracking-[0.3em] text-gold">The Event</span>
          </div>
          <h2 className="text-[2.2rem] font-bold text-forest-deep leading-tight mb-6">Where capital meets capability.</h2>
          <p className="text-[15px] text-forest/70 leading-relaxed mb-8">
            Demo Day isn't just about putting on a show; it's about facilitating genuine investment and growth opportunities. We curate the investor list as rigorously as we curate our founders, ensuring alignment of thesis, stage, and sector.
          </p>
        ...
        <div className="relative rounded-[2rem] overflow-hidden aspect-square shadow-xl border border-forest/5">
          <img src={detailImg} alt="Demo Day Pitch" className="w-full h-full object-cover" loading="lazy" />
        </div>
      </div>
    </section>
  )
  ...
  return (
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2.2rem] md:text-[3rem] font-bold text-white leading-tight">Ready to pitch?</h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">Founders and investors can register their interest for our upcoming Demo Day. Spaces are strictly limited to ensure quality of interaction.</p>
