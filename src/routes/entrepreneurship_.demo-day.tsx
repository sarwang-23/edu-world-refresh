...
export const Route = createFileRoute('/entrepreneurship_/demo-day')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Pitch to investors, corporates and partners. Opportunities for funding, pilots and global expansion.' },
    ],
  }),
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="rounded-[2.5rem] overflow-hidden aspect-[4/3] shadow-[0_32px_80px_-12px_rgba(26,53,35,0.25)] relative ring-1 ring-forest/10">
              <img src={heroImg} alt="Investor Pitching" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
