    ...
    <section className="relative overflow-hidden bg-cream pt-32 pb-24 md:pt-40 md:pb-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-gold">Our People</span>
          <div className="h-px w-8 bg-gold" />
        </div>
    ...
    <section className="bg-white py-24 md:py-32 border-b border-border/60">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div>
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-gold mb-4 block">— Leadership</span>
          ...
          <div className="relative group">
            ...
            <div className="absolute bottom-10 -left-8 z-20 bg-forest-deep text-white p-6 rounded-2xl shadow-xl border border-white/10 hidden lg:block">
              ...
              <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/60">Founder & CEO</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member, i) => (
            <div key={i} className="group bg-white rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition-all border border-forest/5">
              ...
              <p className="text-[11px] font-bold uppercase tracking-[0.15em] text-forest/50 mb-4">{member.role}</p>
  ...
  return (
    <section className="bg-forest-deep py-24 md:py-32 text-center border-t border-white/5">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <a href="/contact" className="inline-flex items-center gap-2 rounded-full bg-gold px-8 py-4 text-[12px] font-bold tracking-[0.2em] uppercase text-forest-deep transition-all hover:bg-white">
