...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-cream">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 pb-32 md:pb-40 lg:grid-cols-12 lg:gap-12 pt-4 md:pt-20">
        <div className="lg:col-span-6">
          <h1 className="mt-4 text-[2rem] sm:text-[2.75rem] font-bold leading-[1.05] text-forest md:text-5xl lg:text-[3.25rem] xl:text-[4rem] break-words">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mb-16 flex items-end justify-between">
          <div>
            ...
            <p className="mt-2 text-[15px] text-forest/80 font-medium">
          ...
          {programmes.map((p, i) => (
            ...
            >
              ...
              <div className="relative z-10 p-5 flex justify-between items-start">
                ...
                <span className="text-[15px] font-bold text-white/80 font-mono mt-1">
                  {p.number}
                </span>
              </div>
...
function ImpactSoFar() {
  const stats = [
    ...
    },
    {
      ...
      desc: "World class organizations",
    },
    {
      icon: <BookOpen className="h-6 w-6" />,
      value: "20+",
      label: "Programmes Delivered",
      desc: "Global executive cohorts",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="text-[2rem] sm:text-[2.5rem] font-bold leading-[1.05] md:text-[3.5rem] mb-6">
