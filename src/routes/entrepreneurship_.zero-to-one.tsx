        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-10 flex gap-4 flex-wrap">
              <Link to="/apply-now" search={{ source: "Zero-to-One Ideation Weekend (Entrepreneurship)" }} className="inline-flex items-center gap-2 rounded-full bg-forest-deep px-8 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-white hover:bg-forest transition-all duration-300 shadow-lg shadow-forest/20">
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <div className="mt-10 flex gap-4 justify-center flex-wrap">
          <Link to="/apply-now" search={{ source: "Zero-to-One Ideation Weekend (Entrepreneurship)" }} className="inline-flex items-center gap-2 rounded-full bg-gold px-8 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-forest-deep hover:bg-amber-400 transition-all duration-300 shadow-lg">
            Apply Now <ArrowUpRight className="h-4 w-4" />
          </Link>
