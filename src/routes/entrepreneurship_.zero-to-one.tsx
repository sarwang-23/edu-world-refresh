  ...
  head: () => ({
    meta: [
      { title: "Zero-to-One Ideation Weekend — Global Edu Lab Entrepreneurship" },
      {
        name: "description",
        content:
          "A 48-hour immersive ideation sprint at Cambridge. Students, professionals and workers come together to solve real-world challenges and build venture-ready ideas.",
      },
    ],
  }),
  component: Page,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h1 className="text-[2.8rem] md:text-[3.6rem] font-bold text-forest-deep leading-[1.05] tracking-tight">
              Zero-to-One
              <br />
              <span className="font-serif italic text-gold">Ideation Weekend</span>
            </h1>
            ...
            <p className="mt-4 text-[15px] text-forest/65 leading-relaxed max-w-lg">
              The Zero-to-One Ideation Weekend is an intensive 48-hour sprint where students, young
              professionals and aspiring founders come together at Cambridge to tackle real-world
              problems, rapidly prototype solutions, and pitch to a live panel of investors and
              mentors.
            </p>
            ...
            <div className="rounded-3xl bg-forest-deep p-10 shadow-2xl border border-white/10 relative overflow-hidden">
              ...
              <div className="mt-6 p-4 bg-gold/10 rounded-xl border border-gold/20 relative z-10">
                <p className="text-[15px] font-bold text-gold uppercase tracking-wider">
                  Next Cohort · Open for Applications
                </p>
                <p className="text-[14px] text-cream/60 mt-1">
                  Cambridge · Limited to 60 Participants
                </p>
              </div>
            </div>
          </div>
  ...
  const items = [
    {
      ...
      title: "Problem Discovery Sessions",
      desc: "Work with Cambridge mentors to identify real market gaps, customer pain points and venture opportunities across sectors.",
    },
    {
      icon: <Zap className="h-8 w-8" />,
      title: "Rapid Prototyping Sprints",
      desc: "Build lean MVPs, user personas and business canvases with expert facilitation in fast-paced design-thinking workshops.",
    },
    {
      icon: <Target className="h-8 w-8" />,
      title: "Pitch Coaching & Demo Day",
      desc: "Refine your pitch with professional coaches and present your solution to a live panel of investors, mentors and academics.",
    },
    {
      icon: <Globe2 className="h-8 w-8" />,
      title: "Network & Community Access",
      desc: "Connect with a diverse cohort of global participants, Cambridge alumni and access the GEL founder community post-event.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep">
            Everything packed into 48 hours.
          </h2>
        </div>
  ...
  const steps = [
    {
      n: "01",
      t: "Arrive & Connect",
      d: "Meet your cohort, mentors and facilitators. Teams are formed across disciplines — tech, business, design and domain expertise.",
    },
    {
      n: "02",
      t: "Problem Deep-Dive",
      d: "Guided sessions to understand real-world problems. Secondary research, mentor briefings and market framing.",
    },
    {
      n: "03",
      t: "Ideate & Build",
      d: "Rapid design-thinking sprints. Test assumptions, sketch solutions and build your minimum viable concept.",
    },
    {
      n: "04",
      t: "Pitch & Win",
      d: "Present your venture idea to a panel of investors and Cambridge mentors. Feedback, prizes and funding introductions await.",
    },
  ];
  return (
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            <div
              key={i}
              className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm hover:border-gold/40 hover:bg-white/10 hover:-translate-y-1 transition-all duration-500 p-8 group"
            >
              <span className="text-5xl font-serif text-gold/20 font-bold group-hover:text-gold/50 transition-colors">
                {s.n}
              </span>
              <h3 className="text-[17px] font-bold text-white mt-4 mb-3 group-hover:text-gold transition-colors duration-300">
                {s.t}
              </h3>
  ...
  const profiles = [
    {
      ...
      desc: "Undergraduate and postgraduate students eager to solve real problems and launch their first venture with Cambridge-level mentorship.",
    },
    {
      title: "Young Professionals",
      desc: "Early-career professionals with a side idea or startup ambition who want structured support, mentors and a co-founder community.",
    },
    {
      title: "Aspiring Founders",
      desc: "Individuals with a business concept who want to validate, prototype and pitch their idea in an intensive, high-energy environment.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {profiles.map((p, i) => (
            <div
              key={i}
              className="bg-white rounded-3xl p-8 border border-forest/8 hover:border-gold/30 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep mb-8">
          ...
          <div className="rounded-3xl bg-forest-deep p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <blockquote className="text-[16px] italic text-cream/85 leading-relaxed mb-8">
                "Zero-to-One gave us clarity, mentors and the confidence to build our MVP in just 48
                hours. Within 6 months, we had our first 100 paying customers."
              </blockquote>
              <p className="font-bold text-gold text-[15px]">Avani Patel</p>
              <p className="text-[15px] text-cream/50 uppercase tracking-wider mt-1">
                Co-Founder, EduTech Hub · Ideation Alumni
              </p>
            </div>
          </div>
        </div>
    ...
    <section className="bg-forest-deep py-24 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-white leading-tight">
          Your idea. 48 hours. Cambridge.
        </h2>
        <p className="mt-5 text-[15px] text-cream/70 leading-relaxed max-w-xl mx-auto">
          Applications are open. Limited cohort size — apply today to secure your place.
        </p>
