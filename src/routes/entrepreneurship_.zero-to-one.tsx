        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-10 flex gap-4 flex-wrap">
              <Link
                to="/apply-now"
                search={{ source: "Zero-to-One Ideation Weekend (Entrepreneurship)" }}
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            ...
            >
              <span className="text-5xl font-serif text-gold/80 font-bold group-hover:text-gold/80 transition-colors">
                {s.n}
              </span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="rounded-3xl bg-forest-deep p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[15px] text-cream/70 uppercase tracking-wider mt-1">
