        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <div className="mt-5 flex items-center gap-2.5 rounded-full bg-white/70 border border-forest/10 px-5 py-2.5 shadow-sm backdrop-blur-sm w-fit">
              <span className="text-[11px] font-bold uppercase tracking-[0.22em] text-forest/60 leading-none">In collaboration with</span>
              ...
              <div className="flex items-center gap-2 leading-none">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#9B2335] shadow-sm shrink-0">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 5H6L12 12L6 19H18" stroke="white" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className="text-[14px] font-black tracking-tight text-[#1a1a1a] leading-none">SUMMATIC</span>
              </div>
            </div>
