          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              {[
                ...
                { icon: <Star className="h-4 w-4" />, label: 'Upcoming Summer' },
              ].map((b, i) => (
            ...
            <div className="rounded-[2.5rem] overflow-hidden aspect-[4/3] shadow-[0_32px_80px_-12px_rgba(26,53,35,0.25)] relative ring-1 ring-forest/10">
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                <div>
                  ...
                  <p className="text-white text-[15px] font-bold">Upcoming Summer</p>
                </div>
...
function StatsMarquee() {
  const stats = [
    ...
    { val: 'Summer', label: 'Next Cohort', sub: 'Upcoming' },
    ...
    <section className="bg-forest-deep py-32 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <p className="mt-10 text-[15px] text-cream/80 uppercase tracking-[0.2em]">
          Cambridge, UK · Upcoming Summer · Fully Supervised
        </p>
      </div>
    </section>
  )
