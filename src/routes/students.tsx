...
import jivikaImg from "@/assets/people/jivika_vikamshi.jpg";
  ...
  return (
    <div className="flex min-h-screen flex-col font-sans text-foreground">
      ...
      <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 animate-float">
        <Link
          to="/apply-now"
          search={{ source: "Young Leaders Summer Programme" }}
...
function Hero() {
  return (
    <section className="relative bg-[#F4EFE6] overflow-hidden pt-4 md:pt-20 pb-32 md:pb-40 border-b border-forest/10">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            {/* Collaboration badge */}
            <div className="mt-5 flex items-center gap-2.5 rounded-full bg-white/70 border border-forest/10 px-5 py-2.5 shadow-sm backdrop-blur-sm w-fit">
              <span className="text-[11px] font-bold uppercase tracking-[0.22em] text-forest/60 leading-none">
                In collaboration with
              </span>
              <span className="text-forest/20 text-[14px] leading-none">|</span>
              {/* Summatic Logo */}
              <div className="flex items-center gap-2 leading-none">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#9B2335] shadow-sm shrink-0">
                  <svg
                    width="12"
                    height="12"
                    viewBox="0 0 24 24"
            ...
            <p className="mt-6 max-w-xl text-[16px] md:text-[17px] leading-[1.7] text-forest/80 font-medium">
              An immersive summer experience in Cambridge for ambitious young learners. Explore
              STEM, AI, entrepreneurship and public speaking while building confidence and a global
              mindset.
            </p>
  ...
  const features = [
    {
      ...
      desc: "STEM, AI, communication & entrepreneurship.",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Cambridge Ecosystem",
      desc: "Connect with researchers & student innovators.",
    },
    {
      icon: <Lightbulb className="h-6 w-6" />,
      title: "Hands-on Learning",
      desc: "Interactive workshops & real-world challenges.",
    },
    {
      icon: <Globe2 className="h-6 w-6" />,
      title: "Global Community",
      desc: "Learn with young leaders from across the globe.",
    },
    {
      icon: <ShieldCheck className="h-6 w-6" />,
      title: "Safe Environment",
      desc: "Fully supervised residential programme.",
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: "Expert Mentors",
      desc: "Cambridge educators & industry professionals.",
    },
  ];
              ...
              {items.map((f, i) => (
                <div key={i} className="flex shrink-0 items-center gap-5 px-8">
                  ...
                  <div className="pr-8 border-r border-forest/8">
                    <p className="text-[15px] font-bold text-forest-deep whitespace-nowrap tracking-tight">
                      {f.title}
                    </p>
                    <p className="text-[15px] text-forest/70 whitespace-nowrap mt-0.5 font-medium">
                      {f.desc}
                    </p>
                  </div>
                  {/* gold dot separator */}
  ...
  const elements = [
    {
      ...
      desc: "Discover, experiment and solve real-world problems through engaging STEM sessions and interactive learning.",
    },
    {
      img: publicSpeakingImg,
      icon: <MessageSquare className="h-5 w-5" />,
      num: "02",
      title: "Public Speaking",
      tag: "Communication",
      desc: "Build confidence and sharpen communication skills through structured speaking practice and presentations.",
    },
    {
      img: siteVisitImg,
      ...
      title: "Site Visits",
      tag: "Industry",
      desc: "Gain real-world perspectives with exclusive visits to leading organisations and innovation hubs.",
    },
    {
      ...
      tag: "Community",
      desc: "Immerse in diverse cultures, build lasting friendships and expand your global perspective.",
    },
  ];
  return (
    <section className="bg-white py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.8rem] font-bold text-forest-deep leading-tight mb-4">
            Core programme elements.
          </h2>
          <p className="text-[15px] text-forest/80 max-w-lg leading-[1.75]">
            Every element is designed to challenge, inspire and equip young leaders for the world
            ahead.
          </p>
        </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="mb-20">
          ...
          <p className="text-[15px] text-cream/80 max-w-xl leading-[1.8]">
            World-class educators, Cambridge researchers and industry leaders — all dedicated to
            your development.
          </p>
        </div>
            ...
            <div className="relative z-10 p-10">
              ...
              <div className="flex items-center gap-4 mb-8 pb-8 border-b border-white/8">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-gold uppercase tracking-[0.2em] mt-0.5 font-semibold">
              ...
              <h3 className="text-[17px] font-bold text-white mb-4">
                In partnership with Summatic
              </h3>
              <p className="text-[15px] text-cream/80 leading-[1.75]">
                We are proud to partner with Summatic to deliver a transformative learning
                experience that inspires young minds and prepares them for a future of limitless
                possibilities.
              </p>
              ...
              <div className="mt-8 flex gap-8 pt-8 border-t border-white/8">
                {[
                  ...
                  <div key={i}>
                    ...
                    <p className="text-[15px] text-cream/80 mt-1 uppercase tracking-[0.15em]">
                      {s.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="relative z-10 p-10">
              ...
              <div className="flex items-center gap-4 mb-8 pb-8 border-b border-white/8">
                <div className="flex -space-x-3">
                  ...
                  <div
                    className="w-12 h-12 rounded-full border-2 border-forest-deep ring-1 ring-white/15 bg-gold/15 flex items-center justify-center text-[15px] font-bold text-gold"
                    style={{ zIndex: 0 }}
                  >
                    +12
                  </div>
              ...
              <p className="text-[15px] text-cream/80 leading-[1.75] mb-8">
                Our facilitators include Cambridge educators, researchers, entrepreneurs, industry
                experts and communication specialists with a passion for guiding young learners.
              </p>

              <button
                onClick={() => {
                  document
                    .getElementById("key-facilitators")
      ...
      >
        {allFacilitators.map((f, i) => (
          ...
          >
            ...
            <p className="text-xs font-semibold text-forest-deep whitespace-pre-line mb-3 leading-snug">
              {f.title}
            </p>
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-[15px] text-forest/80 max-w-lg mx-auto leading-[1.75]">
            Two unique pathways. One unforgettable Cambridge experience.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-white border border-forest/8 shadow-[0_4px_32px_rgba(26,53,35,0.08)] hover:shadow-[0_32px_80px_rgba(26,53,35,0.2)] hover:-translate-y-3 transition-all duration-500 flex flex-col">
            ...
            <div className="p-9 pb-6">
              ...
              <h3 className="text-[2.4rem] font-bold text-forest-deep leading-[1.1] mb-2 group-hover:text-gold transition-colors duration-400">
                Build ideas.
                <br />
                Create impact.
              </h3>
              <p className="text-[15px] text-forest/80 leading-[1.75] mb-7 max-w-sm">
                Explore the world of innovation. Learn how ideas are born, tested and developed into
            ...
            <div className="relative h-52 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7">
                <Link
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-gold px-7 py-3 text-[15px] font-bold uppercase tracking-[0.2em] text-forest-deep shadow-xl shadow-gold/30 hover:bg-amber-400 transition-all duration-300 group/btn"
                >
                  Explore Track
          ...
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-white border border-forest/8 shadow-[0_4px_32px_rgba(26,53,35,0.08)] hover:shadow-[0_32px_80px_rgba(37,99,235,0.18)] hover:-translate-y-3 transition-all duration-500 flex flex-col">
            ...
            <div className="p-9 pb-6">
              ...
              <h3 className="text-[2.4rem] font-bold text-forest-deep leading-[1.1] mb-2 group-hover:text-blue-600 transition-colors duration-400">
                Ask questions.
                <br />
                Discover more.
              </h3>
              <p className="text-[15px] text-forest/80 leading-[1.75] mb-7 max-w-sm">
                Dive into the world of research and STEM. Learn how questions become insights and
                insights create a better world.
              </p>
            ...
            <div className="relative h-52 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7">
                <Link
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-blue-500 px-7 py-3 text-[15px] font-bold uppercase tracking-[0.2em] text-white shadow-xl shadow-blue-500/30 hover:bg-blue-400 transition-all duration-300 group/btn"
                >
                  Explore Track
                  <ArrowUpRight className="h-4 w-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                </Link>
  ...
  const props = [
    {
      ...
      desc: "Speak, present and lead with clarity and conviction.",
    },
    {
      icon: <Lightbulb className="h-6 w-6" />,
      num: "02",
      title: "Think like a solver",
      desc: "Apply STEM & AI thinking to real-world challenges.",
    },
    {
      icon: <Globe2 className="h-6 w-6" />,
      num: "03",
      title: "Connect globally",
      desc: "Build friendships that last a lifetime.",
    },
    {
      icon: <Building2 className="h-6 w-6" />,
      num: "04",
      title: "Access Cambridge",
      desc: "Engage with researchers & leading innovators.",
    },
    {
      icon: <Compass className="h-6 w-6" />,
      num: "05",
      title: "Broaden perspective",
      desc: "Experience new cultures, ideas and ways of thinking.",
    },
    {
      icon: <Target className="h-6 w-6" />,
      num: "06",
      title: "Shape your future",
      desc: "Discover your passions and unlock new pathways.",
    },
  ];
  return (
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-[2rem] md:text-[2.6rem] font-bold text-forest-deep mb-4">
            What you&rsquo;ll take home.
          </h2>
          <p className="text-[15px] text-forest/80 max-w-lg mx-auto leading-[1.75]">
            Six transformative outcomes every participant carries forward.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
          {props.map((p, i) => (
            ...
            >
              ...
              {/* number */}
              <span className="text-[15px] font-black text-gold/80 tracking-[0.2em] group-hover:text-gold transition-colors duration-300">
                {p.num}
              </span>
              ...
              <h4 className="text-[15px] font-bold text-forest-deep mb-2 leading-tight group-hover:text-gold transition-colors duration-300">
                {p.title}
              </h4>
    ...
    <section className="bg-forest-deep py-32 text-center relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6">
        ...
        <h2 className="text-[2rem] md:text-[3rem] font-bold text-white leading-[1.08] tracking-tight">
          Start your Cambridge journey early.
        </h2>
        <p className="mt-5 text-[15px] text-cream/80 leading-[1.75] max-w-xl mx-auto">
          Discover new ideas. Build your voice. Explore the future — at one of the world's greatest
          universities.
        </p>
        ...
        <div className="mt-12 flex gap-4 justify-center flex-wrap">
          <Link
            to="/contact"
            search={{ source: "Young Leaders Summer Programme" }}
            className="group inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-8 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-white hover:border-white/35 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm"
          >
            Register Interest
            <ArrowUpRight className="h-4 w-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200" />
          </Link>
          <Link
            to="/apply-now"
            search={{ source: "Young Leaders Summer Programme" }}
            className="inline-flex items-center gap-2 rounded-full bg-gold px-9 py-4 text-[15px] font-bold uppercase tracking-[0.18em] text-forest-deep hover:bg-amber-400 transition-all duration-300 shadow-xl shadow-gold/25 hover:-translate-y-1 animate-float"
          >
            Apply Now <ArrowUpRight className="h-4 w-4" />
          </Link>
        </div>
