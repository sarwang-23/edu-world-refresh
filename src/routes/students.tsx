...
export const Route = createFileRoute("/students")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "An immersive summer experience in Cambridge for ambitious young learners.",
      },
    ],
  }),
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] text-forest/65 leading-[1.75] max-w-lg">
              Explore STEM, AI, entrepreneurship and public speaking — while building confidence,
              friendships and a global mindset at one of the world's most prestigious universities.
            </p>
              ...
              {items.map((f, i) => (
                <div key={i} className="flex shrink-0 items-center gap-5 px-8">
                  ...
                  <div className="pr-8 border-r border-forest/8">
                    ...
                    <p className="text-[15px] text-forest/50 whitespace-nowrap mt-0.5 font-medium">
                      {f.desc}
                    </p>
                  </div>
                  {/* gold dot separator */}
...
function CoreElements() {
  const elements = [
    ...
    },
    {
      ...
      tag: "Technology",
      desc: "Understand the power of AI and how technology is shaping industries, communities and our future.",
    },
    {
      img: studentsImg,
      ...
      tag: "Innovation",
      desc: "Develop ideas, explore opportunities and learn how innovation turns into impact through practical workshops.",
    },
    {
      img: cambridgeImg,
      icon: <Globe2 className="h-5 w-5" />,
      num: "05",
      title: "Cambridge Experience",
      tag: "Campus Life",
      desc: "Gain exclusive access to Cambridge institutions, research centres, innovation hubs and student life.",
    },
  ];
  return (
    <section className="bg-white py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16">
          ...
          <p className="text-[15px] text-forest/55 max-w-lg leading-[1.75]">
            ...
            <div className="relative z-10 p-10">
              ...
              <div className="flex items-center gap-4 mb-8 pb-8 border-b border-white/8">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-gold uppercase tracking-[0.2em] mt-0.5 font-semibold">
              ...
              <div className="mt-8 flex gap-8 pt-8 border-t border-white/8">
                {[
                  ...
                  <div key={i}>
                    ...
                    <p className="text-[14px] text-cream/45 mt-1 uppercase tracking-[0.15em]">
                      {s.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="relative z-10 p-10">
              ...
              <div className="flex items-center gap-4 mb-8 pb-8 border-b border-white/8">
                <div className="flex -space-x-3">
                  ...
                  <div
                    className="w-12 h-12 rounded-full border-2 border-forest-deep ring-1 ring-white/15 bg-gold/15 flex items-center justify-center text-[14px] font-bold text-gold"
                    style={{ zIndex: 0 }}
                  >
                    +12
                  </div>
            ...
            <div className="relative h-52 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7">
                <Link
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-gold px-7 py-3 text-[14px] font-bold uppercase tracking-[0.2em] text-forest-deep shadow-xl shadow-gold/30 hover:bg-amber-400 transition-all duration-300 group/btn"
                >
                  Explore Track
            ...
            <div className="relative h-52 mt-auto overflow-hidden">
              ...
              <div className="absolute bottom-5 left-7">
                <Link
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-blue-500 px-7 py-3 text-[14px] font-bold uppercase tracking-[0.2em] text-white shadow-xl shadow-blue-500/30 hover:bg-blue-400 transition-all duration-300 group/btn"
                >
                  Explore Track
                  <ArrowUpRight className="h-4 w-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                </Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
          {props.map((p, i) => (
            ...
            >
              ...
              <h4 className="text-[14px] font-bold text-forest-deep mb-2 leading-tight group-hover:text-gold transition-colors duration-300">
                {p.title}
              </h4>
