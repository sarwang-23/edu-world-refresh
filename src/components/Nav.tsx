...
export function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
          ...
          <div className="group relative flex items-center gap-1 cursor-pointer py-3 -my-3">
            ...
            <div className="absolute top-[100%] right-0 hidden w-64 flex-col group-hover:flex">
              ...
              <div className="flex flex-col rounded-xl border border-forest/10 bg-white p-2 shadow-lg mt-0">
                ...
                <Link
                  to="/ai-learning-games"
                  className="rounded-lg px-4 py-2.5 text-[15px] font-medium text-forest/75 transition-colors hover:bg-forest/5 hover:text-forest flex items-center gap-2"
                >
                  AI Learning Games
                </Link>
                <Link
      ...
      {isMobileMenuOpen && (
        <div
          className="fixed inset-0 top-[88px] bg-forest-deep/20 backdrop-blur-sm xl:hidden z-40"
        ...
        <div className="absolute top-[100%] left-0 w-full bg-white border-b border-forest/10 shadow-2xl xl:hidden overflow-y-auto max-h-[calc(100vh-88px)] z-50">
          <div className="flex flex-col p-4 gap-1">
            <Link
              onClick={() => setIsMobileMenuOpen(false)}
              to="/"
              className="p-3 text-[16px] font-medium text-forest hover:bg-forest/5 rounded-lg"
            >
              Home
            </Link>
            ...
            <details className="group">
              ...
              <div className="pl-4 flex flex-col gap-1 mt-1">
                <Link
                  onClick={() => setIsMobileMenuOpen(false)}
                  to="/programmes"
                  className="p-3 text-[15px] font-medium text-forest/90 hover:bg-forest/5 rounded-lg"
                >
                  All Programmes
                </Link>
                ...
                <details className="group/students">
                  ...
                  <div className="pl-4 flex flex-col gap-1 mt-1">
                    <Link
                      onClick={() => setIsMobileMenuOpen(false)}
                      to="/gsp"
                      className="p-3 text-[14px] font-medium text-forest/80 hover:bg-forest/5 rounded-lg"
                    >
                      Graduate Summer Programme
                    </Link>
                    <Link
