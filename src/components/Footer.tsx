        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-12 lg:gap-6 xl:gap-12">
          <div className="lg:col-span-3 lg:pr-4 xl:pr-8">
            ...
            <p className="text-[14.5px] leading-[1.6] text-[#333] font-medium">
              ...
              <br className="hidden xl:block" /> for a lifetime of a learner's life.
            </p>
          </div>
          <div className="lg:col-span-2 lg:border-l lg:border-[#c5ccc7] lg:pl-4 xl:pl-8">
            <p className="text-[15px] font-bold uppercase tracking-wider text-black mb-6">
              Quick Links
            </p>
          ...
          <div className="lg:col-span-2 lg:border-l lg:border-[#c5ccc7] lg:pl-4 xl:pl-8">
            ...
            <ul className="space-y-4 text-[14.5px] font-medium text-[#333]">
              ...
              <li>
                <a
                  href="https://jobs.hellorecruiter.ai/globaledulab"
                  target="_blank"
                  rel="noreferrer"
          ...
          <div className="lg:col-span-3 lg:border-l lg:border-[#c5ccc7] lg:pl-4 xl:pl-8">
            ...
            <p className="text-[13px] font-bold uppercase tracking-wider text-black mb-5">
              Follow us on
            </p>
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/globaleducationlab/"
                target="_blank"
                rel="noreferrer"
                className="text-[#555] hover:text-forest transition-colors"
              >
                <Facebook className="h-5 w-5" strokeWidth={1.5} />
              </a>
              <a
                href="https://www.linkedin.com/company/globaleducationlab/"
                target="_blank"
                rel="noreferrer"
                className="text-[#555] hover:text-forest transition-colors"
              >
              ...
              <a
                href="https://www.instagram.com/globaleducationlab"
                target="_blank"
                rel="noreferrer"
                className="text-[#555] hover:text-forest transition-colors"
              >
              ...
              <a
                href="https://www.youtube.com/@GlobalEduLab"
                target="_blank"
                rel="noreferrer"
                className="text-[#555] hover:text-forest transition-colors"
              >
